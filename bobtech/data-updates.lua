...
if settings.startup["bobmods-tech-colorupdate"].value == true then
  data.raw.tool["automation-science-pack"].icon =
  ...
  data.raw.tool["logistic-science-pack"].icon =
  ...
  data.raw.tool["utility-science-pack"].icon =
  ...
  if settings.startup["bobmods-burnerphase"].value == true then
    data.raw.technology["automation-science-pack"].icon =
      "__base__/graphics/technology/utility-science-pack.png"
    data.raw.technology["automation-science-pack"].icon_size = 256
    data.raw.technology["automation-science-pack"].icon_mipmaps = 4
  end
  data.raw.technology["logistic-science-pack"].icon =
    "__bobtech__/graphics/icons/red-science-pack-technology.png"
  data.raw.technology["logistic-science-pack"].icon_size = 128
  data.raw.technology["logistic-science-pack"].icon_mipmaps = nil
  data.raw.technology["utility-science-pack"].icon =
    "__base__/graphics/technology/logistic-science-pack.png"
