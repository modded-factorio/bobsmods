data:extend({{
  ...
  icon_size = 128,
  order = "c-k-m-a",
  prerequisites = {"advanced-electronics", "logistics-3"},
  effects = {{
    type = "unlock-recipe",
    recipe = "lab-2"
  }},
  ...
  prerequisites = {"logistics-3", "robotics"},
  order = "c-a"
}})

data.raw.technology["logistic-science-pack"].localised_name =
  {"technology-name.transport-science-pack"}
...
if settings.startup["bobmods-burnerphase"].value == true then
  data:extend({{
    ...
    unit = {
      count = 25,
      ingredients = {{"steam-science-pack", 1}},
      time = 5
    },
    order = "c-a"
  }, {
    ...
    icon_size = 128,
    order = "c-k-m-a",
    prerequisites = {"automation-science-pack", "electricity"},
    effects = {},
    unit = {
      count = 20,
      time = 10,
