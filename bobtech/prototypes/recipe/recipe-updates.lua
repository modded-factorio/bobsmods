...
elseif data.raw.item["bob-chemical-plant-2"] then
  bobmods.lib.recipe.add_ingredient("production-science-pack", { type = "item", name = "bob-chemical-plant-2", amount = 1 })
...
if data.raw.item["bob-solar-panel-small"] then
  bobmods.lib.recipe.add_ingredient("utility-science-pack", { type = "item", name = "bob-solar-panel-small", amount = 1 })
else
