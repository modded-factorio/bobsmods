if data.raw.item["sodium-hydroxide"] then
  bobmods.lib.recipe.add_ingredient("chemical-science-pack", {
    "sodium-hydroxide",
    2
  })
end
...
bobmods.lib.recipe.add_ingredient("production-science-pack", {
...
bobmods.lib.recipe.add_ingredient("utility-science-pack", {
  "processing-unit",
  4
})
