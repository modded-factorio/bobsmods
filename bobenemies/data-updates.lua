...
then
  if settings.startup["bobmods-enemies-enablesmallartifacts"].value == true then
    ...
    if settings.startup["bobmods-enemies-enablenewartifacts"].value == true then
      ...
      table.insert(
        data.raw.unit["behemoth-biter"].loot,
        { item = "small-alien-artifact-blue", count_min = 2, count_max = 4, probability = 0.5 }
      )
      table.insert(
        data.raw.unit["behemoth-biter"].loot,
        { item = "small-alien-artifact-yellow", count_min = 2, count_max = 4, probability = 0.5 }
      )
      table.insert(
        data.raw.unit["behemoth-biter"].loot,
        { item = "small-alien-artifact-green", count_min = 2, count_max = 4, probability = 0.5 }
      )
      ...
      table.insert(
        data.raw.unit["behemoth-spitter"].loot,
        { item = "small-alien-artifact-orange", count_min = 2, count_max = 4, probability = 0.5 }
      )
      table.insert(
        data.raw.unit["behemoth-spitter"].loot,
        { item = "small-alien-artifact-purple", count_min = 2, count_max = 4, probability = 0.5 }
      )
      table.insert(
        data.raw.unit["behemoth-spitter"].loot,
        { item = "small-alien-artifact-red", count_min = 2, count_max = 4, probability = 0.5 }
      )
      ...
      table.insert(
        data.raw.unit["bob-leviathan-biter"].loot,
        { item = "alien-artifact-blue", count_min = 1, count_max = 2, probability = 0.75 }
      )
      table.insert(
        data.raw.unit["bob-leviathan-biter"].loot,
        { item = "alien-artifact-orange", count_min = 1, count_max = 2, probability = 0.25 }
      )
      table.insert(
        data.raw.unit["bob-leviathan-biter"].loot,
        { item = "alien-artifact-purple", count_min = 1, count_max = 2, probability = 0.25 }
      )
      table.insert(
        data.raw.unit["bob-leviathan-biter"].loot,
        { item = "alien-artifact-yellow", count_min = 1, count_max = 2, probability = 0.75 }
      )
      table.insert(
        data.raw.unit["bob-leviathan-biter"].loot,
        { item = "alien-artifact-green", count_min = 1, count_max = 2, probability = 0.75 }
      )
      table.insert(
        data.raw.unit["bob-leviathan-biter"].loot,
        { item = "alien-artifact-red", count_min = 1, count_max = 2, probability = 0.25 }
      )
      ...
      table.insert(
        data.raw.unit["bob-leviathan-spitter"].loot,
        { item = "alien-artifact-blue", count_min = 1, count_max = 2, probability = 0.25 }
      )
      table.insert(
        data.raw.unit["bob-leviathan-spitter"].loot,
        { item = "alien-artifact-orange", count_min = 1, count_max = 2, probability = 0.75 }
      )
      table.insert(
        data.raw.unit["bob-leviathan-spitter"].loot,
        { item = "alien-artifact-purple", count_min = 1, count_max = 2, probability = 0.75 }
      )
      table.insert(
        data.raw.unit["bob-leviathan-spitter"].loot,
        { item = "alien-artifact-yellow", count_min = 1, count_max = 2, probability = 0.25 }
      )
      table.insert(
        data.raw.unit["bob-leviathan-spitter"].loot,
        { item = "alien-artifact-green", count_min = 1, count_max = 2, probability = 0.25 }
      )
      table.insert(
        data.raw.unit["bob-leviathan-spitter"].loot,
        { item = "alien-artifact-red", count_min = 1, count_max = 2, probability = 0.75 }
      )
      ...
      table.insert(
        ...
        { item = "small-alien-artifact-purple", count_min = 1, count_max = 1, probability = 0.5 }
      )
      table.insert(
      ...
      table.insert(
        ...
        { item = "small-alien-artifact-yellow", count_min = 1, count_max = 1, probability = 0.5 }
      )
      table.insert(
      ...
      table.insert(
        ...
        { item = "small-alien-artifact-green", count_min = 1, count_max = 1, probability = 0.5 }
      )
      table.insert(
      ...
      table.insert(
        ...
        { item = "small-alien-artifact-red", count_min = 1, count_max = 1, probability = 0.5 }
      )
      table.insert(
      ...
      table.insert(
        ...
        { item = "small-alien-artifact-blue", count_min = 1, count_max = 3, probability = 0.75 }
      )
      table.insert(
      ...
      table.insert(
        ...
        { item = "small-alien-artifact-orange", count_min = 1, count_max = 3, probability = 0.75 }
      )
      table.insert(
      ...
      table.insert(
        ...
        { item = "small-alien-artifact-purple", count_min = 1, count_max = 3, probability = 0.75 }
      )
      table.insert(
      ...
      table.insert(
        ...
        { item = "small-alien-artifact-yellow", count_min = 1, count_max = 3, probability = 0.75 }
      )
      table.insert(
      ...
      table.insert(
        ...
        { item = "small-alien-artifact-green", count_min = 1, count_max = 3, probability = 0.75 }
      )
      table.insert(
      ...
      table.insert(
        ...
        { item = "small-alien-artifact-red", count_min = 1, count_max = 3, probability = 0.75 }
      )
      table.insert(
      ...
      table.insert(
        ...
        { item = "small-alien-artifact-blue", count_min = 1, count_max = 4, probability = 1 }
      )
      table.insert(
      ...
      table.insert(
        ...
        { item = "small-alien-artifact-orange", count_min = 1, count_max = 4, probability = 1 }
      )
      table.insert(
      ...
      table.insert(
        ...
        { item = "small-alien-artifact-purple", count_min = 1, count_max = 4, probability = 1 }
      )
      table.insert(
      ...
      table.insert(
        ...
        { item = "small-alien-artifact-yellow", count_min = 1, count_max = 4, probability = 1 }
      )
      table.insert(
      ...
      table.insert(
        ...
        { item = "small-alien-artifact-green", count_min = 1, count_max = 4, probability = 1 }
      )
      table.insert(
      ...
      table.insert(
        ...
        { item = "small-alien-artifact-red", count_min = 1, count_max = 4, probability = 1 }
      )
      table.insert(
      ...
      table.insert(
        ...
        { item = "small-alien-artifact-blue", count_min = 2, count_max = 5, probability = 1 }
      )
      table.insert(
      ...
      table.insert(
        ...
        { item = "small-alien-artifact-orange", count_min = 2, count_max = 5, probability = 1 }
      )
      table.insert(
      ...
      table.insert(
        ...
        { item = "small-alien-artifact-purple", count_min = 2, count_max = 5, probability = 1 }
      )
      table.insert(
      ...
      table.insert(
        ...
        { item = "small-alien-artifact-yellow", count_min = 2, count_max = 5, probability = 1 }
      )
      table.insert(
      ...
      table.insert(
        ...
        { item = "small-alien-artifact-green", count_min = 2, count_max = 5, probability = 1 }
      )
      table.insert(
      ...
      table.insert(
        ...
        { item = "small-alien-artifact-orange", count_min = 3, count_max = 6, probability = 1 }
      )
      table.insert(
      ...
      table.insert(
        ...
        { item = "small-alien-artifact-purple", count_min = 3, count_max = 6, probability = 1 }
      )
      table.insert(
      ...
      table.insert(
        ...
        { item = "small-alien-artifact-yellow", count_min = 3, count_max = 6, probability = 1 }
      )
      table.insert(
      ...
      table.insert(
        ...
        { item = "small-alien-artifact-green", count_min = 3, count_max = 6, probability = 1 }
      )
      table.insert(
      ...
      table.insert(
        ...
        { item = "small-alien-artifact-orange", count_min = 5, count_max = 11, probability = 1 }
      )
      table.insert(
      ...
      table.insert(
        ...
        { item = "small-alien-artifact-purple", count_min = 5, count_max = 11, probability = 1 }
      )
      table.insert(
      ...
      table.insert(
        ...
        { item = "small-alien-artifact-yellow", count_min = 5, count_max = 11, probability = 1 }
      )
      table.insert(
      ...
      table.insert(
        ...
        { item = "small-alien-artifact-green", count_min = 5, count_max = 11, probability = 1 }
      )
      table.insert(
      ...
      table.insert(
        ...
        { item = "small-alien-artifact-red", count_min = 5, count_max = 11, probability = 1 }
      )
      table.insert(
      ...
      table.insert(
        ...
        { item = "small-alien-artifact", count_min = 2, count_max = 6, probability = 1 }
      )
      table.insert(
        data.raw.unit["bob-behemoth-piercing-biter"].loot,
        { item = "small-alien-artifact-blue", count_min = 6, count_max = 10, probability = 1 }
      )
      table.insert(
        data.raw.unit["bob-behemoth-piercing-biter"].loot,
        { item = "small-alien-artifact-yellow", count_min = 1, count_max = 3, probability = 0.5 }
      )
      ...
      table.insert(
        data.raw.unit["bob-behemoth-electric-biter"].loot,
        { item = "small-alien-artifact-orange", count_min = 6, count_max = 10, probability = 1 }
      )
      table.insert(
        data.raw.unit["bob-behemoth-electric-biter"].loot,
        { item = "small-alien-artifact-purple", count_min = 1, count_max = 3, probability = 0.5 }
      )
      ...
      table.insert(
        data.raw.unit["bob-behemoth-acid-biter"].loot,
        { item = "small-alien-artifact-purple", count_min = 6, count_max = 10, probability = 1 }
      )
      table.insert(
        data.raw.unit["bob-behemoth-acid-biter"].loot,
        { item = "small-alien-artifact-red", count_min = 1, count_max = 3, probability = 0.5 }
      )
      ...
      table.insert(
        data.raw.unit["bob-behemoth-explosive-biter"].loot,
        { item = "small-alien-artifact-yellow", count_min = 6, count_max = 10, probability = 1 }
      )
      table.insert(
        data.raw.unit["bob-behemoth-explosive-biter"].loot,
        { item = "small-alien-artifact-green", count_min = 1, count_max = 3, probability = 0.5 }
      )
      ...
      table.insert(
        data.raw.unit["bob-behemoth-poison-biter"].loot,
        { item = "small-alien-artifact-green", count_min = 6, count_max = 10, probability = 1 }
      )
      table.insert(
        data.raw.unit["bob-behemoth-poison-biter"].loot,
      ...
      table.insert(
        data.raw.unit["bob-behemoth-fire-biter"].loot,
        { item = "small-alien-artifact-red", count_min = 6, count_max = 10, probability = 1 }
      )
      table.insert(
        data.raw.unit["bob-behemoth-fire-biter"].loot,
      ...
      table.insert(
        data.raw.unit["bob-leviathan-piercing-biter"].loot,
        { item = "alien-artifact-blue", count_min = 2, count_max = 3, probability = 1 }
      )
      table.insert(
        data.raw.unit["bob-leviathan-piercing-biter"].loot,
        { item = "alien-artifact-orange", count_min = 1, count_max = 2, probability = 0.4 }
      )
      table.insert(
        data.raw.unit["bob-leviathan-piercing-biter"].loot,
        { item = "alien-artifact-purple", count_min = 1, count_max = 2, probability = 0.4 }
      )
      table.insert(
        data.raw.unit["bob-leviathan-piercing-biter"].loot,
        { item = "alien-artifact-yellow", count_min = 1, count_max = 2, probability = 0.4 }
      )
      table.insert(
        data.raw.unit["bob-leviathan-piercing-biter"].loot,
        { item = "alien-artifact-green", count_min = 1, count_max = 2, probability = 0.4 }
      )
      table.insert(
        data.raw.unit["bob-leviathan-piercing-biter"].loot,
        { item = "alien-artifact-red", count_min = 1, count_max = 2, probability = 0.4 }
      )
      ...
      table.insert(
        data.raw.unit["bob-leviathan-electric-biter"].loot,
        { item = "alien-artifact-blue", count_min = 1, count_max = 2, probability = 0.4 }
      )
      table.insert(
        data.raw.unit["bob-leviathan-electric-biter"].loot,
        { item = "alien-artifact-orange", count_min = 2, count_max = 3, probability = 1 }
      )
      table.insert(
        data.raw.unit["bob-leviathan-electric-biter"].loot,
        { item = "alien-artifact-purple", count_min = 1, count_max = 2, probability = 0.4 }
      ...
      table.insert(
        data.raw.unit["bob-leviathan-acid-biter"].loot,
        { item = "alien-artifact-purple", count_min = 2, count_max = 3, probability = 1 }
      )
      table.insert(
        data.raw.unit["bob-leviathan-acid-biter"].loot,
        { item = "alien-artifact-yellow", count_min = 1, count_max = 2, probability = 0.4 }
      ...
      table.insert(
        data.raw.unit["bob-leviathan-explosive-biter"].loot,
        { item = "alien-artifact-yellow", count_min = 2, count_max = 3, probability = 1 }
      )
      table.insert(
        data.raw.unit["bob-leviathan-explosive-biter"].loot,
        { item = "alien-artifact-green", count_min = 1, count_max = 2, probability = 0.4 }
      ...
      table.insert(
        data.raw.unit["bob-leviathan-poison-biter"].loot,
        { item = "alien-artifact-green", count_min = 2, count_max = 3, probability = 1 }
      )
      table.insert(
        data.raw.unit["bob-leviathan-poison-biter"].loot,
        { item = "alien-artifact-red", count_min = 1, count_max = 2, probability = 0.4 }
    ...
    if settings.startup["bobmods-enemies-enablenewartifacts"].value == true then
      ...
      table.insert(
        data.raw.unit["bob-titan-piercing-biter"].loot,
        { item = "alien-artifact-blue", count_min = 1, count_max = 2, probability = 0.5 }
      )
      table.insert(
        data.raw.unit["bob-titan-piercing-spitter"].loot,
        { item = "alien-artifact-blue", count_min = 1, count_max = 2, probability = 0.5 }
      ...
      table.insert(
        data.raw.unit["bob-leviathan-piercing-biter"].loot,
        { item = "alien-artifact-blue", count_min = 5, count_max = 9, probability = 1 }
      )
      table.insert(
        data.raw.unit["bob-leviathan-piercing-spitter"].loot,
        { item = "alien-artifact-blue", count_min = 5, count_max = 9, probability = 1 }
      ...
      table.insert(
        data.raw.unit["bob-titan-electric-biter"].loot,
        { item = "alien-artifact-orange", count_min = 1, count_max = 2, probability = 0.5 }
      )
      table.insert(
        data.raw.unit["bob-titan-electric-spitter"].loot,
        { item = "alien-artifact-orange", count_min = 1, count_max = 2, probability = 0.5 }
      ...
      table.insert(
        data.raw.unit["bob-leviathan-electric-biter"].loot,
        { item = "alien-artifact-orange", count_min = 5, count_max = 9, probability = 1 }
      )
      table.insert(
        data.raw.unit["bob-leviathan-electric-spitter"].loot,
        { item = "alien-artifact-orange", count_min = 5, count_max = 9, probability = 1 }
      ...
      table.insert(
        data.raw.unit["bob-titan-acid-biter"].loot,
        { item = "alien-artifact-purple", count_min = 1, count_max = 2, probability = 0.5 }
      )
      table.insert(
        data.raw.unit["bob-titan-acid-spitter"].loot,
        { item = "alien-artifact-purple", count_min = 1, count_max = 2, probability = 0.5 }
      ...
      table.insert(
        data.raw.unit["bob-leviathan-acid-biter"].loot,
        { item = "alien-artifact-purple", count_min = 5, count_max = 9, probability = 1 }
      )
      table.insert(
        data.raw.unit["bob-leviathan-acid-spitter"].loot,
        { item = "alien-artifact-purple", count_min = 5, count_max = 9, probability = 1 }
      ...
      table.insert(
        data.raw.unit["bob-titan-explosive-biter"].loot,
        { item = "alien-artifact-yellow", count_min = 1, count_max = 2, probability = 0.5 }
      )
      table.insert(
        data.raw.unit["bob-titan-explosive-spitter"].loot,
        { item = "alien-artifact-yellow", count_min = 1, count_max = 2, probability = 0.5 }
      ...
      table.insert(
        data.raw.unit["bob-leviathan-explosive-biter"].loot,
        { item = "alien-artifact-yellow", count_min = 5, count_max = 9, probability = 1 }
      )
      table.insert(
        data.raw.unit["bob-leviathan-explosive-spitter"].loot,
        { item = "alien-artifact-yellow", count_min = 5, count_max = 9, probability = 1 }
      ...
      table.insert(
        data.raw.unit["bob-titan-poison-biter"].loot,
        { item = "alien-artifact-green", count_min = 1, count_max = 2, probability = 0.5 }
      )
      table.insert(
        data.raw.unit["bob-titan-poison-spitter"].loot,
        { item = "alien-artifact-green", count_min = 1, count_max = 2, probability = 0.5 }
      ...
      table.insert(
        data.raw.unit["bob-leviathan-poison-biter"].loot,
        { item = "alien-artifact-green", count_min = 5, count_max = 9, probability = 1 }
      )
      table.insert(
        data.raw.unit["bob-leviathan-poison-spitter"].loot,
        { item = "alien-artifact-green", count_min = 5, count_max = 9, probability = 1 }
      ...
      table.insert(
        data.raw.unit["bob-titan-fire-biter"].loot,
        { item = "alien-artifact-red", count_min = 1, count_max = 2, probability = 0.5 }
      )
      table.insert(
        data.raw.unit["bob-titan-fire-spitter"].loot,
        { item = "alien-artifact-red", count_min = 1, count_max = 2, probability = 0.5 }
...
if settings.startup["bobmods-enemies-enableartifacts"].value == true then
  ...
  if settings.startup["bobmods-enemies-enablenewartifacts"].value == true then
    ...
    table.insert(
      ...
      { item = "alien-artifact-orange", count_min = 8, count_max = 22, probability = 1 }
    )
    table.insert(
    ...
    table.insert(
      ...
      { item = "alien-artifact-purple", count_min = 8, count_max = 22, probability = 1 }
    )
    table.insert(
    ...
    table.insert(
      ...
      { item = "alien-artifact-yellow", count_min = 8, count_max = 22, probability = 1 }
    )
    table.insert(
    ...
    table.insert(
      ...
      { item = "alien-artifact-green", count_min = 8, count_max = 22, probability = 1 }
    )
    table.insert(
    ...
    table.insert(
      ...
      { item = "alien-artifact-red", count_min = 8, count_max = 22, probability = 1 }
    )
    table.insert(
    ...
    if settings.startup["bobmods-enemies-superspawner"].value == true then
      ...
      table.insert(
        data.raw["unit-spawner"]["bob-super-spawner"].loot,
        { item = "alien-artifact-blue", count_min = 2, count_max = 10, probability = 1 }
      )
      table.insert(
        data.raw["unit-spawner"]["bob-super-spawner"].loot,
        { item = "alien-artifact-orange", count_min = 2, count_max = 10, probability = 1 }
      )
      table.insert(
        data.raw["unit-spawner"]["bob-super-spawner"].loot,
        { item = "alien-artifact-purple", count_min = 2, count_max = 10, probability = 1 }
      )
      table.insert(
        data.raw["unit-spawner"]["bob-super-spawner"].loot,
        { item = "alien-artifact-yellow", count_min = 2, count_max = 10, probability = 1 }
      )
      table.insert(
        data.raw["unit-spawner"]["bob-super-spawner"].loot,
        { item = "alien-artifact-green", count_min = 2, count_max = 10, probability = 1 }
      )
      table.insert(
        data.raw["unit-spawner"]["bob-super-spawner"].loot,
        { item = "alien-artifact-red", count_min = 2, count_max = 10, probability = 1 }
      )

      table.insert(
        data.raw["unit-spawner"]["bob-piercing-super-spawner"].loot,
        { item = "alien-artifact", count_min = 2, count_max = 10, probability = 1 }
      )
      table.insert(
        data.raw["unit-spawner"]["bob-piercing-super-spawner"].loot,
        { item = "alien-artifact-blue", count_min = 20, count_max = 36, probability = 1 }
      )
      table.insert(
        data.raw["unit-spawner"]["bob-piercing-super-spawner"].loot,
        { item = "alien-artifact-orange", count_min = 2, count_max = 10, probability = 1 }
      ...
      table.insert(
        data.raw["unit-spawner"]["bob-electric-super-spawner"].loot,
        { item = "alien-artifact-orange", count_min = 20, count_max = 36, probability = 1 }
      )
      table.insert(
        data.raw["unit-spawner"]["bob-electric-super-spawner"].loot,
        { item = "alien-artifact-purple", count_min = 2, count_max = 10, probability = 1 }
      ...
      table.insert(
        data.raw["unit-spawner"]["bob-acid-super-spawner"].loot,
        { item = "alien-artifact-purple", count_min = 20, count_max = 36, probability = 1 }
      )
      table.insert(
        data.raw["unit-spawner"]["bob-acid-super-spawner"].loot,
        { item = "alien-artifact-yellow", count_min = 2, count_max = 10, probability = 1 }
      ...
      table.insert(
        data.raw["unit-spawner"]["bob-explosive-super-spawner"].loot,
        { item = "alien-artifact-yellow", count_min = 20, count_max = 36, probability = 1 }
      )
      table.insert(
        data.raw["unit-spawner"]["bob-explosive-super-spawner"].loot,
        { item = "alien-artifact-green", count_min = 2, count_max = 10, probability = 1 }
      ...
      table.insert(
        data.raw["unit-spawner"]["bob-poison-super-spawner"].loot,
        { item = "alien-artifact-green", count_min = 20, count_max = 36, probability = 1 }
      )
      table.insert(
        data.raw["unit-spawner"]["bob-poison-super-spawner"].loot,
        { item = "alien-artifact-red", count_min = 2, count_max = 10, probability = 1 }
  ...
  table.insert(
    ...
    { item = "alien-artifact", count_min = 6, count_max = 12, probability = 1 }
  )
  ...
  if settings.startup["bobmods-enemies-enablenewartifacts"].value == true then
    ...
    table.insert(
      ...
      { item = "alien-artifact", count_min = 8, count_max = 14, probability = 1 }
    )
    table.insert(
      data.raw.turret["bob-leviathan-worm-turret"].loot,
      { item = "alien-artifact-blue", count_min = 1, count_max = 3, probability = 0.5 }
    )
    table.insert(
      data.raw.turret["bob-leviathan-worm-turret"].loot,
      { item = "alien-artifact-orange", count_min = 1, count_max = 3, probability = 0.5 }
    )
    table.insert(
      data.raw.turret["bob-leviathan-worm-turret"].loot,
      { item = "alien-artifact-purple", count_min = 1, count_max = 3, probability = 0.5 }
    )
    table.insert(
      data.raw.turret["bob-leviathan-worm-turret"].loot,
      { item = "alien-artifact-yellow", count_min = 1, count_max = 3, probability = 0.5 }
    )
    table.insert(
      data.raw.turret["bob-leviathan-worm-turret"].loot,
      { item = "alien-artifact-green", count_min = 1, count_max = 3, probability = 0.5 }
    )
    table.insert(
      data.raw.turret["bob-leviathan-worm-turret"].loot,
      { item = "alien-artifact-red", count_min = 1, count_max = 3, probability = 0.5 }
    )

    table.insert(
      data.raw.turret["bob-small-piercing-worm-turret"].loot,
      { item = "alien-artifact", count_min = 1, count_max = 1, probability = 0.5 }
    )
    table.insert(
      data.raw.turret["bob-small-piercing-worm-turret"].loot,
      { item = "alien-artifact-blue", count_min = 1, count_max = 2, probability = 1 }
    ...
    table.insert(
      ...
      { item = "alien-artifact", count_min = 1, count_max = 1, probability = 1 }
    )
    table.insert(
      data.raw.turret["bob-medium-piercing-worm-turret"].loot,
    ...
    table.insert(
      data.raw.turret["bob-big-piercing-worm-turret"].loot,
      { item = "alien-artifact-blue", count_min = 2, count_max = 4, probability = 1 }
    )
    table.insert(
    ...
    table.insert(
      data.raw.turret["bob-huge-piercing-worm-turret"].loot,
      { item = "alien-artifact-blue", count_min = 2, count_max = 6, probability = 1 }
    )
    table.insert(
      data.raw.turret["bob-giant-piercing-worm-turret"].loot,
      { item = "alien-artifact", count_min = 1, count_max = 4, probability = 1 }
    )
    table.insert(
      data.raw.turret["bob-giant-piercing-worm-turret"].loot,
      { item = "alien-artifact-blue", count_min = 3, count_max = 7, probability = 1 }
    )
    table.insert(
    ...
    table.insert(
      data.raw.turret["bob-titan-piercing-worm-turret"].loot,
      { item = "alien-artifact-blue", count_min = 3, count_max = 9, probability = 1 }
    )

    table.insert(
      data.raw.turret["bob-behemoth-piercing-worm-turret"].loot,
      { item = "alien-artifact", count_min = 2, count_max = 6, probability = 1 }
    )
    table.insert(
      data.raw.turret["bob-behemoth-piercing-worm-turret"].loot,
      { item = "alien-artifact-blue", count_min = 4, count_max = 10, probability = 1 }
    )
    table.insert(
      data.raw.turret["bob-behemoth-piercing-worm-turret"].loot,
      { item = "alien-artifact-yellow", count_min = 1, count_max = 3, probability = 0.5 }
    ...
    table.insert(
      ...
      { item = "alien-artifact", count_min = 2, count_max = 8, probability = 1 }
    )
    table.insert(
      data.raw.turret["bob-leviathan-piercing-worm-turret"].loot,
      { item = "alien-artifact-blue", count_min = 5, count_max = 11, probability = 1 }
    )
    table.insert(
      data.raw.turret["bob-leviathan-piercing-worm-turret"].loot,
    ...
    table.insert(
      data.raw.turret["bob-big-electric-worm-turret"].loot,
      { item = "alien-artifact-orange", count_min = 2, count_max = 4, probability = 1 }
    )
    table.insert(
    ...
    table.insert(
      data.raw.turret["bob-huge-electric-worm-turret"].loot,
      { item = "alien-artifact-orange", count_min = 2, count_max = 6, probability = 1 }
    )
    table.insert(
    ...
    table.insert(
      data.raw.turret["bob-giant-electric-worm-turret"].loot,
      { item = "alien-artifact-orange", count_min = 3, count_max = 7, probability = 1 }
    )
    table.insert(
    ...
    table.insert(
      data.raw.turret["bob-titan-electric-worm-turret"].loot,
      { item = "alien-artifact-orange", count_min = 3, count_max = 9, probability = 1 }
    )
    ...
    table.insert(
      data.raw.turret["bob-behemoth-electric-worm-turret"].loot,
      { item = "alien-artifact-orange", count_min = 4, count_max = 10, probability = 1 }
    )
    table.insert(
      data.raw.turret["bob-behemoth-electric-worm-turret"].loot,
      { item = "alien-artifact-purple", count_min = 1, count_max = 3, probability = 0.5 }
    ...
    table.insert(
      data.raw.turret["bob-leviathan-electric-worm-turret"].loot,
      { item = "alien-artifact-orange", count_min = 5, count_max = 11, probability = 1 }
    )
    table.insert(
      data.raw.turret["bob-leviathan-electric-worm-turret"].loot,
    ...
    table.insert(
      data.raw.turret["bob-big-acid-worm-turret"].loot,
      { item = "alien-artifact-purple", count_min = 2, count_max = 4, probability = 1 }
    )
    table.insert(
    ...
    table.insert(
      data.raw.turret["bob-huge-acid-worm-turret"].loot,
      { item = "alien-artifact-purple", count_min = 2, count_max = 6, probability = 1 }
    )
    table.insert(
    ...
    table.insert(
      data.raw.turret["bob-giant-acid-worm-turret"].loot,
      { item = "alien-artifact-purple", count_min = 3, count_max = 7, probability = 1 }
    )
    table.insert(
    ...
    table.insert(
      data.raw.turret["bob-titan-acid-worm-turret"].loot,
      { item = "alien-artifact-purple", count_min = 3, count_max = 9, probability = 1 }
    )
    ...
    table.insert(
      data.raw.turret["bob-behemoth-acid-worm-turret"].loot,
      { item = "alien-artifact-purple", count_min = 4, count_max = 10, probability = 1 }
    )
    table.insert(
      data.raw.turret["bob-behemoth-acid-worm-turret"].loot,
      { item = "alien-artifact-red", count_min = 1, count_max = 3, probability = 0.5 }
    ...
    table.insert(
      data.raw.turret["bob-leviathan-acid-worm-turret"].loot,
      { item = "alien-artifact-purple", count_min = 5, count_max = 11, probability = 1 }
    )
    table.insert(
      data.raw.turret["bob-leviathan-acid-worm-turret"].loot,
      { item = "alien-artifact-red", count_min = 1, count_max = 3, probability = 1 }
    ...
    table.insert(
      data.raw.turret["bob-big-explosive-worm-turret"].loot,
      { item = "alien-artifact-yellow", count_min = 2, count_max = 4, probability = 1 }
    )
    table.insert(
    ...
    table.insert(
      data.raw.turret["bob-huge-explosive-worm-turret"].loot,
      { item = "alien-artifact-yellow", count_min = 2, count_max = 6, probability = 1 }
    )
    table.insert(
    ...
    table.insert(
      data.raw.turret["bob-giant-explosive-worm-turret"].loot,
      { item = "alien-artifact-yellow", count_min = 3, count_max = 7, probability = 1 }
    )
    table.insert(
    ...
    table.insert(
      data.raw.turret["bob-titan-explosive-worm-turret"].loot,
      { item = "alien-artifact-yellow", count_min = 3, count_max = 9, probability = 1 }
    )
    ...
    table.insert(
      data.raw.turret["bob-behemoth-explosive-worm-turret"].loot,
      { item = "alien-artifact-yellow", count_min = 4, count_max = 10, probability = 1 }
    )
    table.insert(
      data.raw.turret["bob-behemoth-explosive-worm-turret"].loot,
      { item = "alien-artifact-green", count_min = 1, count_max = 3, probability = 0.5 }
    ...
    table.insert(
      data.raw.turret["bob-leviathan-explosive-worm-turret"].loot,
      { item = "alien-artifact-yellow", count_min = 5, count_max = 11, probability = 1 }
    )
    table.insert(
      data.raw.turret["bob-leviathan-explosive-worm-turret"].loot,
      { item = "alien-artifact-green", count_min = 1, count_max = 3, probability = 1 }
    ...
    table.insert(
      data.raw.turret["bob-big-poison-worm-turret"].loot,
      { item = "alien-artifact-green", count_min = 2, count_max = 4, probability = 1 }
    )
    table.insert(
    ...
    table.insert(
      data.raw.turret["bob-huge-poison-worm-turret"].loot,
      { item = "alien-artifact-green", count_min = 2, count_max = 6, probability = 1 }
    )
    table.insert(
    ...
    table.insert(
      data.raw.turret["bob-giant-poison-worm-turret"].loot,
      { item = "alien-artifact-green", count_min = 3, count_max = 7, probability = 1 }
    )
    table.insert(
    ...
    table.insert(
      data.raw.turret["bob-titan-poison-worm-turret"].loot,
      { item = "alien-artifact-green", count_min = 3, count_max = 9, probability = 1 }
    )
    ...
    table.insert(
      data.raw.turret["bob-behemoth-poison-worm-turret"].loot,
      { item = "alien-artifact-green", count_min = 4, count_max = 10, probability = 1 }
    )
    table.insert(
      data.raw.turret["bob-behemoth-poison-worm-turret"].loot,
      { item = "alien-artifact-orange", count_min = 1, count_max = 3, probability = 0.5 }
    ...
    table.insert(
      data.raw.turret["bob-leviathan-poison-worm-turret"].loot,
      { item = "alien-artifact-green", count_min = 5, count_max = 11, probability = 1 }
    )
    table.insert(
      data.raw.turret["bob-leviathan-poison-worm-turret"].loot,
      { item = "alien-artifact-orange", count_min = 1, count_max = 3, probability = 1 }
    ...
    table.insert(
      data.raw.turret["bob-big-fire-worm-turret"].loot,
      { item = "alien-artifact-red", count_min = 2, count_max = 4, probability = 1 }
    )
    table.insert(
    ...
    table.insert(
      data.raw.turret["bob-huge-fire-worm-turret"].loot,
      { item = "alien-artifact-red", count_min = 2, count_max = 6, probability = 1 }
    )
    table.insert(
    ...
    table.insert(
      data.raw.turret["bob-giant-fire-worm-turret"].loot,
      { item = "alien-artifact-red", count_min = 3, count_max = 7, probability = 1 }
    )
    table.insert(
    ...
    table.insert(
      data.raw.turret["bob-titan-fire-worm-turret"].loot,
      { item = "alien-artifact-red", count_min = 3, count_max = 9, probability = 1 }
    )
    ...
    table.insert(
      data.raw.turret["bob-behemoth-fire-worm-turret"].loot,
      { item = "alien-artifact-red", count_min = 4, count_max = 10, probability = 1 }
    )
    table.insert(
      data.raw.turret["bob-behemoth-fire-worm-turret"].loot,
      { item = "alien-artifact-blue", count_min = 1, count_max = 3, probability = 0.5 }
    ...
    table.insert(
      data.raw.turret["bob-leviathan-fire-worm-turret"].loot,
      { item = "alien-artifact-red", count_min = 5, count_max = 11, probability = 1 }
    )
    table.insert(
      data.raw.turret["bob-leviathan-fire-worm-turret"].loot,
      { item = "alien-artifact-blue", count_min = 1, count_max = 3, probability = 1 }
