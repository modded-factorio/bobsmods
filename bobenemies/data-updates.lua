if settings.startup["bobmods-enemies-enableartifacts"].value == true and settings.startup["bobmods-enemies-aliensdropartifacts"].value == true then
  ...
  if data.raw.unit["small-biter"] then
    ...
    if settings.startup["bobmods-enemies-enablesmallartifacts"].value == true then
      table.insert(data.raw.unit["small-biter"].loot, {
  ...
  if data.raw.unit["small-spitter"] then
    ...
    if settings.startup["bobmods-enemies-enablesmallartifacts"].value == true then
      table.insert(data.raw.unit["small-spitter"].loot, {
        item = "small-alien-artifact",
        count_min = 1,
        count_max = 1,
        probability = 0.5
    ...
    if settings.startup["bobmods-enemies-enablesmallartifacts"].value == true then
      if settings.startup["bobmods-enemies-enablenewartifacts"].value == true then
        table.insert(data.raw.unit["bob-big-piercing-biter"].loot, {
          item = "small-alien-artifact-blue",
          count_min = 1,
          count_max = 3,
          probability = 1
        })
    ...
    if settings.startup["bobmods-enemies-enablesmallartifacts"].value == true then
      if settings.startup["bobmods-enemies-enablenewartifacts"].value == true then
        table.insert(data.raw.unit["bob-big-electric-spitter"].loot, {
          item = "small-alien-artifact-orange",
          count_min = 1,
          count_max = 3,
          probability = 1
        })
  ...
  if data.raw.unit["bob-huge-acid-biter"] ~= nil then
    ...
    if settings.startup["bobmods-enemies-enablesmallartifacts"].value == true then
      if settings.startup["bobmods-enemies-enablenewartifacts"].value == true then
        table.insert(data.raw.unit["bob-huge-acid-biter"].loot, {
          item = "small-alien-artifact-blue",
          count_min = 1,
          count_max = 1,
          probability = 0.5
        ...
        table.insert(data.raw.unit["bob-huge-acid-biter"].loot, {
          item = "small-alien-artifact-purple",
          count_min = 1,
          count_max = 3,
          probability = 1
        })
  ...
  if data.raw.unit["bob-huge-explosive-biter"] ~= nil then
    ...
    if settings.startup["bobmods-enemies-enablesmallartifacts"].value == true then
      if settings.startup["bobmods-enemies-enablenewartifacts"].value == true then
        table.insert(data.raw.unit["bob-huge-explosive-biter"].loot, {
          item = "small-alien-artifact-blue",
          count_min = 1,
          count_max = 1,
          probability = 0.5
        ...
        table.insert(data.raw.unit["bob-huge-explosive-biter"].loot, {
          item = "small-alien-artifact-yellow",
          count_min = 1,
          count_max = 3,
          probability = 1
        })
  ...
  if data.raw.unit["bob-huge-explosive-spitter"] ~= nil then
    ...
    if settings.startup["bobmods-enemies-enablesmallartifacts"].value == true then
      if settings.startup["bobmods-enemies-enablenewartifacts"].value == true then
        table.insert(data.raw.unit["bob-huge-explosive-spitter"].loot, {
          item = "small-alien-artifact-orange",
          count_min = 1,
          count_max = 1,
          probability = 0.5
  ...
  if data.raw.unit["bob-huge-acid-spitter"] ~= nil then
    ...
    if settings.startup["bobmods-enemies-enablesmallartifacts"].value == true then
      if settings.startup["bobmods-enemies-enablenewartifacts"].value == true then
        table.insert(data.raw.unit["bob-huge-acid-spitter"].loot, {
          item = "small-alien-artifact-orange",
          count_min = 1,
          count_max = 1,
          probability = 0.5
  ...
  if data.raw.unit["bob-giant-poison-biter"] ~= nil then
    ...
    if settings.startup["bobmods-enemies-enablesmallartifacts"].value == true then
      if settings.startup["bobmods-enemies-enablenewartifacts"].value == true then
        table.insert(data.raw.unit["bob-giant-poison-biter"].loot, {
          item = "small-alien-artifact-blue",
          count_min = 1,
          count_max = 3,
          probability = 0.5
        ...
        table.insert(data.raw.unit["bob-giant-poison-biter"].loot, {
          item = "small-alien-artifact-green",
          count_min = 1,
          count_max = 3,
          probability = 1
        })
  ...
  if data.raw.unit["bob-giant-fire-biter"] ~= nil then
    ...
    if settings.startup["bobmods-enemies-enablesmallartifacts"].value == true then
      if settings.startup["bobmods-enemies-enablenewartifacts"].value == true then
        table.insert(data.raw.unit["bob-giant-fire-biter"].loot, {
          item = "small-alien-artifact-blue",
          count_min = 1,
          count_max = 3,
          probability = 0.5
  ...
  if data.raw.unit["bob-giant-fire-spitter"] ~= nil then
    ...
    if settings.startup["bobmods-enemies-enablesmallartifacts"].value == true then
      if settings.startup["bobmods-enemies-enablenewartifacts"].value == true then
        table.insert(data.raw.unit["bob-giant-fire-spitter"].loot, {
          item = "small-alien-artifact-orange",
          count_min = 1,
          count_max = 3,
          probability = 0.5
  ...
  if data.raw.unit["bob-giant-poison-spitter"] ~= nil then
    ...
    if settings.startup["bobmods-enemies-enablesmallartifacts"].value == true then
      if settings.startup["bobmods-enemies-enablenewartifacts"].value == true then
        table.insert(data.raw.unit["bob-giant-poison-spitter"].loot, {
          item = "small-alien-artifact-orange",
          count_min = 1,
          count_max = 3,
          probability = 0.5
  ...
  if data.raw.unit["bob-titan-biter"] ~= nil then
    ...
    if settings.startup["bobmods-enemies-enablesmallartifacts"].value == true then
      if settings.startup["bobmods-enemies-enablenewartifacts"].value == true then
        table.insert(data.raw.unit["bob-titan-biter"].loot, {
          item = "small-alien-artifact-blue",
          count_min = 1,
          count_max = 3,
          probability = 1
  ...
  if data.raw.unit["bob-titan-spitter"] ~= nil then
    ...
    if settings.startup["bobmods-enemies-enablesmallartifacts"].value == true then
      if settings.startup["bobmods-enemies-enablenewartifacts"].value == true then
        table.insert(data.raw.unit["bob-titan-spitter"].loot, {
          item = "small-alien-artifact-orange",
          count_min = 1,
          count_max = 3,
          probability = 1
  ...
  if data.raw.unit["bob-behemoth-biter"] ~= nil then
    ...
    if settings.startup["bobmods-enemies-enablesmallartifacts"].value == true then
      if settings.startup["bobmods-enemies-enablenewartifacts"].value == true then
        table.insert(data.raw.unit["bob-behemoth-biter"].loot, {
          item = "small-alien-artifact-blue",
          count_min = 1,
          count_max = 3,
          probability = 1
  ...
  if data.raw.unit["bob-behemoth-spitter"] ~= nil then
    ...
    if settings.startup["bobmods-enemies-enablesmallartifacts"].value == true then
      if settings.startup["bobmods-enemies-enablenewartifacts"].value == true then
        table.insert(data.raw.unit["bob-behemoth-spitter"].loot, {
          item = "small-alien-artifact-orange",
          count_min = 1,
          count_max = 3,
          probability = 1
  ...
  if data.raw.unit["bob-leviathan-biter"] ~= nil then
    ...
    if settings.startup["bobmods-enemies-enablenewartifacts"].value == true then
      table.insert(data.raw.unit["bob-leviathan-biter"].loot, {
        item = "alien-artifact-blue",
        count_min = 1,
        count_max = 2,
        probability = 1
      })
      table.insert(data.raw.unit["bob-leviathan-biter"].loot, {
        item = "alien-artifact-orange",
        count_min = 1,
        count_max = 1,
        probability = 0.5
      })
      table.insert(data.raw.unit["bob-leviathan-biter"].loot, {
        item = "alien-artifact-purple",
        count_min = 1,
        count_max = 2,
        probability = 1
      })
      table.insert(data.raw.unit["bob-leviathan-biter"].loot, {
        item = "alien-artifact-yellow",
        count_min = 1,
        count_max = 1,
        probability = 0.5
      })
      table.insert(data.raw.unit["bob-leviathan-biter"].loot, {
        item = "alien-artifact-green",
        count_min = 1,
        count_max = 2,
        probability = 1
      })
      table.insert(data.raw.unit["bob-leviathan-biter"].loot, {
        item = "alien-artifact-red",
        count_min = 1,
        count_max = 1,
        probability = 1
      })
...
if settings.startup["bobmods-enemies-enableartifacts"].value == true then
  if data.raw["unit-spawner"]["biter-spawner"] then
    ...
    table.insert(data.raw["unit-spawner"]["biter-spawner"].loot, {
      item = "alien-artifact",
      count_min = 5,
      count_max = 15,
      probability = 1
  ...
  if data.raw["unit-spawner"]["spitter-spawner"] then
    ...
    table.insert(data.raw["unit-spawner"]["spitter-spawner"].loot, {
      item = "alien-artifact",
      count_min = 5,
      count_max = 15,
      probability = 1
  ...
  if data.raw["unit-spawner"]["bob-biter-spawner"] then
    ...
    table.insert(data.raw["unit-spawner"]["bob-biter-spawner"].loot, {
      item = "alien-artifact",
      count_min = 5,
      count_max = 15,
      probability = 1
  ...
  if data.raw["unit-spawner"]["bob-spitter-spawner"] then
    ...
    table.insert(data.raw["unit-spawner"]["bob-spitter-spawner"].loot, {
      item = "alien-artifact",
      count_min = 5,
      count_max = 15,
      probability = 1
  ...
  if data.raw["unit-spawner"]["bob-super-spawner"] then
    ...
    table.insert(data.raw["unit-spawner"]["bob-super-spawner"].loot, {
      item = "alien-artifact",
      count_min = 20,
      count_max = 60,
      probability = 1
  ...
  if data.raw.turret["small-worm-turret"] then
    ...
    table.insert(data.raw.turret["small-worm-turret"].loot, {
      item = "alien-artifact",
      count_min = 1,
      count_max = 3,
      probability = 1
  ...
  if data.raw.turret["medium-worm-turret"] then
    ...
    table.insert(data.raw.turret["medium-worm-turret"].loot, {
      item = "alien-artifact",
      count_min = 2,
      count_max = 4,
      probability = 1
  ...
  if data.raw.turret["bob-big-explosive-worm-turret"] then
    ...
    if settings.startup["bobmods-enemies-enablenewartifacts"].value == true then
      table.insert(data.raw.turret["bob-big-explosive-worm-turret"].loot, {
        item = "alien-artifact-yellow",
        count_min = 1,
        count_max = 2,
        probability = 1
  ...
  if data.raw.turret["bob-big-poison-worm-turret"] then
    ...
    if settings.startup["bobmods-enemies-enablenewartifacts"].value == true then
      table.insert(data.raw.turret["bob-big-poison-worm-turret"].loot, {
        item = "alien-artifact-green",
        count_min = 1,
        count_max = 2,
        probability = 1
  ...
  if data.raw.turret["bob-big-fire-worm-turret"] then
    ...
    if settings.startup["bobmods-enemies-enablenewartifacts"].value == true then
      table.insert(data.raw.turret["bob-big-fire-worm-turret"].loot, {
        item = "alien-artifact-red",
        count_min = 1,
        count_max = 2,
        probability = 1
  ...
  if data.raw.turret["bob-big-piercing-worm-turret"] then
    ...
    if settings.startup["bobmods-enemies-enablenewartifacts"].value == true then
      table.insert(data.raw.turret["bob-big-piercing-worm-turret"].loot, {
        item = "alien-artifact-blue",
        count_min = 1,
        count_max = 2,
        probability = 1
  ...
  if data.raw.turret["bob-big-electric-worm-turret"] then
    ...
    if settings.startup["bobmods-enemies-enablenewartifacts"].value == true then
      table.insert(data.raw.turret["bob-big-electric-worm-turret"].loot, {
        item = "alien-artifact-orange",
        count_min = 1,
        count_max = 2,
        probability = 1
  ...
  if data.raw.turret["bob-giant-worm-turret"] then
    ...
    table.insert(data.raw.turret["bob-giant-worm-turret"].loot, {
      item = "alien-artifact",
      count_min = 4,
      count_max = 8,
      probability = 1
