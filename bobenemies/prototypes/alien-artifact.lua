...
if settings.startup["bobmods-enemies-enableartifacts"].value == true then
  ...
  if settings.startup["bobmods-enemies-enablesmallartifacts"].value == true then
    data:extend({{
      ...
      ingredients = {{"small-alien-artifact", 25}},
      energy_required = 1,
      enabled = "true",
      category = "crafting"
    }})
  ...
  if settings.startup["bobmods-enemies-enablenewartifacts"].value == true then
    data:extend({{
      ...
      result_count = 5,
      ingredients = {{"alien-artifact-red", 1}, {"alien-artifact", 5}},
      energy_required = 1,
      enabled = "true",
      category = "crafting"
    }, {
      ...
      result_count = 5,
      ingredients = {{"alien-artifact-orange", 1}, {"alien-artifact", 5}},
      energy_required = 1,
      enabled = "true",
      category = "crafting"
    }, {
      ...
      result_count = 5,
      ingredients = {{"alien-artifact-yellow", 1}, {"alien-artifact", 5}},
      energy_required = 1,
      enabled = "true",
      category = "crafting"
    }, {
      ...
      result_count = 5,
      ingredients = {{"alien-artifact-green", 1}, {"alien-artifact", 5}},
      energy_required = 1,
      enabled = "true",
      category = "crafting"
    }, {
      ...
      result_count = 5,
      ingredients = {{"alien-artifact-blue", 1}, {"alien-artifact", 5}},
      energy_required = 1,
      enabled = "true",
      category = "crafting"
    }, {
      ...
      result_count = 5,
      ingredients = {{"alien-artifact-purple", 1}, {"alien-artifact", 5}},
      energy_required = 1,
      enabled = "true",
      category = "crafting"
    }})
    ...
    if settings.startup["bobmods-enemies-enablesmallartifacts"].value == true then
      data:extend({{
        ...
        result = "alien-artifact-red",
        ingredients = {{"small-alien-artifact-red", 25}},
        energy_required = 1,
        enabled = "true",
        category = "crafting"
      }})
      ...
      data:extend({{
        ...
        result = "alien-artifact-orange",
        ingredients = {{"small-alien-artifact-orange", 25}},
        energy_required = 1,
        enabled = "true",
        category = "crafting"
      }})
      ...
      data:extend({{
        ...
        result = "alien-artifact-yellow",
        ingredients = {{"small-alien-artifact-yellow", 25}},
        energy_required = 1,
        enabled = "true",
        category = "crafting"
      }})
      ...
      data:extend({{
        ...
        result = "alien-artifact-green",
        ingredients = {{"small-alien-artifact-green", 25}},
        energy_required = 1,
        enabled = "true",
        category = "crafting"
      }})
      ...
      data:extend({{
        ...
        result = "alien-artifact-blue",
        ingredients = {{"small-alien-artifact-blue", 25}},
        energy_required = 1,
        enabled = "true",
        category = "crafting"
      }})
      ...
      data:extend({{
        ...
        result = "alien-artifact-purple",
        ingredients = {{"small-alien-artifact-purple", 25}},
        energy_required = 1,
        enabled = "true",
        category = "crafting"
      }})
