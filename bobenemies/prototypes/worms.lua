...
local function set_worm_animations(entiy, scale, tint)
  ...
  entiy.prepared_alternative_animation =
    worm_prepared_alternative_animation(scale, tint)
...
data:extend({util.merge{data.raw.turret["big-worm-turret"], {
...
set_worm_animations(
  ...
  scale_worm_big,
  bobmods.enemies.acid_worm_tint
)
...
data.raw.turret["big-worm-turret"].attack_parameters = {
  ...
  projectile_creation_parameters = worm_shoot_shiftings(
    scale_worm_big,
    scale_worm_big * scale_worm_stream
  ),
...
set_worm_animations(
  data.raw.turret["bob-big-fire-worm-turret"],
  scale_worm_big,
...
set_worm_animations(
  data.raw.turret["bob-big-poison-worm-turret"],
  scale_worm_big,
...
set_worm_animations(
  data.raw.turret["bob-big-piercing-worm-turret"],
  scale_worm_big,
...
set_worm_animations(
  data.raw.turret["bob-big-electric-worm-turret"],
  scale_worm_big,
...
data:extend({util.merge{data.raw.corpse["big-worm-corpse"], {
...
data.raw.corpse["big-worm-corpse"].animation =
  worm_die_animation(scale_worm_big, bobmods.enemies.acid_worm_tint)
...
data:extend({{ -- this is same as particle horizontal speed of flamethrower fire stream
  type = "turret",
  ...
  folded_animation = worm_folded_animation(
  ...
  prepared_animation = worm_prepared_animation(
    bobmods.enemies.giant_scale,
    bobmods.enemies.giant_worm_tint
  ),
  ...
  ending_attack_animation = worm_end_attack_animation(
    bobmods.enemies.giant_scale,
    bobmods.enemies.giant_worm_tint
  ),
  folding_speed = 0.015,
...
data.raw.corpse["bob-giant-worm-corpse"].ground_patch =
  {sheet = worm_integration(bobmods.enemies.giant_scale)}
...
data.raw.turret["behemoth-worm-turret"].collision_box =
  {{-2.8, -2.4}, {2.8, 2.4}}
data.raw.turret["behemoth-worm-turret"].selection_box =
  {{-2.8, -2.4}, {2.8, 2.4}}
data.raw.turret["behemoth-worm-turret"].map_generator_bounding_box =
  {{-3.8, -3.4}, {3.8, 3.4}}
data.raw.turret["behemoth-worm-turret"].integration =
  worm_integration(bobmods.enemies.behemoth_scale)
...
data.raw.corpse["behemoth-worm-corpse"].ground_patch =
  {sheet = worm_integration(bobmods.enemies.behemoth_scale)}