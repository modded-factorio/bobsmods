local leviathanfrequency =
  settings.startup["bobmods-enemies-leviathanfrequency"].value
  ...
  -- With zero evolution the spawn rate is 3 seconds, with max evolution it is 1 seconds
    ...
    result_units = {
      ...
      {"medium-spitter", {{0.4, 0.0}, {0.6, 0.3}, {0.7, 0.0}}},
      {
        ...
        {{0.5, 0.0}, {0.6, 0.4}, {0.7, 0.4}, {0.8, 0.0}}
      },
      {
      ...
      {"bob-huge-acid-biter", {{0.6, 0.0}, {0.7, 0.3}, {0.8, 0.3}, {0.9, 0.0}}},
      {
        ...
        {{0.6, 0.0}, {0.7, 0.3}, {0.8, 0.3}, {0.9, 0.0}}
      },
      {
        "bob-giant-poison-biter",
        {{0.7, 0.0}, {0.8, 0.3}, {0.85, 0.3}, {0.95, 0.0}}
      },
      {
        "bob-giant-fire-spitter",
        {{0.7, 0.0}, {0.8, 0.3}, {0.85, 0.3}, {0.95, 0.0}}
      },
      {"bob-titan-biter", {{0.8, 0.0}, {0.9, 0.3}}},
      {"bob-titan-spitter", {{0.8, 0.0}, {0.9, 0.3}}},
...
if settings.startup["bobmods-enemies-biggersooner"].value == true then
  data.raw["unit-spawner"]["bob-biter-spawner"].build_base_evolution_requirement
  = 0.4
  ...
  data.raw["unit-spawner"]["bob-spitter-spawner"].build_base_evolution_requirement
  = 0.4
  ...
  if settings.startup["bobmods-enemies-superspawner"].value == true then
    data.raw["unit-spawner"]["bob-super-spawner"].build_base_evolution_requirement
    = 0.7
    data.raw["unit-spawner"]["bob-super-spawner"].result_units =
      {
        ...
        {
          "bob-big-piercing-biter",
          {{0.4, 0.0}, {0.5, 0.4}, {0.6, 0.4}, {0.7, 0.0}}
        },
        {
          "bob-big-electric-spitter",
          {{0.4, 0.0}, {0.5, 0.4}, {0.6, 0.4}, {0.7, 0.0}}
        ...
        {
          "bob-huge-acid-biter",
          {{0.5, 0.0}, {0.6, 0.3}, {0.7, 0.3}, {0.8, 0.0}}
        },
        {
          "bob-huge-explosive-spitter",
          {{0.5, 0.0}, {0.6, 0.3}, {0.7, 0.3}, {0.8, 0.0}}
