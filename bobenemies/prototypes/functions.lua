...
-- Faction names must not be a word that would be used elsewhere in any enemy names. For example, "spawner" would cause problems because that word appears in unit-spawner names. Size-related words like "giant" or "titan" also cannot be used. "basic" is also forbidden, since it is used as a placeholder for the vanilla faction.
