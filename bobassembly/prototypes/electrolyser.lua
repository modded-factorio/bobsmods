...
data:extend(
{
...

  {
    ...
    animation = bob_electrolyser_animation("__bobassembly__/graphics/entity/electrolyser", 2, {r = 0.5, g = 0.1, b = 0}),
...

  {
    ...
    fluid_boxes = bob_electrolyser_fluid_boxes(),
    animation = bob_electrolyser_animation("__bobassembly__/graphics/entity/electrolyser", 3, {r = 0, g = 0.3, b = 0.5}),
    working_sound = data.raw["assembling-machine"]["chemical-plant"].working_sound
  },

  {
    ...
    fluid_boxes = bob_electrolyser_fluid_boxes(),
    animation = bob_electrolyser_animation("__bobassembly__/graphics/entity/electrolyser", 4, {r = 0.5, g = 0, b = 0.5}),
    working_sound = data.raw["assembling-machine"]["chemical-plant"].working_sound
  },

  {
    ...
    fluid_boxes = bob_electrolyser_fluid_boxes(),
    animation = bob_electrolyser_animation("__bobassembly__/graphics/entity/electrolyser", 5, {r = 0, g = 0.5, b = 0}),
    working_sound = data.raw["assembling-machine"]["chemical-plant"].working_sound
  },
