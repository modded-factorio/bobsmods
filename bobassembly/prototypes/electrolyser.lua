if settings.startup["bobmods-assembly-electrolysers"].value and data.raw.technology["electrolysis-1"] and data.raw.item["electrolyser"] and data.raw["recipe-category"]["electrolysis"] then
  data:extend({{
    type = "item-subgroup",
  ...
  local function bob_electrolyser_animation_facing(
  directory,
    tier,
    tint,
    facing
  ...
  data:extend({{
    ...
    icon = "__bobassembly__/graphics/icons/technology/electrolyser.png",
    icon_size = 128,
    prerequisites = {"electrolyser-2", "chemical-science-pack"},
    effects = {{
      type = "unlock-recipe",
    ...
    icon = "__bobassembly__/graphics/icons/technology/electrolyser.png",
    icon_size = 128,
    prerequisites = {"electrolyser-4", "utility-science-pack"},
    effects = {{
      type = "unlock-recipe",
