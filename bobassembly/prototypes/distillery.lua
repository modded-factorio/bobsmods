if settings.startup["bobmods-plates-purewater"] and settings.startup["bobmods-plates-purewater"].value == true and settings.startup["bobmods-assembly-distilleries"].value then
  ...
  data:extend({{
    ...
    max_health = 250,
    animation = bobmods.plates.distillery_animation({
      r = 0.7,
      g = 0.2,
      b = 0.1
    }),
    working_visualisations = bobmods.plates.distillery_working_visualisations(
      1.5
    ),
    crafting_speed = 1.5,
    energy_usage = "260kW",
    ...
    icon_size = 128,
    prerequisites = {"bob-distillery-2", "chemical-science-pack"},
    effects = {{
      type = "unlock-recipe",
    ...
    icon_size = 128,
    prerequisites = {"bob-distillery-3", "production-science-pack"},
    effects = {{
      type = "unlock-recipe",
    ...
    icon_size = 128,
    prerequisites = {"bob-distillery-4", "utility-science-pack"},
    effects = {{
      type = "unlock-recipe",
