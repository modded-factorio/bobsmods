if settings.startup["bobmods-assembly-centrifuge"].value == true then
  ...
  data.raw["assembling-machine"]["centrifuge"].fast_replaceable_group =
    "centrifuge"
  ...
  data:extend({{
    ...
    result = "centrifuge-3",
    requester_paste_multiplier = 10
  }, util.merge{data.raw["assembling-machine"]["centrifuge"], {
    name = "centrifuge-2",
    icon = "__base__/graphics/icons/centrifuge.png",
    icon_size = 64,
    icon_mipmaps = 4,
    ...
    prerequisites = {"utility-science-pack", "centrifuge-2"},
    unit = {
      time = 30,
      count = 200,
      ingredients = {
