if settings.startup["bobmods-assembly-oilrefineries"].value == true then
  ...
  data.raw["assembling-machine"]["oil-refinery"].fast_replaceable_group =
    "oil-refinery"
  ...
  data:extend({{
    ...
    enabled = false
  }, util.merge{data.raw["assembling-machine"]["oil-refinery"], {
    name = "oil-refinery-2",
    icon = "__base__/graphics/icons/oil-refinery.png",
    icon_size = 64,
    icon_mipmaps = 4,
  ...
  data:extend({{
    ...
    icon_size = 256,
    icon_mipmaps = 4,
    prerequisites = {"oil-processing-3", "utility-science-pack"},
    order = "d-a4",
    unit = {
      count = 150,
      time = 30,
