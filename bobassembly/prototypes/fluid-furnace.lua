if settings.startup["bobmods-assembly-oilfurnaces"].value == true then
  ...
  data:extend({{
    ...
    stack_size = 50
  }, util.merge{data.raw.furnace["steel-furnace"], {
    name = "fluid-furnace",
    ...
    energy_required = 2,
    enabled = false,
    ingredients = {{"steel-furnace", 1}, {"pipe", 2}},
  ...
  if settings.startup["bobmods-plates-convert-recipes"] and settings.startup["bobmods-plates-convert-recipes"].value == true then
    data:extend({{
      ...
      energy_required = 0.1,
      enabled = false,
      ingredients = {{"fluid-furnace", 1}},
      results = {{"steel-furnace", 1}, {"pipe", 2}},
    ...
    if data.raw["item-subgroup"]["bob-base-smelting-machine-convert"] then
      data.raw.recipe["steel-furnace-from-fluid-furnace"].subgroup =
        "bob-base-smelting-machine-convert"
    end
  end

  if data.raw["assembling-machine"]["mixing-steel-furnace"] or data.raw["assembling-machine"]["steel-mixing-furnace"] then
    data:extend({{
      type = "item",
    ...
    if data.raw["assembling-machine"]["steel-mixing-furnace"] then
      bobmods.lib.recipe.add_ingredient("fluid-mixing-furnace", {
      ...
      data:extend({
        util.merge{data.raw["assembling-machine"]["steel-mixing-furnace"], {
          name = "fluid-mixing-furnace",
      ...
      data:extend({
        util.merge{data.raw["assembling-machine"]["mixing-steel-furnace"], {
          name = "fluid-mixing-furnace",
          minable = {result = "fluid-mixing-furnace"}
        }}
      })
    ...
    data.raw["assembling-machine"]["fluid-mixing-furnace"].energy_source =
      fluid_energy_source()
    ...
    if settings.startup["bobmods-plates-convert-recipes"] and settings.startup["bobmods-plates-convert-recipes"].value == true then
      data:extend({{
        ...
        energy_required = 0.1,
        enabled = false,
        ingredients = {{"fluid-mixing-furnace", 1}},
        results = {{"pipe", 2}},
      ...
      if data.raw["assembling-machine"]["steel-mixing-furnace"] then
        ...
        data.raw.recipe["steel-mixing-furnace-from-fluid-mixing-furnace"].main_product
        = "mixing-steel-furnace"
      end
  ...
  if data.raw["assembling-machine"]["chemical-steel-furnace"] or data.raw["assembling-machine"]["steel-chemical-furnace"] then
    data:extend({{
      type = "item",
    ...
    if data.raw["assembling-machine"]["steel-chemical-furnace"] then
      bobmods.lib.recipe.add_ingredient("fluid-chemical-furnace", {
        "steel-chemical-furnace",
        1
      })
      data:extend({
        util.merge{data.raw["assembling-machine"]["steel-chemical-furnace"], {
          name = "fluid-chemical-furnace",
      ...
      data:extend({
        util.merge{data.raw["assembling-machine"]["chemical-steel-furnace"], {
          name = "fluid-chemical-furnace",
          minable = {result = "fluid-chemical-furnace"}
        }}
      })
    ...
    data.raw["assembling-machine"]["fluid-chemical-furnace"].energy_source =
      fluid_energy_source()
    ...
    if settings.startup["bobmods-plates-convert-recipes"] and settings.startup["bobmods-plates-convert-recipes"].value == true then
      data:extend({{
        ...
        energy_required = 0.1,
        enabled = false,
        ingredients = {{"fluid-chemical-furnace", 1}},
        results = {{"pipe", 2}},
        ...
        energy_required = 2,
        enabled = false,
        ingredients = {{"fluid-furnace", 1}, {"pipe", 5}},
        result = "fluid-chemical-furnace",
        allow_as_intermediate = false
      }, {
        type = "recipe",
        ...
        enabled = false,
        ingredients = {{"fluid-chemical-furnace", 1}},
        results = {{"fluid-furnace", 1}, {"pipe", 5}},
      ...
      if data.raw["assembling-machine"]["steel-chemical-furnace"] then
        ...
        data.raw.recipe["steel-chemical-furnace-from-fluid-chemical-furnace"].main_product
        = "chemical-steel-furnace"
      end
