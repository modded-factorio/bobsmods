if settings.startup["bobmods-assembly-chemicalplants"].value == true then
  data.raw["assembling-machine"]["chemical-plant"].next_upgrade =
    "chemical-plant-2"
  ...
  if data.raw.item["titanium-bearing"] then
    bobmods.lib.recipe.add_ingredient("chemical-plant-3", {
      "titanium-bearing",
      5
    })
  end
  ...
  if data.raw.item["nitinol-bearing"] then
    bobmods.lib.recipe.add_ingredient("chemical-plant-4", {
      "nitinol-bearing",
      5
    })
  end
  ...
  if settings.startup["bobmods-colorupdate"].value == true then
    data.raw.item["chemical-plant"].icon =
      "__bobassembly__/graphics/icons/chemical-plant-3.png"
    data.raw.item["chemical-plant"].icon_size = 32
    data.raw.item["chemical-plant"].icon_mipmaps = nil
    data.raw["assembling-machine"]["chemical-plant"].icon =
      "__bobassembly__/graphics/icons/chemical-plant-3.png"
    ...
    data.raw.item["chemical-plant-2"].icon =
    ...
    data.raw.item["chemical-plant-3"].icon =
      "__bobassembly__/graphics/icons/chemical-plant-2.png"
    data.raw.item["chemical-plant-3"].icon_size = 32
    data.raw["assembling-machine"]["chemical-plant-3"].icon =
      "__bobassembly__/graphics/icons/chemical-plant-2.png"
