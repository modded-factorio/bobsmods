if settings.startup["bobmods-assembly-oilrefineries"].value == true then
  ...
  if mods["bobplates"] then
    ...
    bobmods.lib.recipe.add_ingredient("bob-oil-refinery-2", { type = "item", name = "bob-cobalt-steel-bearing", amount = 5 })
    ...
    bobmods.lib.recipe.add_ingredient("bob-oil-refinery-3", { type = "item", name = "bob-titanium-bearing", amount = 5 })
