...
if data.raw.item["electronics-machine-1"] then
  ...
  data.raw["assembling-machine"]["electronics-machine-1"].crafting_categories = {"electronics", "electronics-machine", "electronics-with-fluid", "crafting-or-electromagnetics"}
  data.raw["assembling-machine"]["electronics-machine-2"].crafting_categories = {"electronics", "electronics-machine", "electronics-with-fluid", "crafting-or-electromagnetics"}
  data.raw["assembling-machine"]["electronics-machine-3"].crafting_categories = {"electronics", "electronics-machine", "electronics-with-fluid", "crafting-or-electromagnetics"}
