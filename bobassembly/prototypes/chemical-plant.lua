if settings.startup["bobmods-assembly-chemicalplants"].value == true then
  ...
  data.raw["assembling-machine"]["chemical-plant"].fast_replaceable_group =
    "chemical-plant"
  ...
  data:extend({{
    ...
    animation = bob_chemical_plant_animation({
      r = 0.5,
      g = 0.1,
      b = 0.7
    }),
    ...
    icon_size = 128,
    prerequisites = {"advanced-electronics", "chemical-science-pack"},
    effects = {{
      type = "unlock-recipe",
    ...
    icon_size = 128,
    prerequisites = {"chemical-plant-3", "utility-science-pack"},
    effects = {{
      type = "unlock-recipe",
