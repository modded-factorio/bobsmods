...
data.raw.technology["automation-3"].prerequisites =
  {"automation-2", "steel-processing", "advanced-electronics"}
...
if data.raw.item["steel-gear-wheel"] then
  bobmods.lib.recipe.add_ingredient("assembling-machine-3", {
    "steel-gear-wheel",
    5
  })
else
...
data.raw["assembling-machine"]["assembling-machine-3"].module_specification.module_slots
= 3
data.raw["assembling-machine"]["assembling-machine-3"].next_upgrade =
...
if data.raw.item["steel-bearing"] then
  bobmods.lib.recipe.add_ingredient("assembling-machine-4", {
    "steel-bearing",
    5
  })
else
...
if data.raw.item["titanium-bearing"] then
  bobmods.lib.recipe.add_ingredient("assembling-machine-5", {
    "titanium-bearing",
    5
  })
else
...
if data.raw.item["nitinol-bearing"] then
  bobmods.lib.recipe.add_ingredient("assembling-machine-6", {
    "nitinol-bearing",
    5
  })
else
...
if settings.startup["bobmods-colorupdate"].value == true then
  data.raw.item["assembling-machine-2"].icon =
  ...
  table.insert(
    data.raw["assembling-machine"]["assembling-machine-2"].animation.layers,
    {
  ...
  data.raw.item["assembling-machine-3"].icon =
  ...
  table.insert(
    data.raw["assembling-machine"]["assembling-machine-3"].animation.layers,
    {
      filename = "__bobassembly__/graphics/entity/assembling-machine/assembling-machine-mask.png",
      priority = "high",
      width = 142,
  ...
  data.raw.item["assembling-machine-4"].icon =
  ...
  data.raw.item["assembling-machine-5"].icon =
  ...
  data.raw["assembling-machine"]["assembling-machine-5"].animation.layers[2].tint
  = {
    r = 0.7,
    g = 0.1,
    b = 0.7
