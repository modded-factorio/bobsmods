if settings.startup["bobmods-assembly-burner"].value == true then
  data:extend({{ --fairly sure this scales, so it would be 1 at level 1 speed.
    type = "item",
    ...
    name = "burner-assembling-machine",
    enabled = false,
    ingredients = {{"iron-gear-wheel", 5}, {"iron-plate", 9}},
    ...
    name = "steam-assembling-machine",
    enabled = false,
    ingredients = {{"iron-gear-wheel", 10}, {"iron-plate", 10}, {"pipe", 5}},
  ...
  if settings.startup["bobmods-assembly-limits"].value == true then
    data.raw["assembling-machine"]["burner-assembling-machine"].ingredient_count
    = 2
    data.raw["assembling-machine"]["steam-assembling-machine"].ingredient_count
    = 4
  end
end