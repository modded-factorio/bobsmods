if settings.startup["bobmods-assembly-electronicmachines"].value == true then
  ...
  if data.raw.item["steel-bearing"] then
    bobmods.lib.recipe.add_ingredient("electronics-machine-2", {
      "steel-bearing",
      5
    })
  else
  ...
  if data.raw.item["titanium-bearing"] then
    bobmods.lib.recipe.add_ingredient("electronics-machine-3", {
      "titanium-bearing",
      5
    })
  else
  ...
  if settings.startup["bobmods-colorupdate"].value == true then
    data.raw.item["electronics-machine-1"].icon =
    ...
    data.raw["assembling-machine"]["electronics-machine-1"].animation.layers[2].tint
    = {
      r = 0.7,
      g = 0.7,
      b = 0.1
    ...
    data.raw.item["electronics-machine-2"].icon =
    ...
    data.raw["assembling-machine"]["electronics-machine-2"].animation.layers[2].tint
    = {
      r = 0.1,
      g = 0.5,
      b = 0.7
