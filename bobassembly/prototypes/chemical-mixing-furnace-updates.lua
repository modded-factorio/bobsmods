if settings.startup["bobmods-assembly-multipurposefurnaces"].value and data.raw["item-subgroup"]["bob-smelting-machine"] and data.raw["recipe-category"]["chemical-furnace"] and data.raw["recipe-category"]["mixing-furnace"] and (data.raw.technology["alloy-processing-2"] or data.raw.technology["electric-mixing-furnace"]) and (data.raw.technology["chemical-processing-3"] or data.raw.technology["electric-chemical-furnace"]) then
  --older plates mod
  ...
  if data.raw["assembling-machine"]["chemical-furnace"] then
    data.raw["assembling-machine"]["chemical-furnace"].next_upgrade =
      "electric-chemical-mixing-furnace"
  elseif data.raw["assembling-machine"]["electric-chemical-furnace"] then
    data.raw["assembling-machine"]["electric-chemical-furnace"].next_upgrade =
      "electric-chemical-mixing-furnace"
  end

  data.raw["assembling-machine"]["electric-mixing-furnace"].next_upgrade =
    "electric-chemical-mixing-furnace"
  ...
  if settings.startup["bobmods-assembly-limits"].value == true then
    data.raw["assembling-machine"]["electric-chemical-mixing-furnace"].ingredient_count
    = 6
    data.raw["assembling-machine"]["electric-chemical-mixing-furnace-2"].ingredient_count
    = 8
    ...
    elseif data.raw["assembling-machine"]["stone-chemical-furnace"] then
      data.raw["assembling-machine"]["stone-chemical-furnace"].ingredient_count
      = 2
    end
    if data.raw["assembling-machine"]["chemical-steel-furnace"] then
      data.raw["assembling-machine"]["chemical-steel-furnace"].ingredient_count
      = 4
    elseif data.raw["assembling-machine"]["steel-chemical-furnace"] then
      data.raw["assembling-machine"]["steel-chemical-furnace"].ingredient_count
      = 4
    end
    if data.raw["assembling-machine"]["chemical-furnace"] then
      data.raw["assembling-machine"]["chemical-furnace"].ingredient_count = 4
    elseif data.raw["assembling-machine"]["electric-chemical-furnace"] then
      data.raw["assembling-machine"]["electric-chemical-furnace"].ingredient_count
      = 4
    end
    ...
    elseif data.raw["assembling-machine"]["stone-mixing-furnace"] then
      data.raw["assembling-machine"]["stone-mixing-furnace"].ingredient_count =
        2
    end
    if data.raw["assembling-machine"]["mixing-steel-furnace"] then
      data.raw["assembling-machine"]["mixing-steel-furnace"].ingredient_count =
        4
    elseif data.raw["assembling-machine"]["steel-mixing-furnace"] then
      data.raw["assembling-machine"]["steel-mixing-furnace"].ingredient_count =
        2
    end
    if data.raw["assembling-machine"]["electric-mixing-furnace"] then
      data.raw["assembling-machine"]["electric-mixing-furnace"].ingredient_count
      = 4
    end
  end
end