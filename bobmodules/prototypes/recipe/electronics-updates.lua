...
if data.raw.item["gold-plate"] then
  ...
  bobmods.lib.recipe.add_ingredient("module-processor-board-2", {
    "gold-plate",
    1
  })
  bobmods.lib.recipe.add_ingredient("module-processor-board-3", {
    "gold-plate",
    2
  })
...
if data.raw.fluid["ferric-chloride-solution"] then
  bobmods.lib.recipe.add_ingredient("module-circuit-board", {
    "ferric-chloride-solution",
    5
  })
  bobmods.lib.recipe.add_ingredient("module-processor-board", {
    "ferric-chloride-solution",
    5
  })
  bobmods.lib.recipe.add_ingredient("module-processor-board-2", {
...
if data.raw.item["processing-electronics"] then
  bobmods.lib.recipe.add_difficulty_ingredient("speed-processor-3", "normal", {
...
if data.raw.item["solder"] then
  ...
  bobmods.lib.recipe.add_ingredient("pollution-clean-processor-2", {
    "solder",
    2
  })
  bobmods.lib.recipe.add_ingredient("pollution-create-processor-2", {
    "solder",
    2
  })
  ...
  bobmods.lib.recipe.add_ingredient("pollution-clean-processor-3", {
    "solder",
    3
  })
  bobmods.lib.recipe.add_ingredient("pollution-create-processor-3", {
    "solder",
    3
  })
end
