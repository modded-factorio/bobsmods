if settings.startup["bobmods-modules-enablerawspeedmodules"].value == true then
  ...
  data:extend({{
    ...
    enabled = false,
    ingredients = {{"speed-module", 1}, {"effectivity-module", 1}},
    energy_required = 15,
    ...
    subgroup = "raw-speed-module-combine",
    enabled = false,
    ingredients = {{"speed-module-2", 1}, {"effectivity-module-2", 1}},
    energy_required = 30,
    allow_as_intermediate = false,
    result = "raw-speed-module-2"
  }, {
    ...
    subgroup = "raw-speed-module-combine",
    enabled = false,
    ingredients = {{"speed-module-3", 1}, {"effectivity-module-3", 1}},
    energy_required = 45,
    allow_as_intermediate = false,
    result = "raw-speed-module-3"
  }, {
    ...
    subgroup = "raw-speed-module-combine",
    enabled = false,
    ingredients = {{"speed-module-4", 1}, {"effectivity-module-4", 1}},
    energy_required = 60,
    allow_as_intermediate = false,
    result = "raw-speed-module-4"
  }, {
    ...
    subgroup = "raw-speed-module-combine",
    enabled = false,
    ingredients = {{"speed-module-5", 1}, {"effectivity-module-5", 1}},
    energy_required = 75,
    allow_as_intermediate = false,
    result = "raw-speed-module-5"
  }, {
    ...
    subgroup = "raw-speed-module-combine",
    enabled = false,
    ingredients = {{"speed-module-6", 1}, {"effectivity-module-6", 1}},
    energy_required = 90,
    allow_as_intermediate = false,
    result = "raw-speed-module-6"
  }, {
    ...
    subgroup = "raw-speed-module-combine",
    enabled = false,
    ingredients = {{"speed-module-7", 1}, {"effectivity-module-7", 1}},
    energy_required = 105,
    allow_as_intermediate = false,
    result = "raw-speed-module-7"
  }, {
    ...
    subgroup = "raw-speed-module-combine",
    enabled = false,
    ingredients = {{"speed-module-8", 1}, {"effectivity-module-8", 1}},
    energy_required = 120,
    allow_as_intermediate = false,
    result = "raw-speed-module-8"
  }})
...
if settings.startup["bobmods-modules-enablegreenmodules"].value == true then
  ...
  data:extend({{
    ...
    enabled = false,
    ingredients = {{"effectivity-module", 1}, {"pollution-clean-module-1", 1}},
    energy_required = 15,
    allow_as_intermediate = false,
    result = "green-module-1"
  }, {
