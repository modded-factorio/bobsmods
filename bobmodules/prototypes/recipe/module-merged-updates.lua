if settings.startup["bobmods-modules-enablerawspeedmodules"].value == true then
  if data.raw.item["solder"] then
    bobmods.lib.recipe.add_ingredient("raw-speed-module-1-combine", {
      "solder",
      1
    })

    bobmods.lib.recipe.add_ingredient("raw-speed-module-2", {"solder", 2})
    bobmods.lib.recipe.add_ingredient("raw-speed-module-2-combine", {
      "solder",
      2
    })

    bobmods.lib.recipe.add_ingredient("raw-speed-module-3", {"solder", 3})
    bobmods.lib.recipe.add_ingredient("raw-speed-module-3-combine", {
      "solder",
      3
    })

    bobmods.lib.recipe.add_ingredient("raw-speed-module-4", {"solder", 5})
    bobmods.lib.recipe.add_ingredient("raw-speed-module-4-combine", {
      "solder",
      4
    })

    bobmods.lib.recipe.add_ingredient("raw-speed-module-5", {"solder", 6})
    bobmods.lib.recipe.add_ingredient("raw-speed-module-5-combine", {
      "solder",
      6
    })

    bobmods.lib.recipe.add_ingredient("raw-speed-module-6", {"solder", 7})
    bobmods.lib.recipe.add_ingredient("raw-speed-module-6-combine", {
      "solder",
      7
    })

    bobmods.lib.recipe.add_ingredient("raw-speed-module-7", {"solder", 10})
    bobmods.lib.recipe.add_ingredient("raw-speed-module-7-combine", {
      "solder",
      8
    })

    bobmods.lib.recipe.add_ingredient("raw-speed-module-8", {"solder", 12})
    bobmods.lib.recipe.add_ingredient("raw-speed-module-8-combine", {
      "solder",
      10
    })
  else
    bobmods.lib.recipe.add_ingredient("raw-speed-module-3", {
      "module-contact",
      5
    })
  end
  ...
  if data.raw.item["processing-electronics"] then
    bobmods.lib.recipe.add_ingredient("raw-speed-module-7", {
      "processing-electronics",
      5
    })
    bobmods.lib.recipe.add_ingredient("raw-speed-module-8", {
      "processing-electronics",
      8
    })
  else
  ...
  if data.raw.item["ruby-5"] then
    ...
    if data.raw.item["alien-artifact"] then
      bobmods.lib.recipe.add_ingredient("raw-speed-module-5", {
        "alien-artifact",
        1
      })
    end
  ...
  if data.raw.item["emerald-5"] then
    ...
    if data.raw.item["alien-artifact"] then
      bobmods.lib.recipe.add_ingredient("raw-speed-module-6", {
        "alien-artifact",
        1
      })
    end
...
if settings.startup["bobmods-modules-enablegreenmodules"].value == true then
  ...
  if data.raw.item["processing-electronics"] then
    bobmods.lib.recipe.add_ingredient("green-module-7", {
      "processing-electronics",
      5
    })
    bobmods.lib.recipe.add_ingredient("green-module-8", {
      "processing-electronics",
      8
    })
  else
...
if settings.startup["bobmods-modules-enablerawproductivitymodules"].value == true then
  if data.raw.item["solder"] then
    bobmods.lib.recipe.add_ingredient("raw-productivity-module-1-combine", {
      "solder",
      1
    })

    bobmods.lib.recipe.add_ingredient("raw-productivity-module-2", {
      "solder",
      2
    })
    bobmods.lib.recipe.add_ingredient("raw-productivity-module-2-combine", {
      "solder",
      2
    })

    bobmods.lib.recipe.add_ingredient("raw-productivity-module-3", {
      "solder",
      3
    })
    bobmods.lib.recipe.add_ingredient("raw-productivity-module-3-combine", {
      "solder",
      3
    })

    bobmods.lib.recipe.add_ingredient("raw-productivity-module-4", {
      "solder",
      5
    })
    bobmods.lib.recipe.add_ingredient("raw-productivity-module-4-combine", {
      "solder",
      4
    })

    bobmods.lib.recipe.add_ingredient("raw-productivity-module-5", {
      "solder",
      6
    })
    bobmods.lib.recipe.add_ingredient("raw-productivity-module-5-combine", {
      "solder",
      6
    })

    bobmods.lib.recipe.add_ingredient("raw-productivity-module-6", {
      "solder",
      7
    })
    bobmods.lib.recipe.add_ingredient("raw-productivity-module-6-combine", {
      "solder",
      7
    })

    bobmods.lib.recipe.add_ingredient("raw-productivity-module-7", {
      "solder",
      10
    })
    bobmods.lib.recipe.add_ingredient("raw-productivity-module-7-combine", {
      "solder",
      8
    })

    bobmods.lib.recipe.add_ingredient("raw-productivity-module-8", {
      "solder",
      12
    })
    bobmods.lib.recipe.add_ingredient("raw-productivity-module-8-combine", {
      "solder",
      10
    })
  else
  ...
  if settings.startup["bobmods-modules-productivityhasspeed"].value == true then
    bobmods.lib.recipe.add_ingredient("raw-productivity-module-1", {
      "speed-processor",
      1
    })
    bobmods.lib.recipe.add_ingredient("raw-productivity-module-1-combine", {
...
if settings.startup["bobmods-modules-enablegodmodules"].value == true then
  ...
  if data.raw.item["processing-electronics"] then
    bobmods.lib.recipe.add_ingredient("god-module-4", {
      "processing-electronics",
      8
    })
    bobmods.lib.recipe.add_ingredient("god-module-5", {
      "processing-electronics",
      10
    })
  else
