if settings.startup["bobmods-modules-enablegreenmodules"].value == true then
  ...
  if data.raw.item["bob-alien-artifact"] then
    ...
    if data.raw.item["bob-alien-artifact-red"] then
      bobmods.lib.recipe.add_ingredient(
        "bob-green-module-2",
        { type = "item", name = "bob-alien-artifact-blue", amount = 3 }
      )
      bobmods.lib.recipe.add_ingredient(
        "bob-green-module-3",
        { type = "item", name = "bob-alien-artifact-orange", amount = 3 }
      )
      bobmods.lib.recipe.add_ingredient(
        "bob-green-module-4",
        { type = "item", name = "bob-alien-artifact-purple", amount = 3 }
      )
      bobmods.lib.recipe.add_ingredient(
        "bob-green-module-4",
        { type = "item", name = "bob-alien-artifact-yellow", amount = 3 }
      )
      bobmods.lib.recipe.add_ingredient(
        "bob-green-module-5",
        { type = "item", name = "bob-alien-artifact-green", amount = 3 }
      )
      bobmods.lib.recipe.add_ingredient(
        "bob-green-module-5",
        { type = "item", name = "bob-alien-artifact-red", amount = 3 }
      )
    else
      bobmods.lib.recipe.add_ingredient(
        "bob-green-module-2",
      ...
      bobmods.lib.recipe.add_ingredient(
        "bob-green-module-3",
        { type = "item", name = "bob-alien-artifact", amount = 12 }
      )
      bobmods.lib.recipe.add_ingredient(
        "bob-green-module-4",
        { type = "item", name = "bob-alien-artifact", amount = 18 }
      )
      bobmods.lib.recipe.add_ingredient(
        "bob-green-module-5",
