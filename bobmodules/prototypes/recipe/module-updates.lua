...
if data.raw.item["bob-ruby-5"] then
  bobmods.lib.recipe.add_ingredient("speed-module-2", { type = "item", name = "bob-ruby-5", amount = 1 })
  bobmods.lib.recipe.add_ingredient("efficiency-module-2", { type = "item", name = "bob-ruby-5", amount = 1 })
  bobmods.lib.recipe.add_ingredient("productivity-module-2", { type = "item", name = "bob-ruby-5", amount = 1 })
  bobmods.lib.recipe.add_ingredient("bob-pollution-clean-module-2", { type = "item", name = "bob-ruby-5", amount = 1 })
  bobmods.lib.recipe.add_ingredient("bob-pollution-create-module-2", { type = "item", name = "bob-ruby-5", amount = 1 })
  if mods["quality"] then
    bobmods.lib.recipe.add_ingredient("quality-module-2", { type = "item", name = "bob-ruby-5", amount = 1 })
  end
...
elseif data.raw.item["alien-artifact"] then
  bobmods.lib.recipe.add_ingredient("speed-module-2", { type = "item", name = "alien-artifact", amount = 1 })
  bobmods.lib.recipe.add_ingredient("efficiency-module-2", { type = "item", name = "alien-artifact", amount = 1 })
  bobmods.lib.recipe.add_ingredient("productivity-module-2", { type = "item", name = "alien-artifact", amount = 1 })
  bobmods.lib.recipe.add_ingredient(
  ...
  if mods["quality"] then
    bobmods.lib.recipe.add_ingredient("quality-module-2", { type = "item", name = "alien-artifact", amount = 1 })
  end
end

if data.raw.item["bob-emerald-5"] then
  bobmods.lib.recipe.add_ingredient("speed-module-3", { type = "item", name = "bob-emerald-5", amount = 1 })
  bobmods.lib.recipe.add_ingredient("efficiency-module-3", { type = "item", name = "bob-emerald-5", amount = 1 })
  bobmods.lib.recipe.add_ingredient("productivity-module-3", { type = "item", name = "bob-emerald-5", amount = 1 })
  bobmods.lib.recipe.add_ingredient("bob-pollution-clean-module-3", { type = "item", name = "bob-emerald-5", amount = 1 })
  bobmods.lib.recipe.add_ingredient("bob-pollution-create-module-3", { type = "item", name = "bob-emerald-5", amount = 1 })
  if mods["quality"] then
    bobmods.lib.recipe.add_ingredient("quality-module-3", { type = "item", name = "bob-emerald-5", amount = 1 })
  end
elseif data.raw.item["alien-artifact"] then
  bobmods.lib.recipe.add_ingredient("speed-module-3", { type = "item", name = "alien-artifact", amount = 1 })
  bobmods.lib.recipe.add_ingredient("efficiency-module-3", { type = "item", name = "alien-artifact", amount = 1 })
  bobmods.lib.recipe.add_ingredient("productivity-module-3", { type = "item", name = "alien-artifact", amount = 1 })
  bobmods.lib.recipe.add_ingredient(
  ...
  if mods["quality"] then
    bobmods.lib.recipe.add_ingredient("quality-module-3", { type = "item", name = "alien-artifact", amount = 1 })
  end
end

if data.raw.item["bob-topaz-5"] then
  bobmods.lib.recipe.add_ingredient("bob-speed-module-4", { type = "item", name = "bob-topaz-5", amount = 1 })
  bobmods.lib.recipe.add_ingredient("bob-efficiency-module-4", { type = "item", name = "bob-topaz-5", amount = 1 })
  bobmods.lib.recipe.add_ingredient("bob-productivity-module-4", { type = "item", name = "bob-topaz-5", amount = 1 })
  bobmods.lib.recipe.add_ingredient("bob-pollution-clean-module-4", { type = "item", name = "bob-topaz-5", amount = 1 })
  bobmods.lib.recipe.add_ingredient("bob-pollution-create-module-4", { type = "item", name = "bob-topaz-5", amount = 1 })
  if mods["quality"] then
    bobmods.lib.recipe.add_ingredient("bob-quality-module-4", { type = "item", name = "bob-topaz-5", amount = 1 })
  end
elseif data.raw.item["alien-artifact"] then
  bobmods.lib.recipe.add_ingredient("bob-speed-module-4", { type = "item", name = "alien-artifact", amount = 1 })
  bobmods.lib.recipe.add_ingredient("bob-efficiency-module-4", { type = "item", name = "alien-artifact", amount = 1 })
  bobmods.lib.recipe.add_ingredient("bob-productivity-module-4", { type = "item", name = "alien-artifact", amount = 1 })
  bobmods.lib.recipe.add_ingredient(
  ...
  if mods["quality"] then
    bobmods.lib.recipe.add_ingredient("bob-quality-module-4", { type = "item", name = "alien-artifact", amount = 1 })
  end
end

if data.raw.item["bob-diamond-5"] then
  bobmods.lib.recipe.add_ingredient("bob-speed-module-5", { type = "item", name = "bob-diamond-5", amount = 1 })
  bobmods.lib.recipe.add_ingredient("bob-efficiency-module-5", { type = "item", name = "bob-diamond-5", amount = 1 })
  bobmods.lib.recipe.add_ingredient("bob-productivity-module-5", { type = "item", name = "bob-diamond-5", amount = 1 })
  bobmods.lib.recipe.add_ingredient("bob-pollution-clean-module-5", { type = "item", name = "bob-diamond-5", amount = 1 })
  bobmods.lib.recipe.add_ingredient("bob-pollution-create-module-5", { type = "item", name = "bob-diamond-5", amount = 1 })
  if mods["quality"] then
    bobmods.lib.recipe.add_ingredient("bob-quality-module-5", { type = "item", name = "bob-diamond-5", amount = 1 })
  end
elseif data.raw.item["alien-artifact"] then
  bobmods.lib.recipe.add_ingredient("bob-speed-module-5", { type = "item", name = "alien-artifact", amount = 1 })
  bobmods.lib.recipe.add_ingredient("bob-efficiency-module-5", { type = "item", name = "alien-artifact", amount = 1 })
  bobmods.lib.recipe.add_ingredient("bob-productivity-module-5", { type = "item", name = "alien-artifact", amount = 1 })
  bobmods.lib.recipe.add_ingredient(
    "bob-pollution-clean-module-5",
    { type = "item", name = "alien-artifact", amount = 1 }
  )
  ...
  if mods["quality"] then
    bobmods.lib.recipe.add_ingredient("bob-quality-module-5", { type = "item", name = "alien-artifact", amount = 1 })
  end
end
