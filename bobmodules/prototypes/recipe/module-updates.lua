if data.raw.item["solder"] then
  ...
  bobmods.lib.recipe.add_ingredient("effectivity-module-3", {
    "module-contact",
    5
  })
  bobmods.lib.recipe.add_ingredient("productivity-module-3", {
    "module-contact",
    5
  })
  bobmods.lib.recipe.add_ingredient("pollution-clean-module-3", {
    "module-contact",
    5
  })
  bobmods.lib.recipe.add_ingredient("pollution-create-module-3", {
    "module-contact",
    5
  })
end
...
if data.raw.item["processing-electronics"] then
  bobmods.lib.recipe.add_ingredient("speed-module-7", {
    "processing-electronics",
    3
  })
  bobmods.lib.recipe.add_ingredient("effectivity-module-7", {
    "processing-electronics",
    3
  })
  bobmods.lib.recipe.add_ingredient("productivity-module-7", {
    "processing-electronics",
    3
  })
  bobmods.lib.recipe.add_ingredient("pollution-clean-module-7", {
    "processing-electronics",
    3
  })
  bobmods.lib.recipe.add_ingredient("pollution-create-module-7", {
    "processing-electronics",
    3
  })

  bobmods.lib.recipe.add_ingredient("speed-module-8", {
    "processing-electronics",
    5
  })
  bobmods.lib.recipe.add_ingredient("effectivity-module-8", {
    "processing-electronics",
    5
  })
  bobmods.lib.recipe.add_ingredient("productivity-module-8", {
    "processing-electronics",
    5
  })
  bobmods.lib.recipe.add_ingredient("pollution-clean-module-8", {
    "processing-electronics",
    5
  })
  bobmods.lib.recipe.add_ingredient("pollution-create-module-8", {
    "processing-electronics",
    5
  })
else
...
if data.raw.item["ruby-5"] then
  ...
  if data.raw.item["alien-artifact"] then
    ...
    bobmods.lib.recipe.add_ingredient("effectivity-module-5", {
      "alien-artifact",
      1
    })
    bobmods.lib.recipe.add_ingredient("productivity-module-5", {
      "alien-artifact",
      1
    })
    bobmods.lib.recipe.add_ingredient("pollution-clean-module-5", {
      "alien-artifact",
      1
    })
    bobmods.lib.recipe.add_ingredient("pollution-create-module-5", {
      "alien-artifact",
      1
    })
  end
...
if data.raw.item["emerald-5"] then
  ...
  bobmods.lib.recipe.add_ingredient("pollution-clean-module-6", {
    "emerald-5",
    1
  })
  bobmods.lib.recipe.add_ingredient("pollution-create-module-6", {
    "emerald-5",
    1
  })
else
  if data.raw.item["alien-artifact"] then
    ...
    bobmods.lib.recipe.add_ingredient("effectivity-module-6", {
      "alien-artifact",
      1
    })
    bobmods.lib.recipe.add_ingredient("productivity-module-6", {
      "alien-artifact",
      1
    })
    bobmods.lib.recipe.add_ingredient("pollution-clean-module-6", {
