data:extend({{
  ...
  normal = {
    energy_required = 10,
    enabled = false,
    ingredients = {{"plastic-bar", 2}, {"iron-plate", 5}},
    result = "module-case"
  },
  expensive = {
    energy_required = 15,
    enabled = false,
    ingredients = {{"plastic-bar", 5}, {"iron-plate", 10}},
    result = "module-case"
  }
}, {
  type = "recipe",
  ...
  energy_required = 10,
  enabled = false,
  ingredients = {{"copper-plate", 1}, {"plastic-bar", 1}},
...
data:extend({{
  ...
  normal = {
    energy_required = 30,
    enabled = false,
    ingredients = {{"copper-plate", 2}, {"plastic-bar", 1}},
...
data:extend({{
  ...
  normal = {
    energy_required = 7.5,
    enabled = false,
    ingredients = {{"module-processor-board-3", 1}, {"processing-unit", 2}},
    result = "speed-processor-3"
  },
  expensive = {
    energy_required = 15,
    enabled = false,
    ingredients = {{"module-processor-board-3", 1}, {"processing-unit", 3}},
    result = "speed-processor-3"
  }
}})
