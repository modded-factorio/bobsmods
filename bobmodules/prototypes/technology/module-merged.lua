if settings.startup["bobmods-modules-enablegreenmodules"].value == true or settings.startup["bobmods-modules-enablerawspeedmodules"].value == true or settings.startup["bobmods-modules-enablerawproductivitymodules"].value == true or settings.startup["bobmods-modules-enablegodmodules"].value == true then
  data:extend({{
    type = "technology",
    name = "module-merging",
...
if settings.startup["bobmods-modules-enablerawspeedmodules"].value == true then
  data:extend({{
    ...
    unit = {
      count = 25,
      ingredients = {{"speed-processor", 1}, {"effectivity-processor", 1}},
      time = 30
    },
    order = "i-m-a"
  }, {
...
if settings.startup["bobmods-modules-enablerawproductivitymodules"].value == true then
  ...
  if settings.startup["bobmods-modules-productivityhasspeed"].value == true then
    table.insert(
      data.raw.technology["raw-productivity-module-1"].prerequisites,
      "speed-module"
    )
    table.insert(
      data.raw.technology["raw-productivity-module-2"].prerequisites,
      "speed-module-2"
    )
    table.insert(
      data.raw.technology["raw-productivity-module-3"].prerequisites,
      "speed-module-3"
    )
    table.insert(
      data.raw.technology["raw-productivity-module-4"].prerequisites,
      "speed-module-4"
    )
    table.insert(
      data.raw.technology["raw-productivity-module-5"].prerequisites,
      "speed-module-5"
    )
    table.insert(
      data.raw.technology["raw-productivity-module-6"].prerequisites,
      "speed-module-6"
    )
    table.insert(
      data.raw.technology["raw-productivity-module-7"].prerequisites,
      "speed-module-7"
    )
    table.insert(
      data.raw.technology["raw-productivity-module-8"].prerequisites,
      "speed-module-8"
    )
  end
end
