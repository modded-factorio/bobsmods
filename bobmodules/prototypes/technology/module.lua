data.raw["technology"]["speed-module"].icon =
...
data.raw["technology"]["speed-module-2"].icon =
...
data.raw["technology"]["speed-module-3"].icon =
...
data.raw["technology"]["speed-module"].unit = {
  count = 25,
  ingredients = {{"speed-processor", 1}},
  time = 30
}
...
data.raw["technology"]["speed-module-3"].unit = {
  count = 50,
  ingredients = {{"speed-processor", 2}, {"module-circuit-board", 1}},
  time = 60
}
...
data:extend({{
  ...
  unit = {
    count = 50,
    ingredients = {{"speed-processor", 4}, {"module-circuit-board", 2}},
    time = 60
  },
  order = "i-c-d"
}, {
...
data.raw["technology"]["effectivity-module"].unit = {
  count = 25,
  ingredients = {{"effectivity-processor", 1}},
  time = 30
}
...
data.raw["technology"]["effectivity-module-3"].unit = {
  count = 50,
  ingredients = {{"effectivity-processor", 2}, {"module-circuit-board", 1}},
  time = 60
}
...
data:extend({{
  ...
  unit = {
    count = 50,
    ingredients = {{"effectivity-processor", 4}, {"module-circuit-board", 2}},
    time = 60
  },
  order = "i-g-d"
}, {
...
data.raw["technology"]["productivity-module-2"].icon =
  "__bobmodules__/graphics/icons/red-module-2.png"
data.raw["technology"]["productivity-module-3"].icon =
  "__bobmodules__/graphics/icons/red-module-3.png"
...
data.raw["technology"]["productivity-module"].unit = {
  count = 25,
  ingredients = {{"productivity-processor", 1}},
  time = 30
}
...
data.raw["technology"]["productivity-module-3"].unit = {
  count = 50,
  ingredients = {{"productivity-processor", 2}, {"module-circuit-board", 1}},
  time = 60
}
...
data:extend({{
  ...
  unit = {
    count = 50,
    ingredients = {{"productivity-processor", 4}, {"module-circuit-board", 2}},
    time = 60
  },
  order = "i-e-d"
}, {
...
data:extend({{
  ...
  unit = {
    count = 25,
    ingredients = {{"pollution-clean-processor", 1}},
    time = 30
  },
  order = "i-i-a"
}, {
...
data:extend({{
  ...
  unit = {
    count = 25,
    ingredients = {{"pollution-create-processor", 1}},
    time = 30
  },
  order = "i-k-a"
}, {
...
table.insert(data.raw.technology["speed-module-3"].effects, {
  type = "unlock-recipe",
  recipe = "speed-processor-2"
})
table.insert(data.raw.technology["effectivity-module-3"].effects, {
  type = "unlock-recipe",
  recipe = "effectivity-processor-2"
})
table.insert(data.raw.technology["productivity-module-3"].effects, {
  type = "unlock-recipe",
  recipe = "productivity-processor-2"
})
table.insert(data.raw.technology["pollution-clean-module-3"].effects, {
  type = "unlock-recipe",
  recipe = "pollution-clean-processor-2"
})
table.insert(data.raw.technology["pollution-create-module-3"].effects, {
  type = "unlock-recipe",
  recipe = "pollution-create-processor-2"
})

table.insert(data.raw.technology["speed-module-6"].effects, {
  type = "unlock-recipe",
  recipe = "speed-processor-3"
})
table.insert(data.raw.technology["effectivity-module-6"].effects, {
  type = "unlock-recipe",
  recipe = "effectivity-processor-3"
})
table.insert(data.raw.technology["productivity-module-6"].effects, {
  type = "unlock-recipe",
  recipe = "productivity-processor-3"
})
table.insert(data.raw.technology["pollution-clean-module-6"].effects, {
  type = "unlock-recipe",
  recipe = "pollution-clean-processor-3"
})
table.insert(data.raw.technology["pollution-create-module-6"].effects, {
  type = "unlock-recipe",
...
table.insert(
  data.raw.technology["pollution-clean-module-3"].prerequisites,
  "advanced-electronics-2"
)
table.insert(
  data.raw.technology["pollution-create-module-3"].prerequisites,
  "advanced-electronics-2"
)

if data.raw.technology["advanced-electronics-3"] then
  table.insert(
    data.raw.technology["speed-module-6"].prerequisites,
    "advanced-electronics-3"
  )
  table.insert(
    data.raw.technology["effectivity-module-6"].prerequisites,
    "advanced-electronics-3"
  )
  table.insert(
    data.raw.technology["productivity-module-6"].prerequisites,
    "advanced-electronics-3"
  )
  table.insert(
    data.raw.technology["pollution-clean-module-6"].prerequisites,
    "advanced-electronics-3"
  )
  table.insert(
    data.raw.technology["pollution-create-module-6"].prerequisites,
    "advanced-electronics-3"
  )
end