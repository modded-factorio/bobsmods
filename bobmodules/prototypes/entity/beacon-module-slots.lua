...
local function create_tiered_module_slot_1(num_lights, shift)
    ...
    local slot = {
        ...
        -- Slot Mask
        {
            ...
            render_layer = "lower-object",
            pictures = {
                filename = "__bobmodules__/graphics/entity/beacon/slots/" .. num_lights .. "-lights/1/beacon-module-mask-box-1.png",
        ...
        -- Slot Lights Count
        {
            ...
            pictures = {
                filename = "__bobmodules__/graphics/entity/beacon/slots/" .. num_lights .. "-lights/1/beacon-module-mask-lights-1.png",
                line_length = num_lights,
                width = 26,
                height = 22,
                variation_count = num_lights,
        ...
        -- Slot Lights Radiance
        {
            apply_module_tint = "secondary",
            pictures = {
                filename = "__bobmodules__/graphics/entity/beacon/slots/" .. num_lights .. "-lights/1/beacon-module-lights-1.png",
                line_length = num_lights,
                width = 56,
                height = 42,
                variation_count = num_lights,
...
local function create_tiered_module_slot_2(num_lights, shift)
    ...
    local slot = {
        ...
        },
        {
            ...
            render_layer = "lower-object",
            pictures = {
                filename = "__bobmodules__/graphics/entity/beacon/slots/" .. num_lights .. "-lights/2/beacon-module-mask-box-2.png",
                line_length = num_lights,
                width = 36,
                height = 28,
                variation_count = num_lights,
        ...
        },
        {
            ...
            render_layer = "lower-object-above-shadow",
            pictures = {
                filename = "__bobmodules__/graphics/entity/beacon/slots/" .. num_lights .. "-lights/2/beacon-module-mask-lights-2.png",
                line_length = num_lights,
                width = 24,
                height = 16,
                variation_count = num_lights,
        ...
        },
        {
            apply_module_tint = "secondary",
            pictures = {
                filename = "__bobmodules__/graphics/entity/beacon/slots/" .. num_lights .. "-lights/2/beacon-module-lights-2.png",
                line_length = num_lights,
                width = 66,
                height = 46,
                variation_count = num_lights,
...
local function create_god_module_slot_1(type_name, shift)
    ...
    local slot = {
        ...
        -- Slot Lights Count
        {
            ...
            render_layer = "lower-object-above-shadow",
            pictures = {
                filename = "__bobmodules__/graphics/entity/beacon/slots/god-modules/1/" .. type_name .. "-module-mask-lights-1.png",
                line_length = 1,
                width = 26,
                height = 22,
                variation_count = 1,
...
local function create_god_module_slot_2(type_name, shift)
    ...
    local slot = {
        ...
        },
        {
            ...
            render_layer = "lower-object-above-shadow",
            pictures = {
                filename = "__bobmodules__/graphics/entity/beacon/slots/god-modules/2/".. type_name .. "-module-mask-lights-2.png",
                line_length = 1,
                width = 24,
                height = 16,
                variation_count = 1,
