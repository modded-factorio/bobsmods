...
data:extend({{
  ...
  stack_size = 10
}, util.merge{data.raw.beacon.beacon, {
  name = "beacon-2",
  ...
  prerequisites = {"effect-transmission-2", "utility-science-pack"},
  unit = {
    count = 100,
    ingredients = {
      {"automation-science-pack", 1},
...
data.raw.beacon["beacon-2"].module_specification.module_info_max_icons_per_row =
  nil
data.raw.beacon["beacon-3"].module_specification.module_info_max_icons_per_row =
  nil