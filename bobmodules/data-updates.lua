...
if data.raw["recipe-category"]["electronics-with-fluid"] then
  ...
  data.raw.recipe["module-processor-board-2"].category =
    "electronics-with-fluid"
  data.raw.recipe["module-processor-board-3"].category =
    "electronics-with-fluid"
end
...
if data.raw["recipe-category"]["electronics-machine"] then
  ...
  data.raw.recipe["pollution-clean-processor-2"].category =
    "electronics-machine"
  data.raw.recipe["pollution-create-processor-2"].category =
    "electronics-machine"
  ...
  data.raw.recipe["pollution-clean-processor-3"].category =
    "electronics-machine"
  data.raw.recipe["pollution-create-processor-3"].category =
    "electronics-machine"
end
