...
data.raw["night-vision-equipment"]["night-vision-equipment"].color_lookup = {{0.5, "__core__/graphics/color_luts/nightvision.png"}}
...
if data.raw.item["alien-artifact"] then
  ...
  bobmods.lib.recipe.add_ingredient("energy-shield-mk3-equipment", {type = "item", name = "alien-artifact", amount = 20})
  if data.raw.item["alien-artifact-red"] then
    bobmods.lib.recipe.add_ingredient("fusion-reactor-equipment-2", {type = "item", name = "alien-artifact-orange", amount = 25})
    bobmods.lib.recipe.add_ingredient("fusion-reactor-equipment-2", {type = "item", name = "alien-artifact-blue", amount = 25})
    bobmods.lib.recipe.add_ingredient("fusion-reactor-equipment-3", {type = "item", name = "alien-artifact-yellow", amount = 25})
    bobmods.lib.recipe.add_ingredient("fusion-reactor-equipment-3", {type = "item", name = "alien-artifact-purple", amount = 25})
    bobmods.lib.recipe.add_ingredient("fusion-reactor-equipment-4", {type = "item", name = "alien-artifact-red", amount = 25})
    bobmods.lib.recipe.add_ingredient("fusion-reactor-equipment-4", {type = "item", name = "alien-artifact-green", amount = 25})
    bobmods.lib.recipe.add_ingredient("battery-mk4-equipment", {type = "item", name = "alien-artifact-orange", amount = 10})
    bobmods.lib.recipe.add_ingredient("battery-mk4-equipment", {type = "item", name = "alien-artifact-blue", amount = 10})
    bobmods.lib.recipe.add_ingredient("battery-mk5-equipment", {type = "item", name = "alien-artifact-yellow", amount = 10})
    bobmods.lib.recipe.add_ingredient("battery-mk5-equipment", {type = "item", name = "alien-artifact-purple", amount = 10})
    bobmods.lib.recipe.add_ingredient("battery-mk6-equipment", {type = "item", name = "alien-artifact-red", amount = 10})
    bobmods.lib.recipe.add_ingredient("battery-mk6-equipment", {type = "item", name = "alien-artifact-green", amount = 10})
    bobmods.lib.recipe.add_ingredient("energy-shield-mk4-equipment", {type = "item", name = "alien-artifact-orange", amount = 10})
    bobmods.lib.recipe.add_ingredient("energy-shield-mk4-equipment", {type = "item", name = "alien-artifact-blue", amount = 10})
    bobmods.lib.recipe.add_ingredient("energy-shield-mk5-equipment", {type = "item", name = "alien-artifact-yellow", amount = 10})
    bobmods.lib.recipe.add_ingredient("energy-shield-mk5-equipment", {type = "item", name = "alien-artifact-purple", amount = 10})
    bobmods.lib.recipe.add_ingredient("energy-shield-mk6-equipment", {type = "item", name = "alien-artifact-red", amount = 10})
    bobmods.lib.recipe.add_ingredient("energy-shield-mk6-equipment", {type = "item", name = "alien-artifact-green", amount = 10})
  else
    bobmods.lib.recipe.add_ingredient("fusion-reactor-equipment-2", {type = "item", name = "alien-artifact", amount = 50})
    bobmods.lib.recipe.add_ingredient("fusion-reactor-equipment-3", {type = "item", name = "alien-artifact", amount = 50})
    bobmods.lib.recipe.add_ingredient("fusion-reactor-equipment-4", {type = "item", name = "alien-artifact", amount = 50})
    ...
    bobmods.lib.recipe.add_ingredient("energy-shield-mk4-equipment", {type = "item", name = "alien-artifact", amount = 20})
    bobmods.lib.recipe.add_ingredient("energy-shield-mk5-equipment", {type = "item", name = "alien-artifact", amount = 20})
    bobmods.lib.recipe.add_ingredient("energy-shield-mk6-equipment", {type = "item", name = "alien-artifact", amount = 20})
  end
end