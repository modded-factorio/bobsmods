data.raw["technology"]["energy-shield-mk2-equipment"].icons
...
data:extend({{
  ...
  order = "g-e-d",
  prerequisites = {"bob-energy-shield-equipment-3"},
  unit = {
    count = 300,
    time = 45,
    ingredients = {
  ...
  order = "g-e-e",
  prerequisites = {"bob-energy-shield-equipment-4", "utility-science-pack"},
  unit = {
    count = 350,
    time = 45,
    ingredients = {
  ...
  order = "g-e-f",
  prerequisites = {"bob-energy-shield-equipment-5"},
  unit = {
    count = 400,
    time = 45,
    ingredients = {
...
data:extend({{
  ...
  order = "g-i-d",
  prerequisites = {"bob-battery-equipment-3", "production-science-pack"},
  unit = {
    count = 200,
    time = 45,
    ingredients = {
  ...
  order = "g-i-e",
  prerequisites = {"bob-battery-equipment-4"},
  unit = {
    count = 250,
    time = 45,
    ingredients = {
  ...
  order = "g-i-f",
  prerequisites = {"bob-battery-equipment-5", "utility-science-pack"},
  unit = {
    count = 300,
    time = 45,
    ingredients = {
...
data:extend({{
  ...
  order = "g-k-c",
  prerequisites = {"solar-panel-equipment-2", "advanced-electronics-2"},
  effects = {{
    type = "unlock-recipe",
...
data:extend({{
  ...
  order = "g-m-e",
  prerequisites = {"personal-laser-defense-equipment-4", "military-4"},
  effects = {{
    type = "unlock-recipe",
...
data:extend({{
  ...
  order = "g-h-b",
  prerequisites = {"exoskeleton-equipment", "advanced-electronics-2"},
  effects = {{
    type = "unlock-recipe",
