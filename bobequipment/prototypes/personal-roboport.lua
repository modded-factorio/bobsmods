...
data.raw["roboport-equipment"]["personal-roboport-equipment"].sprite.height =
  128
data.raw.technology["personal-roboport-equipment"].icons
...
=
  "__bobequipment__/graphics/icons/technology/personal-roboport-mk2-equipment.png"
data.raw["roboport-equipment"]["personal-roboport-mk2-equipment"].sprite.width =
  128
data.raw["roboport-equipment"]["personal-roboport-mk2-equipment"].sprite.height
= 128
data.raw.technology["personal-roboport-mk2-equipment"].icons
= bobmods.equipment.technology_icon_constant_equipment{
  icon = "__bobequipment__/graphics/icons/technology/personal-roboport-mk2-equipment.png",
  icon_size = 128
}

data.raw["roboport-equipment"]["personal-roboport-mk2-equipment"].energy_source.buffer_capacity
= "75MJ"
data.raw["roboport-equipment"]["personal-roboport-mk2-equipment"].energy_source.input_flow_limit
= "7500KW"
data.raw["roboport-equipment"]["personal-roboport-mk2-equipment"].charging_energy
= "1500kW"
data.raw["roboport-equipment"]["personal-roboport-mk2-equipment"].robot_limit =
  15
...
data:extend({{
  ...
  enabled = false,
  energy_required = 4,
  ingredients = {{"advanced-circuit", 2}, {"steel-plate", 5}, {"battery", 20}},
