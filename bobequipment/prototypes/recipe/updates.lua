if data.raw.item["roboport-antenna-1"] and data.raw.item["roboport-chargepad-1"] and data.raw.item["roboport-door-1"] then
  ...
  bobmods.lib.recipe.add_ingredient("personal-roboport-equipment", {
    "battery",
    20
  })
end
...
if data.raw.item["roboport-antenna-2"] and data.raw.item["roboport-chargepad-2"] and data.raw.item["roboport-door-2"] then
  ...
  data.raw.recipe["personal-roboport-chargepad-equipment-2"].ingredients =
    {{"personal-roboport-chargepad-equipment", 1}, {"roboport-chargepad-2", 2}}
  ...
  if data.raw.item["steel-bearing"] then
    bobmods.lib.recipe.add_ingredient("personal-roboport-mk2-equipment", {
      "steel-bearing",
      5
    })
    bobmods.lib.recipe.add_ingredient("personal-roboport-antenna-equipment-2", {
      "steel-bearing",
      5
    })
  end
...
if data.raw.item["roboport-antenna-3"] and data.raw.item["roboport-chargepad-3"] and data.raw.item["roboport-door-3"] then
  ...
  if data.raw.item["titanium-bearing"] then
    bobmods.lib.recipe.add_ingredient("personal-roboport-mk3-equipment", {
      "titanium-bearing",
      5
    })
    bobmods.lib.recipe.add_ingredient("personal-roboport-antenna-equipment-3", {
      "titanium-bearing",
      5
    })
  end
...
if data.raw.item["roboport-antenna-4"] and data.raw.item["roboport-chargepad-4"] and data.raw.item["roboport-door-4"] then
  ...
  if data.raw.item["nitinol-bearing"] then
    bobmods.lib.recipe.add_ingredient("personal-roboport-mk4-equipment", {
      "nitinol-bearing",
      5
    })
    bobmods.lib.recipe.add_ingredient("personal-roboport-antenna-equipment-4", {
      "nitinol-bearing",
      5
    })
  end
...
if data.raw.item["solder"] then
  bobmods.lib.recipe.add_ingredient("personal-roboport-robot-equipment", {
    "solder",
    2
  })
  bobmods.lib.recipe.add_ingredient("personal-roboport-robot-equipment-2", {
    "solder",
    3
  })
  bobmods.lib.recipe.add_ingredient("personal-roboport-robot-equipment-3", {
    "solder",
    4
  })
  bobmods.lib.recipe.add_ingredient("personal-roboport-robot-equipment-4", {
    "solder",
    6
  })
end
...
if data.raw.item["cobalt-steel-bearing"] then
  bobmods.lib.recipe.add_ingredient("exoskeleton-equipment-2", {
...
if data.raw.item["silicon-wafer"] then
  bobmods.lib.recipe.add_ingredient("solar-panel-equipment-3", {
    "silicon-wafer",
    8
  })
end
...
if data.raw.item["titanium-bearing"] then
  bobmods.lib.recipe.add_ingredient("exoskeleton-equipment-3", {
    "titanium-bearing",
    30
  })
end
...
if data.raw.item["sapphire-5"] then
  bobmods.lib.recipe.add_ingredient("personal-laser-defense-equipment-2", {
    "sapphire-5",
    1
  })
...
if data.raw.item["emerald-5"] then
  bobmods.lib.recipe.add_ingredient("personal-laser-defense-equipment-3", {
    "emerald-5",
    1
  })
  bobmods.lib.recipe.remove_ingredient(
...
if data.raw.item["amethyst-5"] then
  bobmods.lib.recipe.add_ingredient("personal-laser-defense-equipment-4", {
    "amethyst-5",
    1
  })
end
...
if data.raw.item["topaz-5"] then
  bobmods.lib.recipe.add_ingredient("personal-laser-defense-equipment-5", {
    "topaz-5",
    1
  })
end
...
if data.raw.item["diamond-5"] then
  ...
  bobmods.lib.recipe.add_ingredient("personal-laser-defense-equipment-6", {
    "diamond-5",
    1
  })
end
...
if data.raw.item["alien-artifact"] then
  bobmods.lib.recipe.add_new_ingredient("energy-shield-mk3-equipment", {
    "alien-artifact",
    10
  })
  bobmods.lib.recipe.add_new_ingredient("night-vision-equipment-3", {
    "alien-artifact",
    10
  })
  bobmods.lib.recipe.add_new_ingredient("solar-panel-equipment-4", {
    "alien-artifact",
    10
  })
else
...
if data.raw.item["alien-artifact-orange"] and data.raw.item["alien-artifact-blue"] then
  bobmods.lib.recipe.add_new_ingredient("energy-shield-mk4-equipment", {
    "alien-artifact-orange",
    5
  })
  bobmods.lib.recipe.add_new_ingredient("battery-mk4-equipment", {
    "alien-artifact-orange",
    5
  })
  bobmods.lib.recipe.add_new_ingredient("fusion-reactor-equipment-2", {
    "alien-artifact-orange",
    15
  })
...
elseif data.raw.item["alien-artifact"] then
  ...
  bobmods.lib.recipe.add_ingredient("fusion-reactor-equipment-2", {
    "processing-unit",
    40
  })
end
...
if data.raw.item["alien-artifact-yellow"] and data.raw.item["alien-artifact-purple"] then
  bobmods.lib.recipe.add_new_ingredient("energy-shield-mk5-equipment", {
    "alien-artifact-yellow",
    5
  })
  bobmods.lib.recipe.add_new_ingredient("battery-mk5-equipment", {
    "alien-artifact-yellow",
    5
  })
  bobmods.lib.recipe.add_new_ingredient("fusion-reactor-equipment-3", {
    "alien-artifact-yellow",
    15
  })
...
elseif data.raw.item["alien-artifact"] then
  ...
  bobmods.lib.recipe.add_ingredient("fusion-reactor-equipment-3", {
    "processing-unit",
    60
  })
end
...
if data.raw.item["alien-artifact-red"] and data.raw.item["alien-artifact-green"] then
  bobmods.lib.recipe.add_new_ingredient("energy-shield-mk6-equipment", {
    "alien-artifact-red",
    5
  })
  bobmods.lib.recipe.add_new_ingredient("battery-mk6-equipment", {
    "alien-artifact-red",
    5
  })
  bobmods.lib.recipe.add_new_ingredient("fusion-reactor-equipment-4", {
    "alien-artifact-red",
    15
  })
  bobmods.lib.recipe.add_new_ingredient("personal-laser-defense-equipment-6", {
    "alien-artifact-red",
    5
  })
...
elseif data.raw.item["alien-artifact"] then
  ...
  bobmods.lib.recipe.add_ingredient("fusion-reactor-equipment-4", {
    "processing-unit",
    80
  })
  bobmods.lib.recipe.add_ingredient("personal-laser-defense-equipment-6", {
