...
data.raw.recipe["battery-mk2-equipment"].ingredients =
  {{"battery-equipment", 2}, {"processing-unit", 5}}
...
data:extend({{
  ...
  enabled = false,
  energy_required = 10,
  ingredients = {{"battery-mk2-equipment", 2}, {"battery", 5}},
  ...
  enabled = false,
  energy_required = 10,
  ingredients = {{"battery-mk3-equipment", 2}, {"processing-unit", 5}},
  ...
  enabled = false,
  energy_required = 10,
  ingredients = {{"battery-mk4-equipment", 2}, {"battery", 5}},
  ...
  enabled = false,
  energy_required = 10,
  ingredients = {{"battery-mk5-equipment", 2}, {"processing-unit", 5}},
