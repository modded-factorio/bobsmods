...
local function split_line(technology, tag)
  if data.raw.technology[technology][tag] then
    if not data.raw.technology[technology].normal[tag] then
      data.raw.technology[technology].normal[tag] = table.deepcopy(data.raw.technology[technology][tag])
    end
    if not data.raw.technology[technology].expensive[tag] then
      data.raw.technology[technology].expensive[tag] = table.deepcopy(data.raw.technology[technology][tag])
    end
  end
end
...
function bobmods.lib.tech.add_new_science_pack(technology, pack, amount)
  ...
  then
    ...
    if data.raw.technology[technology].expensive and data.raw.technology[technology].expensive.unit then
      add_new_science_pack(data.raw.technology[technology].expensive, pack, amount)
    end
  else
    log(debug.traceback())
    bobmods.lib.error.technology(technology)
...
function bobmods.lib.tech.replace_difficulty_science_pack(technology, difficulty, old, new)
  ...
  then
    ...
    if data.raw.technology[technology][difficulty].unit then
      replace_science_pack(data.raw.technology[technology][difficulty], old, new)
    end
  else
    log(debug.traceback())
    bobmods.lib.error.technology(technology)
...
function bobmods.lib.tech.add_new_difficulty_science_pack(technology, difficulty, pack, amount)
  ...
  then
    ...
    if data.raw.technology[technology][difficulty].unit then
      add_new_science_pack(data.raw.technology[technology][difficulty], pack, amount)
    end
  else
    log(debug.traceback())
    bobmods.lib.error.technology(technology)
...
function bobmods.lib.tech.add_difficulty_science_pack(technology, difficulty, pack, amount)
  ...
  then
    ...
    if data.raw.technology[technology][difficulty].unit then
      add_science_pack(data.raw.technology[technology][difficulty], pack, amount)
    end
  else
    log(debug.traceback())
    bobmods.lib.error.technology(technology)
...
function bobmods.lib.tech.has_recipe_unlock(technology, recipe)
  ...
  then
    ...
    if data.raw.technology[technology].normal then
      hasit = hasit or has_recipe_unlock(data.raw.technology[technology].normal, recipe)
    end
    if data.raw.technology[technology].expensive then
      hasit = hasit or has_recipe_unlock(data.raw.technology[technology].expensive, recipe)
    end
    return hasit
  else
    log(debug.traceback())
...
function bobmods.lib.tech.remove_prerequisite(technology, prerequisite)
  ...
  then
    ...
    if data.raw.technology[technology].expensive then
      remove_prerequisite(data.raw.technology[technology].expensive, prerequisite)
    end
  else
    log(debug.traceback())
    bobmods.lib.error.technology(technology)
...
function bobmods.lib.tech.replace_difficulty_prerequisite(technology, difficulty, old, new)
  ...
  then
    ...
    if data.raw.technology[technology][difficulty] then
      replace_prerequisite(data.raw.technology[technology][difficulty], old, new)
    end
  else
    log(debug.traceback())
    bobmods.lib.error.technology(technology)
...
function bobmods.lib.tech.add_difficulty_prerequisite(technology, difficulty, prerequisite)
  ...
  then
    ...
    if data.raw.technology[technology][difficulty] then
      add_prerequisite(data.raw.technology[technology][difficulty], prerequisite)
    end
  else
    log(debug.traceback())
    bobmods.lib.error.technology(technology)
...
function bobmods.lib.tech.remove_difficulty_prerequisite(technology, difficulty, prerequisite)
  ...
  then
    ...
    if data.raw.technology[technology][difficulty] then
      remove_prerequisite(data.raw.technology[technology][difficulty], prerequisite)
    end
  else
    log(debug.traceback())
    bobmods.lib.error.technology(technology)
