...
function bobmods.lib.resource.get_random_icon_layer(type, tint, layer)
  ...
  return {
    icon = string.format(
      "__boblibrary__/graphics/icons/ore/%d/%d.png",
      type,
      piece
    ),
    icon_size = icon_size,
...
function bobmods.lib.resource.get_random_icon(type, tint)
  return {{
    icon = "__boblibrary__/graphics/icons/ore/blank.png",
    icon_size = 64,
    scale = 0.5
  }, bobmods.lib.resource.get_random_icon_layer(
    type,
    tint,
    1
  ), bobmods.lib.resource.get_random_icon_layer(type, tint, 2), bobmods.lib.resource.get_random_icon_layer(type, tint, 3), bobmods.lib.resource.get_random_icon_layer(type, tint, 4)}
end
...
function bobmods.lib.resource.get_icon_variation_layer(type, tint, layer)
  ...
  local shift =
    util.by_pixel(
      4 * layer_shift_directions[layer][1],
      4 * layer_shift_directions[layer][2]
