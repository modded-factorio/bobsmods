data:extend{{
  ...
  energy_required = 3.5,
  enabled = false,
  ingredients = {{"steel-plate", 5}, {"player-brain", 1}},
  result = "player-head"
}, {
  type = "recipe",
  name = "player-boots",
  energy_required = 3.5,
  enabled = false,
  ingredients = {{"steel-plate", 5}, {"plastic-bar", 15}},
  result = "player-boots"
}, {
  type = "recipe",
  name = "player-gloves",
  energy_required = 3.5,
  enabled = false,
  ingredients = {{"steel-plate", 5}, {"iron-gear-wheel", 15}},
  ...
  energy_required = 3.5,
  enabled = false,
  ingredients = {{"battery", 15}, {"processing-unit", 50}},
...
data:extend{{
  ...
  energy_required = 4,
  enabled = false,
  ingredients = {{"steel-plate", 5}, {"player-brain-2", 1}},
