...
table.insert(
  bobmods.classes.characters["bob-character-miner"].crafting_categories,
  "smelting"
)
...
table.insert(
  bobmods.classes.characters["bob-character-miner-2"].crafting_categories,
  "smelting"
)
...
table.insert(
  bobmods.classes.characters["bob-character-engineer"].crafting_categories,
  "smelting"
)
...
table.insert(
  bobmods.classes.characters["bob-character-prospector"].crafting_categories,
  "smelting"
)

for index, character in pairs(bobmods.classes.characters) do
  data:extend{bobmods.classes.characters[index]}
end
