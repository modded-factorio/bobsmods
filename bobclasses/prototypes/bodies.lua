...
data:extend{{
  ...
  energy_required = 10,
  enabled = false,
  ingredients = {{"player-frame", 1}, {"assembling-machine-2", 1}},
  result = "character"
}, {
  type = "recipe",
  name = "bob-character-miner",
  ...
  energy_required = 10,
  enabled = false,
  ingredients = {{"player-frame", 1}, {"assembling-machine-3", 1}},
  ...
  energy_required = 10,
  enabled = false,
  ingredients = {{"player-frame-2", 1}, {"assembling-machine-2", 1}},
  ...
  energy_required = 10,
  enabled = false,
  ingredients = {{"player-frame-2", 1}, {"assembling-machine-3", 1}},
...
data:extend{{
  ...
  prerequisites = {"robotics", "advanced-electronics-2", "automation-2"},
  unit = {
    count = 250,
    ingredients = {
  ...
  prerequisites = {"bodies", "advanced-material-processing-2"},
  unit = {
    count = 150,
    ingredients = {
      {"automation-science-pack", 1},
  ...
  prerequisites = {"bodies", "exoskeleton-equipment"},
  unit = {
    count = 150,
    ingredients = {
      {"automation-science-pack", 1},
  ...
  prerequisites = {"bodies", "automation-3"},
  unit = {
    count = 150,
    ingredients = {
      {"automation-science-pack", 1},
  ...
  prerequisites = {"bodies", "production-science-pack"},
  unit = {
    count = 250,
    ingredients = {
      {"automation-science-pack", 1},
  ...
  prerequisites = {"bodies-2", "miner-body"},
  unit = {
    count = 150,
    ingredients = {
      {"automation-science-pack", 1},
  ...
  prerequisites = {"bodies-2", "fighter-body"},
  unit = {
    count = 150,
    ingredients = {
      {"automation-science-pack", 1},
  ...
  prerequisites = {"bodies-2", "builder-body"},
  unit = {
    count = 150,
    ingredients = {
      {"automation-science-pack", 1},
  ...
  prerequisites = {"miner-body", "builder-body", "bodies-2"},
  unit = {
    count = 150,
    ingredients = {
      {"automation-science-pack", 1},
  ...
  prerequisites = {"miner-body", "fighter-body", "bodies-2"},
  unit = {
    count = 150,
    ingredients = {
      {"automation-science-pack", 1},
