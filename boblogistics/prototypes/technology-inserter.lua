data:extend({{
  ...
  icon_size = 128,
  effects = {},
  prerequisites = {"fast-inserter", "chemical-science-pack"},
  unit = {
    count = 50,
    ingredients = {
  ...
  icon_mipmaps = 4,
  effects = {},
  prerequisites = {"stack-inserter", "express-inserters"},
  unit = {
    count = 250,
    ingredients = {
      {"automation-science-pack", 1},
...
if settings.startup["bobmods-logistics-inserteroverhaul"].value == true then
  data.raw.technology["fast-inserter"].icon =
    "__boblogistics__/graphics/icons/technology/long-inserters.png"
  data.raw.technology["fast-inserter"].icon_size = 128
  data.raw.technology["fast-inserter"].icon_mipmaps = nil

  data.raw.technology["express-inserters"].icon =
    "__boblogistics__/graphics/icons/technology/blue-inserter.png"
  ...
  data:extend({{
    ...
    prerequisites = {"express-inserters", "logistics-4"},
    unit = {
      count = 100,
      ingredients = {
        {"automation-science-pack", 1},
    ...
    prerequisites = {"turbo-inserter", "logistics-5"},
    unit = {
      count = 150,
      ingredients = {
        {"automation-science-pack", 1},
    ...
    prerequisites = {"turbo-inserter", "stack-inserter-2"},
    unit = {
      count = 350,
      ingredients = {
        {"automation-science-pack", 1},
    ...
    prerequisites = {"ultimate-inserter", "stack-inserter-3"},
    unit = {
      count = 450,
      ingredients = {
        {"automation-science-pack", 1},
...
data:extend({{
  ...
  prerequisites = {"logistic-science-pack", "logistics"},
  unit = {
    count = 50,
    ingredients = {
      {"automation-science-pack", 1},
