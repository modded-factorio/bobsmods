...
data.raw["logistic-container"]["logistic-chest-passive-provider"].next_upgrade =
  "logistic-chest-passive-provider-2"
data.raw["logistic-container"]["logistic-chest-active-provider"].next_upgrade =
  "logistic-chest-active-provider-2"
data.raw["logistic-container"]["logistic-chest-storage"].next_upgrade =
  "logistic-chest-storage-2"
data.raw["logistic-container"]["logistic-chest-buffer"].next_upgrade =
  "logistic-chest-buffer-2"
data.raw["logistic-container"]["logistic-chest-requester"].next_upgrade =
  "logistic-chest-requester-2"

data:extend({bobmods.logistics.logistic_container{
  ...
  animation = bobmods.logistics.logistic_container_2_picture({
    r = 0.9,
    g = 0.2,
    b = 0.1,
    a = 1
...
data:extend({bobmods.logistics.logistic_container{
  ...
  inventory_size = 80,
  logistic_mode = "passive-provider",
  animation = bobmods.logistics.logistic_container_3_picture({
    r = 0.9,
    g = 0.2,
    b = 0.1,
    a = 1
