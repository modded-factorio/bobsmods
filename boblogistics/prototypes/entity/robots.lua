...
data:extend({
  {
    ...
    resistances = { { type = "fire", decrease = 4, percent = 85 }, { type = "electric", decrease = 6, percent = 60 }, { type = "acid", decrease = 4, percent = 60 } },
    max_health = 125,
    max_payload_size = 3,
    speed = 0.07,
    max_energy = "2250kJ",
...

  {
    ...
    resistances = { { type = "fire", decrease = 8, percent = 85 }, { type = "electric", decrease = 12, percent = 75 }, { type = "acid", decrease = 8, percent = 65 } },
    max_health = 150,
    max_payload_size = 6,
    speed = 0.09,
    max_energy = "3000kJ",
...

  {
    ...
    resistances = { { type = "fire", decrease = 12, percent = 90 }, { type = "electric", decrease = 20, percent = 90 }, { type = "acid", decrease = 12, percent = 70 } },
    max_health = 175,
    max_payload_size = 11,
    speed = 0.12,
    max_energy = "3750kJ",
