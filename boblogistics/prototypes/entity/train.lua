if settings.startup["bobmods-logistics-trains"].value == true then
  ...
  data:extend({util.merge{data.raw.locomotive.locomotive, { --original is 2000 -- this is a percentage of current speed that will be subtracted --original is 2000 --0.0005, --0.001, -- this is a percentage of current speed that will be subtracted
  ...
  data.raw["cargo-wagon"]["cargo-wagon"].resistances =
    rolling_stock_resistances()

  data:extend({util.merge{data.raw["cargo-wagon"]["cargo-wagon"], { --original is 1000 --1.5 --3 --0.5 --0.01
  ...
  local fluidwagonbase =
    settings.startup["bobmods-logistics-fluidwagonbase"].value * 1000
  data.raw["fluid-wagon"]["fluid-wagon"].capacity = fluidwagonbase

  data:extend({util.merge{data.raw["fluid-wagon"]["fluid-wagon"], { --original is 1000 --1.5 --3 --0.5 --0.01
