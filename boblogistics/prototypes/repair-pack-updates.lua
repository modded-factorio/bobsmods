...
if data.raw.item["bob-steel-gear-wheel"] then
  bobmods.lib.recipe.replace_ingredient("repair-pack-2", "iron-gear-wheel", "bob-steel-gear-wheel")
end
...
if data.raw.item["bob-cobalt-steel-alloy"] then
  bobmods.lib.recipe.replace_ingredient("repair-pack-3", "steel-plate", "bob-cobalt-steel-alloy")
end

if data.raw.item["bob-titanium-gear-wheel"] then
  bobmods.lib.recipe.replace_ingredient("repair-pack-4", "iron-gear-wheel", "bob-titanium-gear-wheel")
end

if data.raw.item["bob-titanium-bearing"] then
  bobmods.lib.recipe.add_ingredient("repair-pack-4", { type = "item", name = "bob-titanium-bearing", amount = 1 })
end
...
if data.raw.item["bob-nitinol-bearing"] then
  bobmods.lib.recipe.add_ingredient("repair-pack-5", { type = "item", name = "bob-nitinol-bearing", amount = 1 })
end
