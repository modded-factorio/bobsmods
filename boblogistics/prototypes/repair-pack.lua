data.raw["repair-tool"]["repair-pack"].icon =
  "__boblogistics__/graphics/icons/repair-pack.png"
...
data:extend({{
  ...
  icon = "__boblogistics__/graphics/icons/technology/repair-pack.png",
  icon_size = 32,
  prerequisites = {"bob-repair-pack-2", "advanced-electronics"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon = "__boblogistics__/graphics/icons/technology/repair-pack.png",
  icon_size = 32,
  prerequisites = {"bob-repair-pack-3", "advanced-electronics-2"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon = "__boblogistics__/graphics/icons/technology/repair-pack.png",
  icon_size = 32,
  prerequisites = {"bob-repair-pack-4"},
  effects = {{
    type = "unlock-recipe",
