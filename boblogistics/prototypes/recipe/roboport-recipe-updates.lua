...
if data.raw.item["invar-alloy"] then
  bobmods.lib.recipe.replace_ingredient("roboport-chargepad-2", "steel-plate", "invar-alloy")
  bobmods.lib.recipe.replace_ingredient("roboport-door-2", "steel-plate", "invar-alloy")
