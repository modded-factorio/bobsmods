if data.raw.item["bob-zinc-plate"] then
  bobmods.lib.recipe.replace_ingredient("bob-storage-tank-2", "steel-plate", "bob-zinc-plate")
  bobmods.lib.recipe.replace_ingredient("bob-storage-tank-all-corners-2", "steel-plate", "bob-zinc-plate")
  bobmods.lib.tech.add_prerequisite("bob-fluid-handling-2", "bob-zinc-processing")
end
