if data.raw.item["brass-chest"] then
  bobmods.lib.recipe.replace_ingredient("logistic-chest-passive-provider-2", "logistic-chest-passive-provider", "brass-chest")
  bobmods.lib.recipe.replace_ingredient("logistic-chest-active-provider-2", "logistic-chest-active-provider", "brass-chest")
...
if data.raw.item["titanium-chest"] then
  bobmods.lib.recipe.replace_ingredient("logistic-chest-passive-provider-3", "logistic-chest-passive-provider-2", "titanium-chest")
  bobmods.lib.recipe.replace_ingredient("logistic-chest-active-provider-3", "logistic-chest-active-provider-2", "titanium-chest")
  ...
  if data.raw.item["advanced-processing-unit"] then
    bobmods.lib.recipe.replace_ingredient("logistic-chest-passive-provider-3", "processing-unit", "advanced-processing-unit")
    bobmods.lib.recipe.replace_ingredient("logistic-chest-active-provider-3", "processing-unit", "advanced-processing-unit")
