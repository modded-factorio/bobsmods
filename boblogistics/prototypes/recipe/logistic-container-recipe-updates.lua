if data.raw.item["bob-brass-chest"] then
  ...
  bobmods.lib.recipe.add_ingredient("bob-active-provider-chest-2", { type = "item", name = "advanced-circuit", amount = 3 })
...
if data.raw.item["bob-titanium-chest"] then
  bobmods.lib.recipe.replace_ingredient("bob-passive-provider-chest-3", "bob-passive-provider-chest-2", "bob-titanium-chest")
  bobmods.lib.recipe.replace_ingredient("bob-active-provider-chest-3", "bob-active-provider-chest-2", "bob-titanium-chest")
  ...
  bobmods.lib.recipe.add_ingredient("bob-passive-provider-chest-3", { type = "item", name = "processing-unit", amount = 2 })
  bobmods.lib.recipe.add_ingredient("bob-active-provider-chest-3", { type = "item", name = "processing-unit", amount = 2 })
  ...
  if data.raw.item["bob-advanced-processing-unit"] then
    bobmods.lib.recipe.replace_ingredient("bob-passive-provider-chest-3", "processing-unit", "bob-advanced-processing-unit")
    bobmods.lib.recipe.replace_ingredient("bob-active-provider-chest-3", "processing-unit", "bob-advanced-processing-unit")
