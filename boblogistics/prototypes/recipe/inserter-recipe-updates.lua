if settings.startup["bobmods-logistics-inserteroverhaul"].value == true then
  ...
  if data.raw.item["cobalt-steel-bearing"] then
    bobmods.lib.recipe.add_ingredient("fast-inserter", {
      "cobalt-steel-bearing",
      1
    })
    if settings.startup["bobmods-logistics-inserterrequireprevious"].value == true then
      bobmods.lib.recipe.add_ingredient("filter-inserter", {
        "cobalt-steel-bearing",
        1
      })
      bobmods.lib.recipe.add_ingredient("stack-inserter", {
        "cobalt-steel-bearing",
        5
      })
      bobmods.lib.recipe.add_ingredient("stack-filter-inserter", {
        "cobalt-steel-bearing",
        6
      })
    else
  ...
  if data.raw.item["titanium-bearing"] then
    ...
    if settings.startup["bobmods-logistics-inserterrequireprevious"].value == true then
      bobmods.lib.recipe.add_ingredient("turbo-filter-inserter", {
        "titanium-bearing",
        1
      })
      bobmods.lib.recipe.add_ingredient("turbo-stack-inserter", {
        "titanium-bearing",
        6
      })
      bobmods.lib.recipe.add_ingredient("turbo-stack-filter-inserter", {
        "titanium-bearing",
        6
      })
    else
  ...
  if data.raw.item["nitinol-bearing"] then
    bobmods.lib.recipe.add_ingredient("express-inserter", {
      "nitinol-bearing",
      1
    })
    if settings.startup["bobmods-logistics-inserterrequireprevious"].value == true then
      bobmods.lib.recipe.add_ingredient("express-filter-inserter", {
        "nitinol-bearing",
        1
      })
      bobmods.lib.recipe.add_ingredient("express-stack-inserter", {
        "nitinol-bearing",
        6
      })
      bobmods.lib.recipe.add_ingredient("express-stack-filter-inserter", {
        "nitinol-bearing",
        6
      })
    else
