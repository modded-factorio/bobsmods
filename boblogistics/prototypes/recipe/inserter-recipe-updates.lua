if settings.startup["bobmods-logistics-inserteroverhaul"].value == true then
  ...
  if data.raw.item["titanium-bearing"] then
    ...
    if settings.startup["bobmods-logistics-inserterrequireprevious"].value == true then
      bobmods.lib.recipe.add_ingredient("turbo-bulk-inserter", { type = "item", name = "titanium-bearing", amount = 6 })
    else
      bobmods.lib.recipe.add_ingredient("turbo-bulk-inserter", { type = "item", name = "titanium-bearing", amount = 5 })
    end
  end
  ...
  if data.raw.item["titanium-bearing"] then
    ...
    bobmods.lib.recipe.add_ingredient("express-bulk-inserter", { type = "item", name = "titanium-bearing", amount = 6 })
  end
