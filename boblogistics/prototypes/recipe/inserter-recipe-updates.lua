if settings.startup["bobmods-logistics-inserteroverhaul"].value == true then
  ...
  if data.raw.item["bob-steel-gear-wheel"] then
    ...
    bobmods.lib.recipe.replace_ingredient("red-bulk-inserter", "iron-gear-wheel", "bob-steel-gear-wheel")
  end
  ...
  if data.raw.item["bob-cobalt-steel-bearing"] then
    ...
    if settings.startup["bobmods-logistics-inserterrequireprevious"].value == true then
      bobmods.lib.recipe.add_ingredient("bulk-inserter", { type = "item", name = "bob-cobalt-steel-bearing", amount = 6 })
    else
      bobmods.lib.recipe.add_ingredient("bulk-inserter", { type = "item", name = "bob-cobalt-steel-bearing", amount = 5 })
    end
  ...
  if data.raw.item["bob-titanium-bearing"] then
    bobmods.lib.recipe.add_ingredient("turbo-inserter", { type = "item", name = "bob-titanium-bearing", amount = 1 })
    if settings.startup["bobmods-logistics-inserterrequireprevious"].value == true then
      bobmods.lib.recipe.add_ingredient("turbo-bulk-inserter", { type = "item", name = "bob-titanium-bearing", amount = 6 })
    else
      bobmods.lib.recipe.add_ingredient("turbo-bulk-inserter", { type = "item", name = "bob-titanium-bearing", amount = 5 })
    end
  end

  if data.raw.item["bob-titanium-gear-wheel"] then
    bobmods.lib.recipe.replace_ingredient("turbo-inserter", "iron-gear-wheel", "bob-titanium-gear-wheel")
    bobmods.lib.recipe.replace_ingredient("turbo-bulk-inserter", "iron-gear-wheel", "bob-titanium-gear-wheel")
  end
  ...
  if data.raw.item["bob-nitinol-bearing"] then
    bobmods.lib.recipe.add_ingredient("express-inserter", { type = "item", name = "bob-nitinol-bearing", amount = 1 })
    if settings.startup["bobmods-logistics-inserterrequireprevious"].value == true then
  ...
  if data.raw.item["bob-nitinol-gear-wheel"] then
    bobmods.lib.recipe.replace_ingredient("express-inserter", "iron-gear-wheel", "bob-nitinol-gear-wheel")
    bobmods.lib.recipe.replace_ingredient("express-bulk-inserter", "iron-gear-wheel", "bob-nitinol-gear-wheel")
  end
  ...
  if data.raw.item["bob-titanium-bearing"] then
    bobmods.lib.recipe.add_ingredient("express-inserter", { type = "item", name = "bob-titanium-bearing", amount = 1 })
    bobmods.lib.recipe.add_ingredient("express-bulk-inserter", { type = "item", name = "bob-titanium-bearing", amount = 6 })
  end

  if data.raw.item["bob-titanium-gear-wheel"] then
    bobmods.lib.recipe.replace_ingredient("express-inserter", "iron-gear-wheel", "bob-titanium-gear-wheel")
    bobmods.lib.recipe.replace_ingredient("express-bulk-inserter", "iron-gear-wheel", "bob-titanium-gear-wheel")
    bobmods.lib.tech.add_prerequisite("express-inserters", "bob-titanium-processing")
  end
end
