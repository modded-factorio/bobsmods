data:extend({{
  ...
  energy_required = 4,
  enabled = false,
  ingredients = {{"storage-tank", 1}, {"steel-plate", 20}},
  ...
  energy_required = 5,
  enabled = false,
  ingredients = {{"storage-tank-2", 1}, {"steel-plate", 20}},
  ...
  energy_required = 6,
  enabled = false,
  ingredients = {{"storage-tank-3", 1}, {"steel-plate", 20}},
...
data:extend({{
  ...
  energy_required = 3,
  enabled = false,
  ingredients = {{"iron-plate", 20}, {"steel-plate", 5}, {"pipe", 4}},
