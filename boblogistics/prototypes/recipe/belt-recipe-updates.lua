if settings.startup["bobmods-logistics-beltoverhaul"].value == true then
  ...
  if data.raw.item["steel-bearing"] then
    ...
    if settings.startup["bobmods-logistics-beltrequireprevious"].value == true then
      if data.raw.item["cobalt-steel-bearing"] then
        bobmods.lib.recipe.add_ingredient("express-underground-belt", {
          "cobalt-steel-bearing",
          20
        })
        bobmods.lib.recipe.add_ingredient("express-splitter", {
          "cobalt-steel-bearing",
          12
        })
      elseif data.raw.item["brass-bearing"] then
  ...
  if data.raw.item["titanium-bearing"] then
    ...
    if settings.startup["bobmods-logistics-beltrequireprevious"].value == true then
      bobmods.lib.recipe.add_ingredient("turbo-underground-belt", {
        "titanium-bearing",
        20
      })
      bobmods.lib.recipe.add_ingredient("turbo-splitter", {
        "titanium-bearing",
        12
      })
    else
  ...
  if data.raw.item["nitinol-bearing"] then
    ...
    if settings.startup["bobmods-logistics-beltrequireprevious"].value == true then
      bobmods.lib.recipe.add_ingredient("ultimate-underground-belt", {
        "nitinol-bearing",
        20
      })
      bobmods.lib.recipe.add_ingredient("ultimate-splitter", {
        "nitinol-bearing",
        12
      })
    else
