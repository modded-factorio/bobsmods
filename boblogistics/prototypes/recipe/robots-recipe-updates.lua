if settings.startup["bobmods-logistics-robotrequireprevious"].value == true then
  bobmods.lib.recipe.add_ingredient("bob-logistic-robot-2", {
    "logistic-robot",
    1
  })
  bobmods.lib.recipe.add_ingredient("bob-construction-robot-2", {
    "construction-robot",
    1
  })
  bobmods.lib.recipe.add_ingredient("bob-logistic-robot-3", {
    "bob-logistic-robot-2",
    1
  })
  bobmods.lib.recipe.add_ingredient("bob-construction-robot-3", {
    "bob-construction-robot-2",
    1
  })
  bobmods.lib.recipe.add_ingredient("bob-logistic-robot-4", {
    "bob-logistic-robot-3",
    1
  })
  bobmods.lib.recipe.add_ingredient("bob-construction-robot-4", {
...
if data.raw.recipe["robot-brain-logistic"] then
  ...
  if data.raw.item["circuit-board"] and data.raw.item["basic-electronic-components"] and data.raw.item["electronic-components"] then
    bobmods.lib.recipe.add_ingredient("robot-brain-logistic", {
      "circuit-board",
      1
    })
    bobmods.lib.recipe.add_ingredient("robot-brain-logistic", {
...
if data.raw.recipe["robot-brain-construction"] then
  ...
  if data.raw.item["circuit-board"] and data.raw.item["basic-electronic-components"] and data.raw.item["electronic-components"] then
    bobmods.lib.recipe.add_ingredient("robot-brain-construction", {
      "circuit-board",
      1
    })
    bobmods.lib.recipe.add_ingredient("robot-brain-construction", {
...
if data.raw.recipe["robot-brain-logistic-2"] then
  ...
  if data.raw.item["circuit-board"] and data.raw.item["basic-electronic-components"] and data.raw.item["electronic-components"] then
    bobmods.lib.recipe.add_ingredient("robot-brain-logistic-2", {
      "circuit-board",
      1
    })
    bobmods.lib.recipe.add_ingredient("robot-brain-logistic-2", {
...
if data.raw.recipe["robot-brain-construction-2"] then
  ...
  if data.raw.item["circuit-board"] and data.raw.item["basic-electronic-components"] and data.raw.item["electronic-components"] then
    bobmods.lib.recipe.add_ingredient("robot-brain-construction-2", {
      "circuit-board",
      1
    })
    bobmods.lib.recipe.add_ingredient("robot-brain-construction-2", {
...
if data.raw.recipe["robot-brain-logistic-3"] then
  ...
  if data.raw.item["superior-circuit-board"] and data.raw.item["basic-electronic-components"] and data.raw.item["electronic-components"] and data.raw.item["intergrated-electronics"] then
    bobmods.lib.recipe.add_ingredient("robot-brain-logistic-3", {
...
if data.raw.recipe["robot-brain-construction-3"] then
  ...
  if data.raw.item["superior-circuit-board"] and data.raw.item["basic-electronic-components"] and data.raw.item["electronic-components"] and data.raw.item["intergrated-electronics"] then
    bobmods.lib.recipe.add_ingredient("robot-brain-construction-3", {
      "superior-circuit-board",
      1
    })
    bobmods.lib.recipe.add_ingredient("robot-brain-construction-3", {
...
if data.raw.recipe["robot-brain-logistic-4"] then
  ...
  if data.raw.item["multi-layer-circuit-board"] and data.raw.item["basic-electronic-components"] and data.raw.item["electronic-components"] and data.raw.item["intergrated-electronics"] and data.raw.item["processing-electronics"] then
    bobmods.lib.recipe.add_ingredient("robot-brain-logistic-4", {
...
if data.raw.recipe["robot-brain-construction-4"] then
  ...
  if data.raw.item["multi-layer-circuit-board"] and data.raw.item["basic-electronic-components"] and data.raw.item["electronic-components"] and data.raw.item["intergrated-electronics"] and data.raw.item["processing-electronics"] then
    bobmods.lib.recipe.add_ingredient("robot-brain-construction-4", {
      "multi-layer-circuit-board",
      1
    })
    bobmods.lib.recipe.add_ingredient("robot-brain-construction-4", {
...
if data.raw.item["flying-robot-frame-2"] then
  ...
  for i, robot in
    ipairs({"bob-logistic-robot-2", "bob-construction-robot-2"})
  do
...
if data.raw.item["flying-robot-frame-3"] then
  ...
  for i, robot in
    ipairs({"bob-logistic-robot-3", "bob-construction-robot-3"})
  do
    data.raw.recipe[robot].energy_required = 20
...
if data.raw.item["flying-robot-frame-4"] then
  ...
  for i, robot in
    ipairs({"bob-logistic-robot-4", "bob-construction-robot-4"})
  do
    data.raw.recipe[robot].energy_required = 20
    if settings.startup["bobmods-logistics-robotrequireprevious"].value == false then
      bobmods.lib.recipe.add_ingredient(robot, {"electric-engine-unit", 1})
...
if settings.startup["bobmods-logistics-robotrequireprevious"].value == true then
  bobmods.lib.recipe.add_ingredient("bob-logistic-robot-5", {
    "bob-logistic-robot-4",
    1
  })
  bobmods.lib.recipe.add_ingredient("bob-construction-robot-5", {
  ...
  if data.raw.item["flying-robot-frame-4"] then
    ...
    for i, robot in
      ipairs({"bob-logistic-robot-5", "bob-construction-robot-5"})
    do
      data.raw.recipe[robot].energy_required = 20
      bobmods.lib.recipe.add_ingredient(robot, {"electric-engine-unit", 1})
      ...
      if data.raw.item["advanced-processing-unit"] then
        bobmods.lib.recipe.add_ingredient(robot, {
          "advanced-processing-unit",
          3
        })
      else
