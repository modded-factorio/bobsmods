if settings.startup["bobmods-logistics-trains"].value == true then
  if mods["bobplates"] then
    ...
    bobmods.lib.recipe.add_ingredient("bob-locomotive-2", { type = "item", name = "bob-cobalt-steel-bearing", amount = 16 })
    bobmods.lib.recipe.add_ingredient("bob-cargo-wagon-2", { type = "item", name = "bob-cobalt-steel-bearing", amount = 8 })
    ...
    bobmods.lib.recipe.add_ingredient("bob-armoured-locomotive", { type = "item", name = "bob-cobalt-steel-bearing", amount = 16 })
    bobmods.lib.recipe.add_ingredient("bob-armoured-cargo-wagon", { type = "item", name = "bob-cobalt-steel-bearing", amount = 8 })
    ...
    bobmods.lib.recipe.add_ingredient("bob-armoured-locomotive", { type = "item", name = "bob-gunmetal-alloy", amount = 15 })
    bobmods.lib.recipe.add_ingredient("bob-armoured-cargo-wagon", { type = "item", name = "bob-gunmetal-alloy", amount = 15 })
    bobmods.lib.recipe.add_ingredient("bob-armoured-fluid-wagon", { type = "item", name = "bob-gunmetal-alloy", amount = 15 })
    ...
    bobmods.lib.recipe.add_ingredient("bob-armoured-locomotive-2", { type = "item", name = "bob-titanium-bearing", amount = 16 })
    bobmods.lib.recipe.add_ingredient("bob-armoured-cargo-wagon-2", { type = "item", name = "bob-titanium-bearing", amount = 8 })
    ...
    bobmods.lib.recipe.add_ingredient("bob-armoured-locomotive-2", { type = "item", name = "bob-silicon-nitride", amount = 15 })
    bobmods.lib.recipe.add_ingredient("bob-armoured-cargo-wagon-2", { type = "item", name = "bob-silicon-nitride", amount = 15 })
    bobmods.lib.recipe.add_ingredient("bob-armoured-fluid-wagon-2", { type = "item", name = "bob-silicon-nitride", amount = 15 })
