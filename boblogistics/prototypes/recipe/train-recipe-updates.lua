if settings.startup["bobmods-logistics-trains"].value == true then
  ...
  if data.raw.item["steel-bearing"] then
    ...
    bobmods.lib.recipe.add_ingredient("bob-locomotive-2", {
      "iron-gear-wheel",
      10
    })
    bobmods.lib.recipe.add_ingredient("bob-cargo-wagon-2", {
      "iron-gear-wheel",
      8
    })
    bobmods.lib.recipe.add_ingredient("bob-fluid-wagon-2", {
      "iron-gear-wheel",
      8
    })
  end
  ...
  if data.raw.item["titanium-bearing"] then
    bobmods.lib.recipe.add_ingredient("bob-locomotive-3", {
      "titanium-bearing",
      16
    })
    bobmods.lib.recipe.add_ingredient("bob-cargo-wagon-3", {
      "titanium-bearing",
      8
    })
    bobmods.lib.recipe.add_ingredient("bob-fluid-wagon-3", {
      "titanium-bearing",
      8
    })

    bobmods.lib.recipe.add_ingredient("bob-armoured-locomotive-2", {
      "titanium-bearing",
      16
    })
    bobmods.lib.recipe.add_ingredient("bob-armoured-cargo-wagon-2", {
      "titanium-bearing",
      8
    })
    bobmods.lib.recipe.add_ingredient("bob-armoured-fluid-wagon-2", {
      "titanium-bearing",
      8
    })
  else
