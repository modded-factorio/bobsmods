...
bobmods.lib.recipe.add_ingredient("bob-logistic-zone-expander-2", {type = "item", name = "se-aeroframe-pole", amount = 2})
bobmods.lib.recipe.remove_ingredient("bob-logistic-zone-expander-3", "steel-plate")
bobmods.lib.recipe.add_ingredient("bob-logistic-zone-expander-3", {type = "item", name = "se-aeroframe-scaffold", amount = 3})
bobmods.lib.recipe.remove_ingredient("bob-logistic-zone-expander-4", "steel-plate")
bobmods.lib.recipe.add_ingredient("bob-logistic-zone-expander-4", {type = "item", name = "se-aeroframe-bulkhead", amount = 1})
...
bobmods.lib.recipe.add_ingredient("bob-robo-charge-port-3", {type = "item", name = "se-aeroframe-scaffold", amount = 5})
bobmods.lib.recipe.remove_ingredient("bob-robo-charge-port-4", "steel-plate")
bobmods.lib.recipe.add_ingredient("bob-robo-charge-port-4", {type = "item", name = "se-aeroframe-bulkhead", amount = 3})
bobmods.lib.recipe.remove_ingredient("bob-robo-charge-port-large-2", "steel-plate")
bobmods.lib.recipe.add_ingredient("bob-robo-charge-port-large-2", {type = "item", name = "se-beryllium-plate", amount = 18})
bobmods.lib.recipe.remove_ingredient("bob-robo-charge-port-large-3", "steel-plate")
bobmods.lib.recipe.add_ingredient("bob-robo-charge-port-large-3", {type = "item", name = "se-aeroframe-scaffold", amount = 12})
bobmods.lib.recipe.remove_ingredient("bob-robo-charge-port-large-4", "steel-plate")
bobmods.lib.recipe.add_ingredient("bob-robo-charge-port-large-4", {type = "item", name = "se-aeroframe-bulkhead", amount = 7})
...
bobmods.lib.recipe.add_ingredient("se-pylon-construction-radar", {type = "item", name = "roboport-antenna-4", amount = 3})
...
bobmods.lib.recipe.replace_ingredient("se-deep-space-transport-belt", "se-space-transport-belt", "ultimate-transport-belt")
