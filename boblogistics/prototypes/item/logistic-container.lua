data.raw.item["logistic-chest-passive-provider"].order =
  "b[storage]-[logistic-chest-passive-provider-1]"
data.raw.item["logistic-chest-active-provider"].order =
  "b[storage]-[logistic-chest-active-provider-1]"
data.raw.item["logistic-chest-storage"].order =
  "b[storage]-[logistic-chest-storage-1]"
data.raw.item["logistic-chest-buffer"].order =
  "b[storage]-[logistic-chest-buffer-1]"
data.raw.item["logistic-chest-requester"].order =
  "b[storage]-[logistic-chest-requester-1]"
