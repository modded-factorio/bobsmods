...
data.raw.item["stack-filter-inserter"].order =
  "e[inserter]-d[express]-d[stack-filter]"
...
if settings.startup["bobmods-logistics-inserteroverhaul"].value == true then
  ...
  data.raw.item["express-stack-inserter"].localised_name =
    {"entity-name.ultimate-stack-inserter"}
  data.raw.item["express-stack-inserter"].icon =
  ...
  data.raw.item["express-stack-filter-inserter"].localised_name =
  ...
  data.raw.item["express-stack-filter-inserter"].subgroup =
    "bob-logistic-tier-5"
end