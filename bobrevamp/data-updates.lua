...
if settings.startup["bobmods-revamp-old-oil"].value == true or settings.startup["bobmods-revamp-oil"].value == true then
  ...
  data.raw.technology["oil-processing"].icon =
  ...
  if data.raw.technology["chemical-processing-2"] then --chemical plant before oil processing
    ...
    bobmods.lib.tech.replace_prerequisite(
      ...
      "chemical-processing-2",
      "chemical-plant"
    ) --chemical plant after oil processing
...
if settings.startup["bobmods-revamp-old-oil"].value == true and not settings.startup["bobmods-revamp-oil"].value == true then
  ...
  if data.raw.fluid["sulfur-dioxide"] then
    ...
    bobmods.lib.module.add_productivity_limitation(
      "oil-processing-with-sulfur-dioxide"
    )
    bobmods.lib.module.add_productivity_limitation(
      "oil-processing-with-sulfur-dioxide-2"
...
if settings.startup["bobmods-revamp-oil"].value == true then
  ...
  if data.raw.fluid["hydrogen-sulfide"] then
    bobmods.lib.recipe.add_result("petroleum-gas-sweetening", {
      type = "fluid",
  ...
  if data.raw["item-subgroup"]["bob-resource-chemical"] then
    data.raw.recipe["solid-fuel-from-sour-gas"].subgroup =
...
data.raw.item["nuclear-fuel"].fuel_glow_color = {
  r = 0.5,
  g = 1,
  b = 0.5
}
...
if data.raw.item["thorium-fuel-cell"] and data.raw.reactor["nuclear-reactor-2"] and settings.startup["bobmods-revamp-nuclear"].value == true then
  data.raw.item["nuclear-reactor"].localised_name =
    {"entity-name.uranium-reactor"}
  data.raw.reactor["nuclear-reactor"].localised_name =
    {"entity-name.uranium-reactor"}
  data.raw["fuel-category"]["nuclear"].localised_name =
    {"fuel-category-name.uranium"}
  ...
  data.raw.reactor["nuclear-reactor-2"].localised_name =
    {"entity-name.thorium-reactor"}
  data.raw.reactor["nuclear-reactor-2"].default_fuel_glow_color = {
    r = 1.0,
    g = 1.0,
    b = 0.0
  }
  data.raw.reactor["nuclear-reactor-2"].icon =
    "__bobrevamp__/graphics/icons/thorium-reactor.png"
  ...
  data.raw.item["nuclear-reactor-2"].localised_name =
    {"entity-name.thorium-reactor"}
  data.raw.item["nuclear-reactor-2"].icon =
    "__bobrevamp__/graphics/icons/thorium-reactor.png"
  ...
  data.raw.technology["bob-nuclear-power-2"].icon =
    "__bobrevamp__/graphics/icons/technology/thorium-nuclear-power.png"
  data.raw.technology["bob-nuclear-power-2"].icon_size = 128
  data.raw.technology["bob-nuclear-power-2"].localised_name =
    {"technology-name.thorium-power"}
...
if data.raw.item["deuterium-fuel-cell"] and data.raw.reactor["nuclear-reactor-3"] and settings.startup["bobmods-revamp-nuclear"].value == true then
  ...
  data.raw.reactor["nuclear-reactor-3"].energy_source.fuel_category =
    "deuterium"
  data.raw.reactor["nuclear-reactor-3"].localised_name =
    {"entity-name.deuterium-reactor"}
  ...
  data.raw.item["nuclear-reactor-3"].localised_name =
    {"entity-name.deuterium-reactor"}
  ...
  data.raw.technology["bob-nuclear-power-3"].localised_name =
    {"technology-name.deuterium-power"}
  ...
  if settings.startup["bobmods-plates-bluedeuterium"] and settings.startup["bobmods-plates-bluedeuterium"].value == true then
    data.raw.reactor["nuclear-reactor-3"].default_fuel_glow_color = {
      r = 0,
      g = 0.7,
      b = 1
    }
    data.raw.reactor["nuclear-reactor-3"].icon =
      "__bobrevamp__/graphics/icons/deuterium-reactor-blue.png"
    data.raw.item["nuclear-reactor-3"].icon =
      "__bobrevamp__/graphics/icons/deuterium-reactor-blue.png"
    ...
    data.raw.reactor["nuclear-reactor-3"].icon =
      "__bobrevamp__/graphics/icons/deuterium-reactor.png"
    data.raw.item["nuclear-reactor-3"].icon =
      "__bobrevamp__/graphics/icons/deuterium-reactor.png"
    data.raw.technology["bob-nuclear-power-3"].icon =
