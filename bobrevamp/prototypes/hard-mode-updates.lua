...
if bobmods.plates and settings.startup["bobmods-revamp-hardmode"].value == true then
  ...
  bobmods.lib.recipe.set_ingredient("calcium-chloride", {
    type = "fluid",
    name = "hydrogen-chloride",
    amount = 50
  })
  bobmods.lib.recipe.add_result("calcium-chloride", {
    type = "fluid",
    name = "hydrogen",
    amount = 20,
    catalyst_amount = 20
  ...
  if data.raw.recipe["calcium-chloride"].expensive then
    data.raw.recipe["calcium-chloride"].expensive.main_product =
      "calcium-chloride"
  end

  bobmods.lib.recipe.set_ingredient("petroleum-gas-cracking", {
    type = "fluid",
    name = "water",
    amount = 20
  })
