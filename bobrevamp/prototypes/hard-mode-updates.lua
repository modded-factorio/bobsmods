...
if bobmods.plates and settings.startup["bobmods-revamp-hardmode"].value == true then
  ...
  bobmods.lib.tech.add_recipe_unlock("bob-chemical-processing-2", "limestone")

  bobmods.lib.tech.add_recipe_unlock("bob-lithium-processing", "sodium-chlorate")
  bobmods.lib.tech.add_recipe_unlock("bob-lithium-processing", "sodium-perchlorate")
  ...
  bobmods.lib.recipe.replace_ingredient("bob-sulfuric-acid-2", "water", "hydrogen-peroxide")
  ...
  bobmods.lib.tech.add_recipe_unlock("bob-nitrogen-processing", "hydrogen-peroxide")
