if data.raw.item["tin-plate"] then
  data:extend({{
    ...
    enabled = false,
    ingredients = {{"copper-cable", 3}, {"tin-plate", 1}},
...
if data.raw.item["gold-plate"] then
  data:extend({{
    ...
    enabled = false,
    ingredients = {{"copper-cable", 3}, {"gold-plate", 1}},
...
if data.raw.item["solder-alloy"] then
  data:extend({{
    ...
    energy_required = 2,
    enabled = false,
    ingredients = {{"solder-alloy", 4}, {"resin", 1}},
    result = "solder",
    result_count = 8,
    allow_decomposition = false
  }})
...
data:extend({{
  ...
  normal = {
    energy_required = 2,
    enabled = false,
    ingredients = {{"copper-cable", 1}, {"coal", 1}},
...
data:extend({{
  ...
  normal = {
    energy_required = 3.5,
    enabled = false,
    ingredients = {{"copper-cable", 1}, {"plastic-bar", 1}},
...
data:extend({{
  ...
  normal = {
    energy_required = 7,
    enabled = false,
    ingredients = {{"copper-cable", 2}, {"plastic-bar", 1}, {
      type = "fluid",
      name = "sulfuric-acid",
      amount = 5
    }},
...
data:extend({{
  ...
  category = "electronics",
  energy_required = 1,
  ingredients = {{"wooden-board", 1}, {"copper-cable", 3}},
...
data:extend({{
  ...
  energy_required = 5,
  enabled = false,
  ingredients = {{"phenolic-board", 1}, {"copper-plate", 1}, {
    type = "fluid",
...
data:extend({{
  ...
  energy_required = 10,
  enabled = false,
  ingredients = {{"fibreglass-board", 1}, {"copper-plate", 1}, {
    type = "fluid",
    name = "ferric-chloride-solution",
    amount = 5
  }},
...
data:extend({{
  ...
  energy_required = 15,
  enabled = false,
  ingredients = {{"fibreglass-board", 1}, {"copper-plate", 2}, {
    type = "fluid",
    name = "ferric-chloride-solution",
    amount = 10
  }},
