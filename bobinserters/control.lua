...
function _slimOffset(entity,l)
  ...
  elseif(entity.prototype.tile_height == 1 and entity.prototype.tile_width == 0) then
	  --   not implemented because no mod found to test
	end
	return o
end
function slimDropOffset(entity) return _slimOffset(entity,1) end
function slimPickupOffset(entity) return _slimOffset(entity,0) end
