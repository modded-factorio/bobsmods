if settings.startup["bobmods-mining-steamminingdrills"].value == true then
  data:extend({{
    ...
    name = "steam-mining-drill",
    energy_required = 1,
    ingredients = {{"burner-mining-drill", 1}, {"pipe", 2}},
  ...
  data.raw["mining-drill"]["steam-mining-drill"].resource_searching_radius =
    1.99
  ...
  for i, direction in
    pairs(data.raw["mining-drill"]["steam-mining-drill"].animations)
  do
