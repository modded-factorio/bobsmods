if settings.startup["bobmods-mining-areadrills"].value == true then
  ...
  if data.raw.item["bob-cobalt-steel-alloy"] then
    ...
    bobmods.lib.tech.add_prerequisite("bob-area-drills-3", "bob-cobalt-processing")
  else
    if data.raw.item["bob-invar-alloy"] then
      bobmods.lib.recipe.replace_ingredient("bob-area-mining-drill-2", "steel-plate", "bob-invar-alloy")
      bobmods.lib.tech.add_prerequisite("bob-area-drills-3", "bob-invar-processing")
    else
      if data.raw.item["bob-brass-alloy"] then
        ...
        bobmods.lib.tech.add_prerequisite("bob-area-drills-3", "bob-zinc-processing")
      end
    end
  end
  ...
  if data.raw.item["bob-tungsten-carbide"] then
    ...
    bobmods.lib.tech.add_prerequisite("bob-area-drills-5", "bob-tungsten-alloy-processing")
  else
  ...
  if data.raw.item["bob-nitinol-gear-wheel"] then
    ...
    bobmods.lib.tech.add_prerequisite("bob-area-drills-5", "bob-nitinol-processing")
  else
    if data.raw.item["bob-tungsten-gear-wheel"] then
      bobmods.lib.recipe.replace_ingredient("bob-area-mining-drill-4", "iron-gear-wheel", "bob-tungsten-gear-wheel")
      bobmods.lib.tech.add_prerequisite("bob-area-drills-5", "bob-tungsten-processing")
    end
  end
end
