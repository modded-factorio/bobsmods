  ...
  data:extend({
    {
      ...
      fluid_box = {
        ...
        pipe_connections = {
          { flow_direction = "input-output", position = { 0, 1.35 }, direction = defines.direction.south },
          { flow_direction = "input-output", position = { 0, -1.35 }, direction = defines.direction.north },
          { flow_direction = "input-output", position = { 1.35, 0 }, direction = defines.direction.east },
          { flow_direction = "input-output", position = { -1.35, 0 }, direction = defines.direction.west },
        },
