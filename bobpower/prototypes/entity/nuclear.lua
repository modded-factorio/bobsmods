if settings.startup["bobmods-power-nuclear"].value == true then
  ...
  data.raw.reactor["nuclear-reactor"].localised_description =
    { "", { "entity-description.nuclear-reactor" }, { "entity-description.reactor-max-temperature", tostring(1000) } }
    ...
    util.merge({
      data.raw.reactor["nuclear-reactor"],
      {
        ...
        localised_description = {
          ...
          { "entity-description.reactor-max-temperature", tostring(1250) },
        },
    ...
    util.merge({
      data.raw.reactor["nuclear-reactor"],
      {
        ...
        localised_description = {
          "",
          { "entity-description.nuclear-reactor" },
          { "entity-description.reactor-max-temperature", tostring(1500) },
        },
        icon = "__base__/graphics/icons/nuclear-reactor.png",
        icon_size = 64,
