if settings.startup["bobmods-power-steam"].value == true then
  data:extend({util.merge{data.raw.boiler.boiler, {
    name = "oil-boiler",
  ...
  data:extend({util.merge{data.raw.boiler["oil-boiler"], {
    name = "oil-boiler-2",
    icon = "__bobpower__/graphics/icons/oil-boiler.png",
    icon_size = 32,
    minable = {
    ...
    energy_source = {emissions_per_minute = 16.875}
  }}, util.merge{data.raw.boiler["oil-boiler"], {
    name = "oil-boiler-3",
    icon = "__bobpower__/graphics/icons/oil-boiler.png",
    icon_size = 32,
    minable = {
    ...
    energy_source = {emissions_per_minute = 11.25}
  }}, util.merge{data.raw.boiler["oil-boiler"], {
    name = "oil-boiler-4",
    icon = "__bobpower__/graphics/icons/oil-boiler.png",
    icon_size = 32,
    ...
    energy_source = {emissions_per_minute = 7.03125}
  }}})
