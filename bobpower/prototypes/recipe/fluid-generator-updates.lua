if settings.startup["bobmods-power-fluidgenerator"].value == true then
  if data.raw.item["steel-bearing"] then
    bobmods.lib.recipe.add_difficulty_ingredient("fluid-generator", "normal", {
      "steel-bearing",
      10
    })
    ...
    bobmods.lib.recipe.add_ingredient("fluid-generator", {
      "iron-gear-wheel",
      10
    })
  end
  ...
  elseif data.raw.item["steel-bearing"] then
    ...
    bobmods.lib.recipe.add_ingredient("fluid-generator-2", {
      "iron-gear-wheel",
      10
    })
  end
  ...
  elseif data.raw.item["steel-bearing"] then
    ...
    bobmods.lib.recipe.add_ingredient("fluid-generator-3", {
      "iron-gear-wheel",
      10
    })
  end
  ...
  if mods["bobrevamp"] and data.raw.fluid.hydrogen and data.raw.fluid.oxygen and data.raw.fluid.nitrogen then
    if data.raw.item["nitinol-bearing"] then
      ...
      bobmods.lib.recipe.add_ingredient("hydrazine-generator", {
        "iron-gear-wheel",
        10
      })
    end
