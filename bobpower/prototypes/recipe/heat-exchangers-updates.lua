if settings.startup["bobmods-power-steam"].value == true then
  ...
  if data.raw.item["heat-pipe-3"] then
    bobmods.lib.recipe.add_ingredient("heat-exchanger-2", { "heat-pipe-3", 4 })
  end
  ...
  if data.raw.item["heat-pipe-4"] then
    bobmods.lib.recipe.add_ingredient("heat-exchanger-3", { "heat-pipe-4", 4 })
  end
  ...
  then
    if data.raw.item["heat-pipe-3"] then
      bobmods.lib.recipe.replace_ingredient("heat-exchanger-2-from-boiler-4", "heat-pipe", "heat-pipe-3")

      bobmods.lib.recipe.remove_result("boiler-4-from-heat-exchanger-2", "heat-pipe")
      bobmods.lib.recipe.add_result("boiler-4-from-heat-exchanger-2", { "heat-pipe-3", 2 })
    end
    if data.raw.item["heat-pipe-4"] then
      bobmods.lib.recipe.replace_ingredient("heat-exchanger-3-from-boiler-5", "heat-pipe", "heat-pipe-4")

      bobmods.lib.recipe.remove_result("boiler-5-from-heat-exchanger-3", "heat-pipe")
      bobmods.lib.recipe.add_result("boiler-5-from-heat-exchanger-3", { "heat-pipe-4", 2 })
    end
