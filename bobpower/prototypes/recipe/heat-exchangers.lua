if settings.startup["bobmods-power-steam"].value == true then
  data:extend({{
    ...
    energy_required = 3,
    enabled = false,
    ingredients = {{"boiler-3", 1}, {"heat-pipe", 4}},
    result = "heat-exchanger"
  }, {
    type = "recipe",
    name = "heat-exchanger-2",
    enabled = false,
    ingredients = {{"heat-exchanger", 1}, {"steel-plate", 10}},
    result = "heat-exchanger-2"
  }, {
    type = "recipe",
    name = "heat-exchanger-3",
    enabled = false,
    ingredients = {{"heat-exchanger-2", 1}, {"steel-plate", 10}},
  ...
  if settings.startup["bobmods-plates-convert-recipes"] and settings.startup["bobmods-plates-convert-recipes"].value == true then
    data:extend({{
      ...
      enabled = false,
      ingredients = {{"boiler-4", 1}, {"heat-pipe", 4}},
      result = "heat-exchanger-2",
      ...
      subgroup = "bob-energy-heat-exchanger-convert",
      enabled = false,
      ingredients = {{"boiler-5", 1}, {"heat-pipe", 4}},
      result = "heat-exchanger-3",
      allow_as_intermediate = false
    }})
    ...
    data:extend({{
      ...
      energy_required = 3,
      enabled = false,
      ingredients = {{"heat-exchanger", 1}},
      results = {{"boiler-3", 1}, {"heat-pipe", 4}},
      ...
      subgroup = "bob-energy-boiler-convert",
      enabled = false,
      ingredients = {{"heat-exchanger-2", 1}},
      results = {{"boiler-4", 1}, {"heat-pipe", 4}},
      ...
      subgroup = "bob-energy-boiler-convert",
      enabled = false,
      ingredients = {{"heat-exchanger-3", 1}},
      results = {{"boiler-5", 1}, {"heat-pipe", 4}},
