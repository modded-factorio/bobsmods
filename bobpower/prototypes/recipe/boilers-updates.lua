if settings.startup["bobmods-power-steam"].value == true then
  ...
  if mods["space-age"] and data.raw.item["bob-stainless-steel-alloy"] then
    bobmods.lib.recipe.replace_ingredient("bob-boiler-4", "steel-plate", "bob-stainless-steel-alloy")
    bobmods.lib.tech.add_prerequisite("bob-boiler-4", "bob-tungsten-processing")
  elseif data.raw.item["tungsten-plate"] then
    bobmods.lib.recipe.replace_ingredient("bob-boiler-4", "steel-plate", "tungsten-plate")
    bobmods.lib.tech.add_prerequisite("bob-boiler-4", "bob-tungsten-processing")
  end
  ...
  if mods["space-age"] and data.raw.item["tungsten-plate"] then
    bobmods.lib.recipe.replace_ingredient("bob-boiler-5", "steel-plate", "tungsten-plate")
    bobmods.lib.tech.add_prerequisite("bob-boiler-5", "metallurgic-science-pack")
