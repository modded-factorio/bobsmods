if settings.startup["bobmods-power-steam"].value == true then
  if data.raw.item["steel-bearing"] then
    bobmods.lib.recipe.add_difficulty_ingredient("steam-engine-2", "normal", {
      "steel-bearing",
      5
    })
  ...
  if data.raw.item["cobalt-steel-bearing"] then
    bobmods.lib.recipe.add_difficulty_ingredient("steam-engine-3", "normal", {
    ...
    if data.raw.item["steel-bearing"] then
      ...
      bobmods.lib.recipe.add_ingredient("steam-engine-3", {
        "iron-gear-wheel",
        5
      })
    end
  ...
  if data.raw.item["titanium-bearing"] then
    bobmods.lib.recipe.add_difficulty_ingredient("steam-engine-4", "normal", {
      "titanium-bearing",
      5
    })
    bobmods.lib.recipe.add_difficulty_ingredient(
    ...
    if data.raw.item["steel-bearing"] then
      ...
      bobmods.lib.recipe.add_ingredient("steam-engine-4", {
        "iron-gear-wheel",
        5
      })
    end
  ...
  if data.raw.item["nitinol-bearing"] then
    bobmods.lib.recipe.add_difficulty_ingredient("steam-engine-5", "normal", {
      "nitinol-bearing",
      5
    })
    bobmods.lib.recipe.add_difficulty_ingredient(
    ...
    if data.raw.item["titanium-bearing"] then
      ...
      bobmods.lib.recipe.add_ingredient("steam-engine-5", {
        "iron-gear-wheel",
        5
      })
    end
