if settings.startup["bobmods-power-accumulators"].value == true then
  ...
  if data.raw.item["bob-silver-zinc-battery"] then
    ...
    bobmods.lib.recipe.replace_ingredient("fast-accumulator-3", "battery", "bob-silver-zinc-battery")
    bobmods.lib.recipe.replace_ingredient("slow-accumulator-3", "battery", "bob-silver-zinc-battery")
    ...
    if data.raw.item["bob-lithium-ion-battery"] then
      ...
      bobmods.lib.recipe.replace_ingredient("fast-accumulator-3", "battery", "bob-lithium-ion-battery")
      bobmods.lib.recipe.replace_ingredient("slow-accumulator-3", "battery", "bob-lithium-ion-battery")
    end
  end
