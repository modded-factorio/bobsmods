if settings.startup["bobmods-power-steam"].value == true or settings.startup["bobmods-power-nuclear"].value == true or settings.startup["bobmods-power-heatsources"].value == true then
  ...
  data:extend({{
    ...
    connection_sprites = make_heat_pipe_pictures(
      "__bobpower__/graphics/heat-pipe-2/",
      "heat-pipe",
      {
        single = {
          name = "straight-vertical-single",
          ommit_number = true
        },
    ...
    connection_sprites = make_heat_pipe_pictures(
      "__bobpower__/graphics/heat-pipe-3/",
      "heat-pipe",
      {
        single = {
          name = "straight-vertical-single",
    ...
    icon = "__bobpower__/graphics/icons/technology/heat-pipe.png",
    icon_size = 256,
    prerequisites = {"bob-heat-pipe-1", "chemical-science-pack"},
    effects = {{
      type = "unlock-recipe",
      recipe = "heat-pipe-2"
    }},
    ...
    icon = "__bobpower__/graphics/icons/technology/heat-pipe.png",
    icon_size = 256,
    prerequisites = {"bob-heat-pipe-2", "production-science-pack"},
    effects = {{
      type = "unlock-recipe",
      recipe = "heat-pipe-3"
    }},
