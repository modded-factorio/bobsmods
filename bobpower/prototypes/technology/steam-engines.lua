if settings.startup["bobmods-power-steam"].value == true then
  data:extend({{
    ...
    prerequisites = {"bob-steam-engine-2", "logistic-science-pack"},
    icon = "__bobpower__/graphics/icons/technology/steam-engine.png",
    icon_size = 128,
    effects = {{
      type = "unlock-recipe",
    ...
    prerequisites = {"bob-steam-engine-3", "chemical-science-pack"},
    icon = "__bobpower__/graphics/icons/technology/steam-engine.png",
    icon_size = 128,
    effects = {{
      type = "unlock-recipe",
    ...
    prerequisites = {"bob-steam-engine-4", "production-science-pack"},
    icon = "__bobpower__/graphics/icons/technology/steam-engine.png",
    icon_size = 128,
    effects = {{
      type = "unlock-recipe",
