if settings.startup["bobmods-power-poles"].value == true then
  data:extend({{
    ...
    prerequisites = {"electric-pole-2", "chemical-science-pack"},
    unit = {
      count = 200,
      ingredients = {
        {"automation-science-pack", 1},
    ...
    prerequisites = {"electric-pole-3", "production-science-pack"},
    unit = {
      count = 250,
      ingredients = {
        {"automation-science-pack", 1},
    ...
    prerequisites = {"electric-energy-distribution-2", "advanced-electronics"},
    unit = {
      count = 300,
      ingredients = {
        {"automation-science-pack", 1},
    ...
    prerequisites = {"electric-substation-2", "advanced-electronics-2"},
    unit = {
      count = 350,
      ingredients = {
        {"automation-science-pack", 1},
    ...
    prerequisites = {"electric-substation-3"},
    unit = {
      count = 400,
      ingredients = {
        {"automation-science-pack", 1},
