if settings.startup["bobmods-power-heatsources"].value == true then
  ...
  data:extend({{ -- should use glow color from fuel item prototype as light color and tint for working_light_picture
  -- default_fuel_glow_color = { 0, 1, 0, 1 } -- color used as working_light_picture tint for fuels that don't have glow color defined
    ...
    energy_required = 2,
    enabled = false,
    ingredients = {{"steel-furnace", 1}, {"heat-pipe", 8}, {"steel-plate", 6}},
    ...
    icon_size = 128,
    prerequisites = {"advanced-material-processing", "bob-heat-pipe-1"},
    effects = {{
      type = "unlock-recipe",
  ...
  }, util.merge{data.raw.reactor["burner-reactor"], {
    name = "burner-reactor-2",
  ...
  data:extend({{
    ...
    energy_required = 2,
    enabled = false,
    ingredients = {{"burner-reactor", 1}, {"steel-plate", 6}, {"pipe", 5}},
    ...
    icon = "__bobpower__/graphics/icons/technology/heat-power.png",
    icon_size = 128,
    prerequisites = {"burner-reactor-1", "bob-heat-pipe-1"},
    effects = {{
      type = "unlock-recipe",
  ...
  }, util.merge{data.raw.reactor["burner-reactor-2"], {
    name = "fluid-reactor-2",
  ...
  }, util.merge{data.raw.reactor["burner-reactor-3"], {
    name = "fluid-reactor-3",
  ...
  data.raw.reactor["fluid-reactor-2"].energy_source =
    fluid_reactor_energy_source
  data.raw.reactor["fluid-reactor-3"].energy_source =
    fluid_reactor_energy_source

  --If the oil burning steel furnace exists, add a new alternate recipe to craft the fluid reactor from it.
  if settings.startup["bobmods-assembly-oilfurnaces"] and settings.startup["bobmods-assembly-oilfurnaces"].value == true then
    data:extend({{
      type = "recipe",
