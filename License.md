...
No Modification - Although I can't stop you from looking at my code, you are not allowed to distribute anything altered or derived from my code without express permission first.
...
Minor bug fixes/tweaks for compatibility reasons, such as altering the dependencies line in info.json to force a load order in a modpack.
Any further modifications, such as changing values of entities/recipes should be done externally in another mod, similar to how my own mods have dynamic recipes and enable/disable certain things as needed.
