data:extend({
  {
    type = "item",
    name = "bob-vehicle-fission-cell-equipment-1",
    icon = "__bobvehicleequipment__/graphics/icons/vehicle-fission-cell-equipment-1.png",
    place_as_equipment_result = "bob-vehicle-fission-cell-equipment-1",
...

  {
    ...
    results = { { type = "item", name = "bob-vehicle-fission-cell-equipment-1", amount = 1 } },
  },
...

  {
    ...
    effects = {
      {
        type = "unlock-recipe",
        recipe = "bob-vehicle-fission-cell-equipment-1",
      },
    },
  },
})
...
data:extend({
  {
    ...
    place_as_equipment_result = "bob-vehicle-fission-cell-equipment-2",
    subgroup = "vehicle-equipment",
...

  {
    ...
    results = { { type = "item", name = "bob-vehicle-fission-cell-equipment-2", amount = 1 } },
  },
...

  {
    ...
    effects = {
      {
        type = "unlock-recipe",
        recipe = "bob-vehicle-fission-cell-equipment-2",
      },
    },
  },
})
...
data:extend({
  {
    ...
    place_as_equipment_result = "bob-vehicle-fission-cell-equipment-3",
    subgroup = "vehicle-equipment",
...

  {
    ...
    energy_required = 10,
    ingredients = {
      { type = "item", name = "bob-vehicle-fission-cell-equipment-2", amount = 1 },
      { type = "item", name = "processing-unit", amount = 50 },
      { type = "item", name = "uranium-fuel-cell", amount = 18 },
      { type = "item", name = "low-density-structure", amount = 25 },
    },
    results = { { type = "item", name = "bob-vehicle-fission-cell-equipment-3", amount = 1 } },
  },
...

  {
    ...
    effects = {
      {
        type = "unlock-recipe",
        recipe = "bob-vehicle-fission-cell-equipment-3",
      },
    },
  },
})
...
data:extend({
  {
    ...
    place_as_equipment_result = "bob-vehicle-fission-cell-equipment-4",
    subgroup = "vehicle-equipment",
...

  {
    ...
    energy_required = 10,
    ingredients = {
      { type = "item", name = "bob-vehicle-fission-cell-equipment-3", amount = 1 },
      { type = "item", name = "processing-unit", amount = 50 },
      { type = "item", name = "uranium-fuel-cell", amount = 24 },
    },
    results = { { type = "item", name = "bob-vehicle-fission-cell-equipment-4", amount = 1 } },
  },
...

  {
    ...
    effects = {
      {
        type = "unlock-recipe",
        recipe = "bob-vehicle-fission-cell-equipment-4",
      },
    },
  },
})
...
data:extend({
  {
    ...
    place_as_equipment_result = "bob-vehicle-fission-cell-equipment-5",
    subgroup = "vehicle-equipment",
...

  {
    ...
    energy_required = 10,
    ingredients = {
      { type = "item", name = "bob-vehicle-fission-cell-equipment-4", amount = 1 },
      { type = "item", name = "processing-unit", amount = 50 },
      { type = "item", name = "uranium-fuel-cell", amount = 30 },
    },
    results = { { type = "item", name = "bob-vehicle-fission-cell-equipment-5", amount = 1 } },
  },
...

  {
    ...
    effects = {
      {
        type = "unlock-recipe",
        recipe = "bob-vehicle-fission-cell-equipment-5",
      },
    },
  },
})
...
data:extend({
  {
    ...
    place_as_equipment_result = "bob-vehicle-fission-cell-equipment-6",
    subgroup = "vehicle-equipment",
...

  {
    ...
    energy_required = 10,
    ingredients = {
      { type = "item", name = "bob-vehicle-fission-cell-equipment-5", amount = 1 },
      { type = "item", name = "processing-unit", amount = 75 },
      { type = "item", name = "uranium-fuel-cell", amount = 48 },
    },
    results = { { type = "item", name = "bob-vehicle-fission-cell-equipment-6", amount = 1 } },
  },
...

  {
    ...
    effects = {
      {
        type = "unlock-recipe",
        recipe = "bob-vehicle-fission-cell-equipment-6",
      },
    },
  },
})
