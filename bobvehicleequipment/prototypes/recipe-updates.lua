...
then
  ...
  if data.raw.item["steel-bearing"] then
    bobmods.lib.recipe.add_ingredient("vehicle-roboport-equipment-2", { type = "item", name = "steel-bearing", amount = 5 })
...
if data.raw.item["aluminium-plate"] then
  bobmods.lib.recipe.replace_ingredient("vehicle-roboport-equipment-2", "steel-plate", "aluminium-plate")
...
then
  ...
  if data.raw.item["titanium-bearing"] then
    bobmods.lib.recipe.add_ingredient("vehicle-roboport-equipment-3", { type = "item", name = "titanium-bearing", amount = 5 })
    bobmods.lib.recipe.add_ingredient(
...
if data.raw.item["titanium-plate"] then
  bobmods.lib.recipe.replace_ingredient("vehicle-roboport-equipment-3", "steel-plate", "titanium-plate")
...
then
  ...
  if data.raw.item["nitinol-bearing"] then
    bobmods.lib.recipe.add_ingredient("vehicle-roboport-equipment-4", { type = "item", name = "nitinol-bearing", amount = 5 })
    bobmods.lib.recipe.add_ingredient(
      "vehicle-roboport-antenna-equipment-4",
...
if data.raw.item["advanced-processing-unit"] then
  bobmods.lib.tech.add_prerequisite("vehicle-roboport-equipment-equipment-4", "advanced-electronics-3")
  bobmods.lib.recipe.replace_ingredient(
...
if data.raw.item["glass"] then
  bobmods.lib.recipe.replace_ingredient("vehicle-solar-panel-equipment-2", "steel-plate", "glass")
end

if data.raw.item["silver-plate"] then
  bobmods.lib.recipe.replace_ingredient("vehicle-solar-panel-equipment-2", "copper-plate", "silver-plate")
end

if data.raw.item["invar-alloy"] then
  bobmods.lib.recipe.replace_ingredient("vehicle-laser-defense-equipment-3", "steel-plate", "invar-alloy")
  bobmods.lib.tech.add_prerequisite("vehicle-laser-defense-equipment-3", "invar-processing")

  bobmods.lib.recipe.replace_ingredient("vehicle-big-turret-equipment-3", "steel-plate", "invar-alloy")
  bobmods.lib.tech.add_prerequisite("vehicle-big-turret-equipment-3", "invar-processing")
end

if data.raw.item["aluminium-plate"] then
  bobmods.lib.recipe.replace_ingredient("vehicle-solar-panel-equipment-3", "steel-plate", "aluminium-plate")
  bobmods.lib.tech.add_prerequisite("vehicle-solar-panel-equipment-3", "aluminium-processing")
end

if data.raw.item["gold-plate"] then
  bobmods.lib.recipe.replace_ingredient("vehicle-solar-panel-equipment-3", "copper-plate", "gold-plate")
end
...
if data.raw.item["silicon-wafer"] then
  bobmods.lib.recipe.add_new_ingredient("vehicle-solar-panel-equipment-4", { type = "item", name = "silicon-wafer", amount = 10 })
  bobmods.lib.tech.add_prerequisite("vehicle-solar-panel-equipment-4", "silicon-processing")
  bobmods.lib.recipe.add_new_ingredient("vehicle-solar-panel-equipment-5", { type = "item", name = "silicon-wafer", amount = 10 })
  bobmods.lib.recipe.add_new_ingredient("vehicle-solar-panel-equipment-6", { type = "item", name = "silicon-wafer", amount = 10 })
end

if data.raw.item["advanced-processing-unit"] then
  bobmods.lib.recipe.replace_ingredient("vehicle-shield-equipment-3", "processing-unit", "advanced-processing-unit")
  bobmods.lib.tech.add_prerequisite("vehicle-shield-equipment-3", "advanced-electronics-3")
  ...
  bobmods.lib.tech.add_prerequisite("vehicle-fission-reactor-equipment-4", "advanced-electronics-3")
  ...
  bobmods.lib.tech.add_prerequisite("vehicle-fission-cell-equipment-4", "advanced-electronics-3")
  ...
  bobmods.lib.recipe.replace_ingredient("vehicle-solar-panel-equipment-6", "processing-unit", "advanced-processing-unit")

  bobmods.lib.recipe.replace_ingredient("vehicle-laser-defense-equipment-6", "processing-unit", "advanced-processing-unit")
...
if data.raw.item["titanium-plate"] then
  bobmods.lib.recipe.replace_ingredient("vehicle-solar-panel-equipment-4", "steel-plate", "titanium-plate")
  bobmods.lib.tech.add_prerequisite("vehicle-solar-panel-equipment-4", "titanium-processing")

  bobmods.lib.recipe.replace_ingredient("vehicle-laser-defense-equipment-4", "steel-plate", "titanium-plate")
  bobmods.lib.tech.add_prerequisite("vehicle-laser-defense-equipment-4", "titanium-processing")

  bobmods.lib.recipe.replace_ingredient("vehicle-big-turret-equipment-4", "steel-plate", "titanium-plate")
...
if data.raw.item["nitinol-alloy"] then
  bobmods.lib.recipe.replace_ingredient("vehicle-solar-panel-equipment-5", "steel-plate", "nitinol-alloy")
  bobmods.lib.tech.add_prerequisite("vehicle-solar-panel-equipment-5", "nitinol-processing")
  bobmods.lib.recipe.replace_ingredient("vehicle-solar-panel-equipment-6", "steel-plate", "nitinol-alloy")

  bobmods.lib.recipe.replace_ingredient("vehicle-laser-defense-equipment-5", "steel-plate", "nitinol-alloy")
  bobmods.lib.tech.add_prerequisite("vehicle-laser-defense-equipment-5", "nitinol-processing")
  bobmods.lib.recipe.replace_ingredient("vehicle-laser-defense-equipment-6", "steel-plate", "nitinol-alloy")

  bobmods.lib.recipe.replace_ingredient("vehicle-big-turret-equipment-5", "steel-plate", "nitinol-alloy")
  bobmods.lib.tech.add_prerequisite("vehicle-big-turret-equipment-equipment-5", "nitinol-processing")
  bobmods.lib.recipe.replace_ingredient("vehicle-big-turret-equipment-6", "steel-plate", "nitinol-alloy")
...
if data.raw.item["nitinol-bearing"] then
  bobmods.lib.recipe.add_ingredient("vehicle-engine-equipment", { type = "item", name = "nitinol-bearing", amount = 30 })
end
...
if data.raw.item["ruby-5"] then
  bobmods.lib.recipe.add_ingredient("vehicle-laser-defense-equipment-1", { type = "item", name = "ruby-5", amount = 1 })
  bobmods.lib.tech.add_prerequisite("vehicle-laser-defense-equipment-1", "gem-processing-3")
end

if data.raw.item["sapphire-5"] then
  bobmods.lib.recipe.add_ingredient("vehicle-laser-defense-equipment-2", { type = "item", name = "sapphire-5", amount = 1 })
  bobmods.lib.recipe.remove_ingredient("vehicle-laser-defense-equipment-2", "battery")
end

if data.raw.item["emerald-5"] then
  bobmods.lib.recipe.add_ingredient("vehicle-laser-defense-equipment-3", { type = "item", name = "emerald-5", amount = 1 })
  bobmods.lib.recipe.remove_ingredient("vehicle-laser-defense-equipment-3", "advanced-circuit")
end

if data.raw.item["amethyst-5"] then
  bobmods.lib.recipe.add_ingredient("vehicle-laser-defense-equipment-4", { type = "item", name = "amethyst-5", amount = 1 })
end

if data.raw.item["topaz-5"] then
  bobmods.lib.recipe.add_ingredient("vehicle-laser-defense-equipment-5", { type = "item", name = "topaz-5", amount = 1 })
end

if data.raw.item["diamond-5"] then
  bobmods.lib.recipe.add_ingredient("vehicle-laser-defense-equipment-6", { type = "item", name = "diamond-5", amount = 1 })
  bobmods.lib.tech.add_prerequisite("vehicle-solar-panel-equipment-6", "gem-processing-3")
  bobmods.lib.recipe.add_ingredient("vehicle-solar-panel-equipment-6", { type = "item", name = "diamond-5", amount = 1 })
end

if data.raw.module["efficiency-module-4"] then
  bobmods.lib.recipe.replace_ingredient("vehicle-shield-equipment-4", "efficiency-module-3", "efficiency-module-4")
end

if data.raw.module["productivity-module-4"] then
  bobmods.lib.recipe.replace_ingredient("vehicle-shield-equipment-4", "productivity-module-3", "productivity-module-4")
end

if data.raw.module["efficiency-module-5"] then
  bobmods.lib.recipe.replace_ingredient("vehicle-fission-reactor-equipment-4", "efficiency-module-3", "efficiency-module-5")
  bobmods.lib.recipe.replace_ingredient("vehicle-fission-cell-equipment-4", "efficiency-module-3", "efficiency-module-5")
end

if data.raw.module["speed-module-5"] then
  bobmods.lib.recipe.replace_ingredient("vehicle-fission-reactor-equipment-4", "speed-module-3", "speed-module-5")
  bobmods.lib.recipe.replace_ingredient("vehicle-fission-cell-equipment-4", "speed-module-3", "speed-module-5")
end

if data.raw.module["productivity-module-5"] then
  bobmods.lib.recipe.replace_ingredient("vehicle-fission-reactor-equipment-4", "productivity-module-3", "productivity-module-5")
  bobmods.lib.recipe.replace_ingredient("vehicle-fission-cell-equipment-4", "productivity-module-3", "productivity-module-5")
end

if data.raw.module["efficiency-module-6"] then
  bobmods.lib.recipe.replace_ingredient("vehicle-shield-equipment-5", "efficiency-module-3", "efficiency-module-6")
  bobmods.lib.recipe.replace_ingredient("vehicle-fission-reactor-equipment-5", "efficiency-module-3", "efficiency-module-6")
  bobmods.lib.recipe.replace_ingredient("vehicle-fission-cell-equipment-5", "efficiency-module-3", "efficiency-module-6")
end

if data.raw.module["speed-module-6"] then
  bobmods.lib.recipe.replace_ingredient("vehicle-fission-reactor-equipment-5", "speed-module-3", "speed-module-6")
  bobmods.lib.recipe.replace_ingredient("vehicle-fission-cell-equipment-5", "speed-module-3", "speed-module-6")
end

if data.raw.module["productivity-module-6"] then
  bobmods.lib.recipe.replace_ingredient("vehicle-shield-equipment-5", "productivity-module-3", "productivity-module-6")
  bobmods.lib.recipe.replace_ingredient("vehicle-fission-reactor-equipment-5", "productivity-module-3", "productivity-module-6")
  bobmods.lib.recipe.replace_ingredient("vehicle-fission-cell-equipment-5", "productivity-module-3", "productivity-module-6")
end

if data.raw.module["efficiency-module-8"] then
  bobmods.lib.recipe.replace_ingredient("vehicle-shield-equipment-6", "efficiency-module-3", "efficiency-module-8")
  bobmods.lib.recipe.replace_ingredient("vehicle-fission-reactor-equipment-6", "efficiency-module-3", "efficiency-module-8")
  bobmods.lib.recipe.replace_ingredient("vehicle-fission-cell-equipment-6", "efficiency-module-3", "efficiency-module-8")
end

if data.raw.module["speed-module-8"] then
  bobmods.lib.recipe.replace_ingredient("vehicle-fission-reactor-equipment-6", "speed-module-3", "speed-module-8")
  bobmods.lib.recipe.replace_ingredient("vehicle-fission-cell-equipment-6", "speed-module-3", "speed-module-8")
end

if data.raw.module["productivity-module-8"] then
  bobmods.lib.recipe.replace_ingredient("vehicle-shield-equipment-6", "productivity-module-3", "productivity-module-8")
  bobmods.lib.recipe.replace_ingredient("vehicle-fission-reactor-equipment-6", "productivity-module-3", "productivity-module-8")
  bobmods.lib.recipe.replace_ingredient("vehicle-fission-cell-equipment-6", "productivity-module-3", "productivity-module-8")
end

if data.raw.item["alien-artifact"] then
  bobmods.lib.recipe.add_new_ingredient("vehicle-shield-equipment-3", { type = "item", name = "alien-artifact", amount = 10 })
  bobmods.lib.recipe.add_new_ingredient("vehicle-big-turret-equipment-1", { type = "item", name = "alien-artifact", amount = 30 })
  bobmods.lib.recipe.add_new_ingredient("vehicle-big-turret-equipment-2", { type = "item", name = "alien-artifact", amount = 30 })
  bobmods.lib.recipe.add_new_ingredient("vehicle-big-turret-equipment-3", { type = "item", name = "alien-artifact", amount = 30 })
  ...
  bobmods.lib.recipe.add_ingredient("vehicle-fission-cell-equipment-2", { type = "item", name = "processing-unit", amount = 25 })
  bobmods.lib.recipe.add_ingredient("vehicle-fission-cell-equipment-3", { type = "item", name = "processing-unit", amount = 25 })

  bobmods.lib.recipe.add_ingredient("vehicle-solar-panel-equipment-5", { type = "item", name = "processing-unit", amount = 10 })
  bobmods.lib.recipe.add_ingredient("vehicle-solar-panel-equipment-6", { type = "item", name = "processing-unit", amount = 10 })
end
...
if data.raw.item["alien-artifact-orange"] and data.raw.item["alien-artifact-blue"] then
  ...
  bobmods.lib.recipe.add_new_ingredient("vehicle-shield-equipment-4", { type = "item", name = "alien-artifact-blue", amount = 5 })
  bobmods.lib.recipe.add_new_ingredient(
    "vehicle-battery-equipment-4",
...
elseif data.raw.item["alien-artifact"] then
  bobmods.lib.recipe.add_new_ingredient("vehicle-shield-equipment-4", { type = "item", name = "alien-artifact", amount = 10 })
  bobmods.lib.recipe.add_new_ingredient("vehicle-battery-equipment-4", { type = "item", name = "alien-artifact", amount = 10 })
  bobmods.lib.recipe.add_new_ingredient(
    "vehicle-fission-reactor-equipment-4",
    { type = "item", name = "alien-artifact", amount = 30 }
  )
  ...
  bobmods.lib.recipe.add_new_ingredient("vehicle-big-turret-equipment-4", { type = "item", name = "alien-artifact", amount = 30 })
else
  bobmods.lib.recipe.add_ingredient(
    "vehicle-fission-reactor-equipment-4",
    { type = "item", name = "processing-unit", amount = 50 }
  )
  bobmods.lib.recipe.add_ingredient("vehicle-fission-cell-equipment-4", { type = "item", name = "processing-unit", amount = 25 })
end
...
elseif data.raw.item["alien-artifact"] then
  bobmods.lib.recipe.add_new_ingredient("vehicle-shield-equipment-5", { type = "item", name = "alien-artifact", amount = 10 })
  bobmods.lib.recipe.add_new_ingredient("vehicle-battery-equipment-5", { type = "item", name = "alien-artifact", amount = 10 })
  bobmods.lib.recipe.add_new_ingredient(
    "vehicle-fission-reactor-equipment-5",
    { type = "item", name = "alien-artifact", amount = 30 }
  )
  ...
  bobmods.lib.recipe.add_new_ingredient("vehicle-big-turret-equipment-5", { type = "item", name = "alien-artifact", amount = 30 })
else
  bobmods.lib.recipe.add_ingredient(
    "vehicle-fission-reactor-equipment-5",
    { type = "item", name = "processing-unit", amount = 50 }
  )
  bobmods.lib.recipe.add_ingredient("vehicle-fission-cell-equipment-5", { type = "item", name = "processing-unit", amount = 25 })
end

if data.raw.item["alien-artifact-red"] and data.raw.item["alien-artifact-green"] then
  bobmods.lib.recipe.add_new_ingredient("vehicle-shield-equipment-6", { type = "item", name = "alien-artifact-red", amount = 5 })
  bobmods.lib.recipe.add_new_ingredient("vehicle-battery-equipment-6", { type = "item", name = "alien-artifact-red", amount = 5 })
  bobmods.lib.recipe.add_new_ingredient(
...
elseif data.raw.item["alien-artifact"] then
  bobmods.lib.recipe.add_new_ingredient("vehicle-shield-equipment-6", { type = "item", name = "alien-artifact", amount = 10 })
  bobmods.lib.recipe.add_new_ingredient("vehicle-battery-equipment-6", { type = "item", name = "alien-artifact", amount = 10 })
  bobmods.lib.recipe.add_new_ingredient(
    "vehicle-fission-reactor-equipment-6",
    { type = "item", name = "alien-artifact", amount = 30 }
  )
  ...
  bobmods.lib.recipe.add_new_ingredient("vehicle-big-turret-equipment-6", { type = "item", name = "alien-artifact", amount = 30 })
else
  bobmods.lib.recipe.add_ingredient(
    "vehicle-fission-reactor-equipment-6",
    { type = "item", name = "processing-unit", amount = 50 }
  )
  bobmods.lib.recipe.add_ingredient("vehicle-fission-cell-equipment-6", { type = "item", name = "processing-unit", amount = 25 })
end
