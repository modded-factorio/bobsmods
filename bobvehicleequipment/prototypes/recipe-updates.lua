if data.raw.item["roboport-antenna-1"] and data.raw.item["roboport-chargepad-1"] and data.raw.item["roboport-door-1"] then
  ...
  data.raw.recipe["vehicle-roboport-antenna-equipment"].ingredients =
    {{"roboport-antenna-1", 2}, {"roboport-door-1", 1}}
...
if data.raw.item["roboport-antenna-2"] and data.raw.item["roboport-chargepad-2"] and data.raw.item["roboport-door-2"] then
  ...
  data.raw.recipe["vehicle-roboport-chargepad-equipment-2"].ingredients =
    {{"vehicle-roboport-chargepad-equipment", 1}, {"roboport-chargepad-2", 2}}
  ...
  if data.raw.item["steel-bearing"] then
    bobmods.lib.recipe.add_ingredient("vehicle-roboport-2", {
      "steel-bearing",
      5
    })
    bobmods.lib.recipe.add_ingredient("vehicle-roboport-antenna-equipment-2", {
      "steel-bearing",
      5
    })
  end
...
if data.raw.item["roboport-antenna-3"] and data.raw.item["roboport-chargepad-3"] and data.raw.item["roboport-door-3"] then
  ...
  data.raw.recipe["vehicle-roboport-chargepad-equipment-3"].ingredients =
    {{"vehicle-roboport-chargepad-equipment-2", 1}, {"roboport-chargepad-3", 2}}
  ...
  if data.raw.item["titanium-bearing"] then
    bobmods.lib.recipe.add_ingredient("vehicle-roboport-3", {
      "titanium-bearing",
      5
    })
    bobmods.lib.recipe.add_ingredient("vehicle-roboport-antenna-equipment-3", {
      "titanium-bearing",
      5
    })
  end
...
if data.raw.item["roboport-antenna-4"] and data.raw.item["roboport-chargepad-4"] and data.raw.item["roboport-door-4"] then
  ...
  data.raw.recipe["vehicle-roboport-chargepad-equipment-4"].ingredients =
    {{"vehicle-roboport-chargepad-equipment-3", 1}, {"roboport-chargepad-4", 2}}
  ...
  if data.raw.item["nitinol-bearing"] then
    bobmods.lib.recipe.add_ingredient("vehicle-roboport-4", {
      "nitinol-bearing",
      5
    })
    bobmods.lib.recipe.add_ingredient("vehicle-roboport-antenna-equipment-4", {
      "nitinol-bearing",
      5
    })
  end
...
if data.raw.item["basic-electronic-components"] and data.raw.item["electronic-components"] and data.raw.item["intergrated-electronics"] and data.raw.item["processing-electronics"] and data.raw.item["circuit-board"] and data.raw.item["superior-circuit-board"] and data.raw.item["multi-layer-circuit-board"] then
...
if data.raw.item["solder"] then
  bobmods.lib.recipe.add_ingredient("vehicle-roboport-robot-equipment", {
    "solder",
    2
  })
  bobmods.lib.recipe.add_ingredient("vehicle-roboport-robot-equipment-2", {
    "solder",
    3
  })
  bobmods.lib.recipe.add_ingredient("vehicle-roboport-robot-equipment-3", {
    "solder",
    4
  })
  bobmods.lib.recipe.add_ingredient("vehicle-roboport-robot-equipment-4", {
    "solder",
    6
  })
end
...
if data.raw.item["silicon-wafer"] then
  bobmods.lib.recipe.add_new_ingredient("vehicle-solar-panel-4", {
    "silicon-wafer",
    10
  })
  bobmods.lib.tech.add_prerequisite(
  ...
  bobmods.lib.recipe.add_new_ingredient("vehicle-solar-panel-5", {
    "silicon-wafer",
    10
  })
  bobmods.lib.recipe.add_new_ingredient("vehicle-solar-panel-6", {
    "silicon-wafer",
    10
  })
end
...
if data.raw.item["sapphire-5"] then
  bobmods.lib.recipe.add_ingredient("vehicle-laser-defense-2", {
    "sapphire-5",
    1
  })
...
if data.raw.item["emerald-5"] then
  ...
  bobmods.lib.recipe.remove_ingredient(
    "vehicle-laser-defense-3",
    "advanced-circuit"
  )
end
...
if data.raw.item["amethyst-5"] then
  bobmods.lib.recipe.add_ingredient("vehicle-laser-defense-4", {
    "amethyst-5",
    1
  })
end
...
if data.raw.item["alien-artifact"] then
  bobmods.lib.recipe.add_new_ingredient("vehicle-shield-3", {
    "alien-artifact",
    10
  })
  bobmods.lib.recipe.add_new_ingredient("vehicle-big-turret-1", {
    "alien-artifact",
    30
  })
  bobmods.lib.recipe.add_new_ingredient("vehicle-big-turret-2", {
    "alien-artifact",
    30
  })
  bobmods.lib.recipe.add_new_ingredient("vehicle-big-turret-3", {
    "alien-artifact",
    30
  })

  bobmods.lib.recipe.add_new_ingredient("vehicle-fusion-reactor-2", {
    "alien-artifact",
    30
  })
  bobmods.lib.recipe.add_new_ingredient("vehicle-fusion-reactor-3", {
    "alien-artifact",
    30
  })

  bobmods.lib.recipe.add_new_ingredient("vehicle-fusion-cell-2", {
    "alien-artifact",
    15
  })
  bobmods.lib.recipe.add_new_ingredient("vehicle-fusion-cell-3", {
    "alien-artifact",
    15
  })
  ...
  bobmods.lib.recipe.add_ingredient("vehicle-fusion-reactor-2", {
    "processing-unit",
    50
  })
  bobmods.lib.recipe.add_ingredient("vehicle-fusion-reactor-3", {
    "processing-unit",
    50
  })

  bobmods.lib.recipe.add_ingredient("vehicle-fusion-cell-2", {
    "processing-unit",
    25
  })
  bobmods.lib.recipe.add_ingredient("vehicle-fusion-cell-3", {
    "processing-unit",
    25
  })

  bobmods.lib.recipe.add_ingredient("vehicle-solar-panel-5", {
    "processing-unit",
    10
  })
  bobmods.lib.recipe.add_ingredient("vehicle-solar-panel-6", {
    "processing-unit",
    10
  })
end
...
if data.raw.item["alien-artifact-orange"] and data.raw.item["alien-artifact-blue"] then
  bobmods.lib.recipe.add_new_ingredient("vehicle-shield-4", {
    "alien-artifact-orange",
    5
  })
  bobmods.lib.recipe.add_new_ingredient("vehicle-battery-4", {
    "alien-artifact-orange",
    5
  })
  bobmods.lib.recipe.add_new_ingredient("vehicle-fusion-reactor-4", {
    "alien-artifact-orange",
    15
  })
  bobmods.lib.recipe.add_new_ingredient("vehicle-fusion-cell-4", {
    "alien-artifact-orange",
    8
  })
  bobmods.lib.recipe.add_new_ingredient("vehicle-big-turret-4", {
    "alien-artifact-orange",
    15
  })
...
elseif data.raw.item["alien-artifact"] then
  ...
  bobmods.lib.recipe.add_ingredient("vehicle-fusion-reactor-4", {
    "processing-unit",
    50
  })
  bobmods.lib.recipe.add_ingredient("vehicle-fusion-cell-4", {
    "processing-unit",
    25
  })
end
...
if data.raw.item["alien-artifact-yellow"] and data.raw.item["alien-artifact-purple"] then
  bobmods.lib.recipe.add_new_ingredient("vehicle-shield-5", {
    "alien-artifact-yellow",
    5
  })
  bobmods.lib.recipe.add_new_ingredient("vehicle-battery-5", {
    "alien-artifact-yellow",
    5
  })
  bobmods.lib.recipe.add_new_ingredient("vehicle-fusion-reactor-5", {
    "alien-artifact-yellow",
    15
  })
  bobmods.lib.recipe.add_new_ingredient("vehicle-fusion-cell-5", {
    "alien-artifact-yellow",
    8
  })
  bobmods.lib.recipe.add_new_ingredient("vehicle-big-turret-5", {
    "alien-artifact-yellow",
    15
  })
...
elseif data.raw.item["alien-artifact"] then
  ...
  bobmods.lib.recipe.add_ingredient("vehicle-fusion-reactor-5", {
    "processing-unit",
    50
  })
  bobmods.lib.recipe.add_ingredient("vehicle-fusion-cell-5", {
    "processing-unit",
    25
  })
end
...
if data.raw.item["alien-artifact-red"] and data.raw.item["alien-artifact-green"] then
  bobmods.lib.recipe.add_new_ingredient("vehicle-shield-6", {
    "alien-artifact-red",
    5
  })
  bobmods.lib.recipe.add_new_ingredient("vehicle-battery-6", {
    "alien-artifact-red",
    5
  })
  bobmods.lib.recipe.add_new_ingredient("vehicle-fusion-reactor-6", {
    "alien-artifact-red",
    15
  })
  bobmods.lib.recipe.add_new_ingredient("vehicle-fusion-cell-6", {
    "alien-artifact-red",
    8
  })
  bobmods.lib.recipe.add_new_ingredient("vehicle-big-turret-6", {
    "alien-artifact-red",
    15
  })
...
elseif data.raw.item["alien-artifact"] then
  ...
  bobmods.lib.recipe.add_ingredient("vehicle-fusion-reactor-6", {
    "processing-unit",
    50
  })
  bobmods.lib.recipe.add_ingredient("vehicle-fusion-cell-6", {
    "processing-unit",
    25
  })
end