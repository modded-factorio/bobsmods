...
data:extend({{
  ...
  order = "v-g-m-b",
  prerequisites = {"vehicle-laser-defense-equipment-1", "advanced-electronics"},
  unit = {
    count = 150,
    time = 30,
    ingredients = {
...
data:extend({{
  ...
  order = "v-g-m-e",
  prerequisites = {"vehicle-laser-defense-equipment-4", "military-4"},
  unit = {
    count = 300,
    time = 30,
    ingredients = {
...
data:extend({{
  ...
  order = "v-g-m-f",
  prerequisites = {"vehicle-laser-defense-equipment-5"},
  unit = {
    count = 350,
    time = 30,
    ingredients = {
