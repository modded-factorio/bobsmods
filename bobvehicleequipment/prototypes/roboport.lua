data:extend({{
  ...
  order = "v-c-k-zx-1",
  prerequisites = {"construction-robotics", "vehicle-solar-panel-equipment-1"},
  unit = {
    count = 50,
    ingredients = {
  ...
  order = "v-c-k-zx-2",
  prerequisites = {"vehicle-roboport-equipment", "chemical-science-pack"},
  unit = {
    count = 100,
    ingredients = {
      {"automation-science-pack", 1},
  ...
  prerequisites = {"vehicle-roboport-equipment-3", "production-science-pack"},
  unit = {
    count = 200,
    ingredients = {
      {"automation-science-pack", 1},
...
data:extend({{
  ...
  prerequisites = {"vehicle-roboport-equipment"},
  unit = {
    count = 50,
    ingredients = {
      {"automation-science-pack", 1},
