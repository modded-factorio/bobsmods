data:extend({{ --"20MJ",
  ...
  order = "v-g-i-a",
  prerequisites = {"vehicle-solar-panel-equipment-1", "battery"},
  unit = {
    count = 50,
    time = 15,
...
data:extend({{
  ...
  enabled = false,
  energy_required = 10,
  ingredients = {{"vehicle-battery-1", 2}, {"processing-unit", 5}},
  ...
  order = "v-g-i-b",
  prerequisites = {"vehicle-battery-equipment-1", "advanced-electronics-2"},
  unit = {
    count = 100,
    time = 30,
    ingredients = {
...
data:extend({{
  ...
  enabled = false,
  energy_required = 10,
  ingredients = {{"vehicle-battery-2", 2}, {"battery", 5}},
  ...
  order = "v-g-i-c",
  prerequisites = {"vehicle-battery-equipment-2"},
  unit = {
    count = 150,
    time = 30,
    ingredients = {
...
data:extend({{
  ...
  enabled = false,
  energy_required = 10,
  ingredients = {{"vehicle-battery-3", 2}, {"processing-unit", 5}},
  ...
  order = "v-g-i-d",
  prerequisites = {"vehicle-battery-equipment-3", "production-science-pack"},
  unit = {
    count = 200,
    time = 45,
    ingredients = {
...
data:extend({{
  ...
  enabled = false,
  energy_required = 10,
  ingredients = {{"vehicle-battery-4", 2}, {"battery", 5}},
  ...
  order = "v-g-i-e",
  prerequisites = {"vehicle-battery-equipment-4"},
  unit = {
    count = 250,
    time = 45,
    ingredients = {
...
data:extend({{
  ...
  enabled = false,
  energy_required = 10,
  ingredients = {{"vehicle-battery-5", 2}, {"processing-unit", 5}},
  ...
  order = "v-g-i-f",
  prerequisites = {"vehicle-battery-equipment-5", "utility-science-pack"},
  unit = {
    count = 300,
    time = 45,
    ingredients = {
