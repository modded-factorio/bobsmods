data:extend({{
  ...
  enabled = false,
  energy_required = 10,
  ingredients = {{"processing-unit", 125}},
  ...
  order = "v-g-l-a",
  prerequisites = {"vehicle-solar-panel-equipment-1", "advanced-electronics-2"},
  unit = {
    count = 100,
    time = 30,
    ingredients = {
...
data:extend({{
  ...
  order = "v-g-l-c",
  prerequisites = {"vehicle-fusion-cell-equipment-2", "utility-science-pack"},
  unit = {
    count = 150,
    time = 45,
    ingredients = {
...
data:extend({{
  ...
  order = "v-g-l-d",
  prerequisites = {"vehicle-fusion-cell-equipment-3"},
  unit = {
    count = 200,
    time = 45,
    ingredients = {
...
data:extend({{
  ...
  order = "v-g-l-e",
  prerequisites = {"vehicle-fusion-cell-equipment-4"},
  unit = {
    count = 250,
    time = 45,
    ingredients = {
...
data:extend({{
  ...
  order = "v-g-l-f",
  prerequisites = {"vehicle-fusion-cell-equipment-5"},
  unit = {
    count = 300,
    time = 45,
    ingredients = {
