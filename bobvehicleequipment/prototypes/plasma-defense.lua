...
data:extend({{
  ...
  order = "v-g-m-b",
  prerequisites = {"vehicle-big-turret-equipment-1"},
  unit = {
    count = 150,
    time = 30,
    ingredients = {
...
data:extend({{
  ...
  order = "v-g-m-c",
  prerequisites = {"vehicle-big-turret-equipment-2", "military-4"},
  unit = {
    count = 250,
    time = 30,
    ingredients = {
...
data:extend({{
  ...
  order = "v-g-m-d",
  prerequisites = {"vehicle-big-turret-equipment-3"},
  unit = {
    count = 300,
    time = 30,
    ingredients = {
...
data:extend({{
  ...
  order = "v-g-m-e",
  prerequisites = {"vehicle-big-turret-equipment-4"},
  unit = {
    count = 350,
    time = 30,
    ingredients = {
...
data:extend({{
  ...
  order = "v-g-m-f",
  prerequisites = {"vehicle-big-turret-equipment-5"},
  unit = {
    count = 400,
    time = 30,
    ingredients = {
