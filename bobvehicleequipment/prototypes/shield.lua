...
data:extend({{
  ...
  enabled = false,
  energy_required = 10,
  ingredients = {{"vehicle-shield-1", 2}, {"processing-unit", 5}},
...
data:extend({{
  ...
  order = "v-g-e-d",
  prerequisites = {"vehicle-energy-shield-equipment-3"},
  unit = {
    count = 300,
    time = 45,
    ingredients = {
...
data:extend({{
  ...
  order = "v-g-e-e",
  prerequisites = {"vehicle-energy-shield-equipment-4", "utility-science-pack"},
  unit = {
    count = 350,
    time = 45,
    ingredients = {
...
data:extend({{
  ...
  order = "v-g-e-f",
  prerequisites = {"vehicle-energy-shield-equipment-5"},
  unit = {
    count = 400,
    time = 45,
    ingredients = {
