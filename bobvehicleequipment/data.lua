...
function bobmods.equipment.technology_icon_constant_vehicle_equipment(
technology_icon
)
  local scale =
    ((technology_icon.icon_size or 256) / 256) * (technology_icon.scale or 1)
  local icons = {technology_icon, {
