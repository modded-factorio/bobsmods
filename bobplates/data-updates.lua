...
if feature_flags["quality"] then
  if settings.startup["bobmods-colorupdate"].value == true then
    bobmods.lib.recipe.update_recycling_recipe_icon("battery-recycling", "__bobplates__/graphics/icons/battery-red.png", 64)
    bobmods.lib.recipe.update_recycling_recipe_icon("bob-lithium-ion-battery-recycling", "__bobplates__/graphics/icons/battery-blue.png", 64)
    bobmods.lib.recipe.update_recycling_recipe_icon("bob-silver-zinc-battery-recycling", "__bobplates__/graphics/icons/battery-purple.png", 64)
  else
