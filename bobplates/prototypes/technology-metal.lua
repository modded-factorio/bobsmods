if not data.raw.technology["nickel-processing"] then
  data:extend({{
    ...
    prerequisites = {"electrolysis-1"},
    effects = {}
  }})
end

data.raw.technology["nickel-processing"].icon =
  "__bobplates__/graphics/icons/technology/nickel-processing.png"
...
if not data.raw.technology["zinc-processing"] then
  data:extend({{
    ...
    prerequisites = {"electrolysis-1", "sulfur-processing"},
    effects = {}
  }})
end

data.raw.technology["zinc-processing"].icon =
  "__bobplates__/graphics/icons/technology/zinc-processing.png"
...
if not data.raw.technology["lead-processing"] then
  data:extend({{
    ...
    prerequisites = {"electrolysis-1", "chemical-processing-2"},
    effects = {}
  }})
end

data.raw.technology["lead-processing"].icon =
  "__bobplates__/graphics/icons/technology/lead-processing.png"
...
if not data.raw.technology["aluminium-processing"] then
  data:extend({{
    ...
    prerequisites = {"electrolysis-2"},
    effects = {}
  }})
end

data.raw.technology["aluminium-processing"].icon =
...
data.raw.technology["gold-processing"].icon =
  "__bobplates__/graphics/icons/technology/gold-processing.png"
...
if not data.raw.technology["silicon-processing"] then
  data:extend({{
    ...
    prerequisites = {"chemical-processing-2"},
    effects = {}
  }})
end

data.raw.technology["silicon-processing"].icon =
  "__bobplates__/graphics/icons/plate/silicon-plate.png"
...
if not data.raw.technology["titanium-processing"] then
  data:extend({{
    ...
    prerequisites = {"chemical-processing-2", "chemical-science-pack"},
    effects = {}
  }})
end

data.raw.technology["titanium-processing"].icon =
  "__bobplates__/graphics/icons/technology/titanium-processing.png"
...
data.raw.technology["tungsten-processing"].icon =
  "__bobplates__/graphics/icons/technology/tungsten-processing.png"
...
data.raw.technology["invar-processing"].icon =
  "__bobplates__/graphics/icons/technology/invar-processing.png"
...
data.raw.technology["nitinol-processing"].icon =
  "__bobplates__/graphics/icons/plate/nitinol-plate.png"
...
data.raw.technology["tungsten-alloy-processing"].icon =
...
data.raw.technology["cobalt-processing"].icon =
  "__bobplates__/graphics/icons/technology/cobalt-processing.png"
...
data.raw.technology["lithium-processing"].icon =
  "__bobplates__/graphics/icons/technology/lithium-processing.png"
