...
data:extend({
...

  {
    ...
    icon_size = 32,
    subgroup = "bob-gears",
    order = "be[bob-titanium-gear-wheel]",
    stack_size = 100,
    drop_sound = plate_drop_move,
    inventory_move_sound = plate_drop_move,
    pick_sound = plate_pick,
...

  {
    ...
    icon_size = 32,
    subgroup = "bob-bearings",
    order = "bae[bob-ball-bearing-titanium]",
    stack_size = 500,
    drop_sound = ball_drop_move,
    inventory_move_sound = ball_drop_move,
    pick_sound = ball_pick,
...

  {
    ...
    icon_size = 32,
    subgroup = "bob-bearings",
    order = "bbe[bob-bearing-titanium]",
    stack_size = 100,
    drop_sound = bearing_drop_move,
    inventory_move_sound = bearing_drop_move,
    pick_sound = bearing_pick,
...

  {
    ...
    icon_size = 32,
    subgroup = "bob-gears",
    order = "bf[bob-tungsten-gear-wheel]",
    stack_size = 100,
    drop_sound = plate_drop_move,
    inventory_move_sound = plate_drop_move,
    pick_sound = plate_pick,
...

  {
    ...
    icon_size = 32,
    subgroup = "bob-bearings",
    order = "baf[bob-ball-bearing-ceramic]",
    stack_size = 500,
    drop_sound = ball_drop_move,
    inventory_move_sound = ball_drop_move,
    pick_sound = ball_pick,
...

  {
    ...
    icon_size = 32,
    subgroup = "bob-gears",
    order = "bg[bob-nitinol-gear-wheel]",
    stack_size = 100,
    drop_sound = plate_drop_move,
    inventory_move_sound = plate_drop_move,
    pick_sound = plate_pick,
...

  {
    ...
    icon_size = 32,
    subgroup = "bob-bearings",
    order = "bag[bob-ball-bearing-nitinol]",
    stack_size = 500,
    drop_sound = ball_drop_move,
    inventory_move_sound = ball_drop_move,
    pick_sound = ball_pick,
  ...
  data:extend({
    {
      ...
      icon_size = 32,
      subgroup = "bob-gears",
      order = "bd[bob-stainless-steel-gear-wheel]",
      stack_size = 100,
      drop_sound = plate_drop_move,
      inventory_move_sound = plate_drop_move,
      pick_sound = plate_pick,
...

    {
      ...
      icon_size = 32,
      subgroup = "bob-bearings",
      order = "bad[bob-ball-bearing-stainless-steel]",
      stack_size = 500,
      drop_sound = ball_drop_move,
      inventory_move_sound = ball_drop_move,
      pick_sound = ball_pick,
...

    {
      ...
      icon_size = 32,
      subgroup = "bob-bearings",
      order = "bbd[bob-bearing-stainless-steel]",
      stack_size = 100,
      drop_sound = bearing_drop_move,
      inventory_move_sound = bearing_drop_move,
      pick_sound = bearing_pick,
