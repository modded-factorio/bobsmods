...
--        {"chemical-science-pack", 1}, --removed for balance, to allow lowest tier laser weapons to not be locked behind chemical science.
  ...
  icon = "__bobplates__/graphics/icons/technology/chemical-processing.png",
  icon_size = 128,
  prerequisites = {"electrolysis-2", "chemical-processing-1"},
  effects = {{
    type = "unlock-recipe",
  ...
  prerequisites = {"chemical-processing-1", "advanced-material-processing"},
  effects = {{
    type = "unlock-recipe",
  ...
  prerequisites = {"chemical-processing-1", "advanced-material-processing-2"},
  effects = {{
    type = "unlock-recipe",
  ...
  prerequisites = {"alloy-processing", "advanced-material-processing"},
  effects = {{
    type = "unlock-recipe",
  ...
  prerequisites = {"alloy-processing", "advanced-material-processing-2"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_size = 128,
  prerequisites = {"chemical-processing-2", "air-compressor-1"},
  effects = {{
    type = "unlock-recipe",
    recipe = "nitrogen"
  }, {
  ...
  icon_size = 64,
  prerequisites = {"water-bore-1", "logistic-science-pack", "steel-processing"},
  effects = {{
    type = "unlock-recipe",
    recipe = "empty-barrel"
  }},
  ...
  icon_size = 720,
  prerequisites = {"water-bore-1", "plastics"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_size = 64,
  prerequisites = {"chemical-processing-1", "silicon-processing"},
  unit = {
    count = 50,
    ingredients = {
      {"automation-science-pack", 1},
  ...
  icon_size = 64,
  prerequisites = {"grinding", "automation-2"},
  unit = {
    count = 75,
    ingredients = {
      {"automation-science-pack", 1},
  ...
  icon = "__bobplates__/graphics/icons/technology/gems.png",
  icon_size = 64,
  prerequisites = {"gem-processing-1", "polishing"},
  unit = {
    count = 100,
    ingredients = {
      {"automation-science-pack", 1},
  ...
  icon_size = 128,
  prerequisites = {"air-compressor-1"},
  unit = {
    count = 30,
    ingredients = {{"automation-science-pack", 1}},
    time = 10
