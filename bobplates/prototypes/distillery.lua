...
if settings.startup["bobmods-plates-purewater"].value == true then
  ...
  if feature_flags["freezing"] then
    ...
    if mods["space-age"] then
      ...
      data.raw.furnace["bob-distillery"].fluid_boxes[1].pipe_covers_frozen = frozenpatchcovers()
      data.raw.furnace["bob-distillery"].fluid_boxes[2].pipe_covers_frozen = frozenpatchcovers()
    end
  end
end
