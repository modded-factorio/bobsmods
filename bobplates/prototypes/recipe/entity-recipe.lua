data:extend({{
  ...
  energy_required = 3,
  enabled = false,
  ingredients = {{"steel-plate", 6}, {"stone-brick", 10}, {"pipe", 5}},
  ...
  energy_required = 2,
  enabled = false,
  ingredients = {{"iron-plate", 3}, {"pipe", 1}},
  ...
  energy_required = 2,
  enabled = false,
  ingredients = {{"iron-plate", 3}, {"pipe", 2}},
...
if settings.startup["bobmods-plates-convert-recipes"].value == true then
  data:extend({{
    ...
    enabled = false,
    subgroup = "bob-smelting-machine-convert",
    ingredients = {{"stone-furnace", 1}, {"pipe", 2}},
    allow_as_intermediate = false,
    result = "stone-chemical-furnace"
  }, {
    type = "recipe",
    ...
    enabled = false,
    subgroup = "bob-smelting-machine-convert",
    ingredients = {{"steel-furnace", 1}, {"pipe", 5}},
    allow_as_intermediate = false,
    result = "steel-chemical-furnace"
  }, {
    type = "recipe",
    ...
    enabled = false,
    subgroup = "bob-smelting-machine-convert",
    ingredients = {{"electric-furnace", 1}, {"pipe", 5}},
    allow_as_intermediate = false,
    result = "electric-chemical-furnace"
  }, {
    type = "recipe",
    ...
    ingredients = {{"stone-mixing-furnace", 1}},
    allow_as_intermediate = false,
    ...
    enabled = false,
    subgroup = "bob-base-smelting-machine-convert",
    ingredients = {{"stone-chemical-furnace", 1}},
    allow_as_intermediate = false,
    results = {{"stone-furnace", 1}, {"pipe", 2}},
    ...
    enabled = false,
    subgroup = "bob-base-smelting-machine-convert",
    ingredients = {{"steel-mixing-furnace", 1}},
    allow_as_intermediate = false,
    ...
    enabled = false,
    subgroup = "bob-base-smelting-machine-convert",
    ingredients = {{"steel-chemical-furnace", 1}},
    allow_as_intermediate = false,
    results = {{"steel-furnace", 1}, {"pipe", 5}},
    ...
    enabled = false,
    subgroup = "bob-base-smelting-machine-convert",
    ingredients = {{"electric-mixing-furnace", 1}},
    allow_as_intermediate = false,
    ...
    enabled = false,
    subgroup = "bob-base-smelting-machine-convert",
    ingredients = {{"electric-chemical-furnace", 1}},
    allow_as_intermediate = false,
    results = {{"electric-furnace", 1}, {"pipe", 5}},
