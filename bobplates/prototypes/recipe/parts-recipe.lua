data:extend({{
  ...
  normal = {
    enabled = false,
    ingredients = {{"steel-plate", 1}, {"steel-bearing-ball", 16}},
    result = "steel-bearing",
    result_count = 2
  },
  expensive = {
    enabled = false,
    ingredients = {{"steel-plate", 1}, {"steel-bearing-ball", 8}},
    result = "steel-bearing"
  }
}, {
  type = "recipe",
  ...
  normal = {
    enabled = false,
    ingredients = {{"cobalt-steel-alloy", 1}},
  ...
  expensive = {
    enabled = false,
    ingredients = {{"cobalt-steel-alloy", 1}, {"cobalt-steel-bearing-ball", 8}},
    result = "cobalt-steel-bearing"
  }
}, {
  type = "recipe",
  ...
  normal = {
    enabled = false,
    ingredients = {{"titanium-plate", 1}, {"titanium-bearing-ball", 16}, {
      type = "fluid",
      name = "lubricant",
      amount = 10
    }},
  ...
  expensive = {
    enabled = false,
    ingredients = {{"titanium-plate", 1}, {"titanium-bearing-ball", 8}, {
      type = "fluid",
      name = "lubricant",
      amount = 10
    }},
  ...
  normal = {
    enabled = false,
    ingredients = {{"nitinol-alloy", 1}, {"nitinol-bearing-ball", 16}, {
      type = "fluid",
      name = "lubricant",
      amount = 10
    }},
  ...
  expensive = {
    enabled = false,
    ingredients = {{"nitinol-alloy", 1}, {"nitinol-bearing-ball", 8}, {
      type = "fluid",
      name = "lubricant",
      amount = 10
    }},
  ...
  normal = {
    enabled = false,
    ingredients = {{"silicon-nitride", 1}, {"ceramic-bearing-ball", 16}, {
      type = "fluid",
      name = "lubricant",
      amount = 10
    }},
  ...
  expensive = {
    enabled = false,
    ingredients = {{"silicon-nitride", 1}, {"ceramic-bearing-ball", 8}, {
      type = "fluid",
      name = "lubricant",
      amount = 10
    }},
  ...
  energy_required = 2,
  enabled = false,
  ingredients = {{"steel-plate", 1}, {"silicon-carbide", 5}},
  ...
  energy_required = 2,
  enabled = false,
  ingredients = {{"steel-plate", 1}, {"wood", 5}},
