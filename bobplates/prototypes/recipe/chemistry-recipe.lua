...
data:extend({{ -- #dfbb0000 -- #1aef0000 -- #8fca0000 -- Causes it to use the recipe name. -- Causes it to use the recipe name. -- #ffa70000 -- #cfff0000 -- #f4cd0000
  type = "recipe",
  name = "bob-liquid-air",
  ...
  enabled = false,
  energy_required = 5,
  ingredients = {{"silver-nitrate", 1}, {"sodium-hydroxide", 1}},
  result = "silver-oxide",
  {
    primary = {
      r = 0.3,
