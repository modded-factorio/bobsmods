...
data:extend({{
  ...
  ingredients = {{"plutonium-239", 40}, {"uranium-238", 5}},
  results = {{"plutonium-239", 41}, {"uranium-238", 2}},
...
if data.raw.item["thorium-ore"] then
  data:extend({{
    ...
    energy_required = 10,
    enabled = false,
    ingredients = {{"lead-plate", 10}, {"uranium-235", 1}, {"thorium-232", 19}},
  ...
  if settings.startup["bobmods-plates-nuclearupdate"].value == true then
    ...
    data:extend({{
      ...
      enabled = false,
      category = "centrifuging",
      ingredients = {{"used-up-thorium-fuel-cell", 10}},
      results = {{
        type = "item",
        name = "thorium-232",
        amount = 4,
...
if settings.startup["bobmods-plates-nuclearupdate"].value == true then
  data:extend({{
    ...
    enabled = false,
    category = "centrifuging",
    ingredients = {{"uranium-235", 5}, {"uranium-238", 15}},
    results = {{"uranium-235", 3}, {"uranium-238", 10}, {"plutonium-239", 1}},
    crafting_machine_tint = {
      primary = {
        r = 1,
        g = 0.7,
  ...
  data:extend({{ --Lithium
    ...
    energy_required = 10,
    enabled = false,
    ingredients = {{"empty-nuclear-fuel-cell", 10}, {
      type = "item",
      name = "fusion-catalyst",
      amount = 1
    }, {
    ...
    enabled = false,
    category = "centrifuging",
    ingredients = {{"used-up-deuterium-fuel-cell", 10}},
    results = {{
      type = "item",
      name = "empty-nuclear-fuel-cell",
      amount = 10,
  ...
  data:extend({{
    ...
    enabled = false,
    category = "centrifuging",
    ingredients = {{"used-up-deuterium-fuel-cell", 5}},
    results = {{
      type = "item",
      name = "lead-plate",
      amount = 5,
...
if settings.startup["bobmods-plates-bluedeuterium"].value == true then
  data.raw.recipe["deuterium-fuel-reprocessing"].crafting_machine_tint.primary
  = {
    r = 0,
    g = 0.7,
    b = 1
  }
  data.raw.recipe["deuterium-fuel-reprocessing"].crafting_machine_tint.tertiary
  = {
    r = 0,
    g = 0.7,
    b = 1
