...
if settings.startup["bobmods-plates-nuclearupdate"].value == true then
  ...
  data.raw.technology["bobingabout-enrichment-process"].localised_name =
    {"technology-name.plutonium-synthesis"}
  data.raw.technology["bobingabout-enrichment-process"].icon =
    "__bobplates__/graphics/icons/nuclear/plutonium-239.png"
...
if data.raw.item["thorium-ore"] then
  data:extend({{
    ...
    prerequisites = {"thorium-processing", "production-science-pack"},
    unit = {
      ingredients = {
        {"automation-science-pack", 1},
        {"logistic-science-pack", 1},
...
if settings.startup["bobmods-plates-nuclearupdate"].value == true then
  data:extend({{
    ...
    prerequisites = {"deuterium-processing", "utility-science-pack"},
    unit = {
      ingredients = {
        {"automation-science-pack", 1},
        {"logistic-science-pack", 1},
