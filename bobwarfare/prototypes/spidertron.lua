if settings.startup["bobmods-warfare-spidertron-overhaul"].value == true then
  ...
  data:extend({{
    ...
    enabled = false,
    energy_required = 1,
    ingredients = {{"pipe", 3}, {"steel-plate", 2}},
    result = "mech-leg-segment"
  }, {
    type = "recipe",
    name = "mech-foot",
    enabled = false,
    ...
    enabled = false,
    energy_required = 5,
    ingredients = {{"low-density-structure", 50}, {"mech-brain", 1}},
    result = "mech-frame"
  }, {
    type = "recipe",
    name = "mech-armor-plate",
    enabled = false,
    energy_required = 1,
    ingredients = {{"low-density-structure", 5}, {"steel-plate", 2}},
    result = "mech-armor-plate"
  }})
end

local spidertron_animations =
  require("__base__.prototypes.entity.spidertron-animations")
local sounds = require("__base__.prototypes.entity.sounds")

data.raw["spider-vehicle"]["spidertron"].order =
  "b[personal-transport]-c[spidertron]-c[spidertron]"
...
function bobmods.warfare.create_spidertron(arguments)
  ...
  data:extend({{
    ...
    1
  ), make_spidertron_leg(arguments.name, leg_scale, arguments.leg_thickness, arguments.leg_movement_speed, 2), make_spidertron_leg(arguments.name, leg_scale, arguments.leg_thickness, arguments.leg_movement_speed, 3), make_spidertron_leg(arguments.name, leg_scale, arguments.leg_thickness, arguments.leg_movement_speed, 4), make_spidertron_leg(arguments.name, leg_scale, arguments.leg_thickness, arguments.leg_movement_speed, 5), make_spidertron_leg(arguments.name, leg_scale, arguments.leg_thickness, arguments.leg_movement_speed, 6), make_spidertron_leg(arguments.name, leg_scale, arguments.leg_thickness, arguments.leg_movement_speed, 7), make_spidertron_leg(arguments.name, leg_scale, arguments.leg_thickness, arguments.leg_movement_speed, 8), {
    type = "equipment-grid",
...
data:extend({{
  ...
  enabled = false,
  energy_required = 10,
  ingredients = {{"steel-plate", 15}, {"iron-gear-wheel", 5}},
  result = "spidertron-cannon"
}, {
  type = "recipe",
  name = "antron",
  enabled = false,
  energy_required = 8,
  ingredients = {{"gun-turret", 2}},
  result = "antron"
}, {
  type = "recipe",
  name = "tankotron",
  enabled = false,
  energy_required = 10,
  ingredients = {{"spidertron-cannon", 2}},
  result = "tankotron"
}, {
  type = "recipe",
  ...
  enabled = false,
  energy_required = 10,
  ingredients = {{"gun-turret", 2}, {"steel-chest", 1}},
  result = "logistic-spidertron"
}, {
  type = "recipe",
  name = "heavy-spidertron",
  enabled = false,
  energy_required = 12,
  ingredients = {{"rocket-launcher", 8}},
  result = "heavy-spidertron"
}})
...
bobmods.warfare.create_spidertron{
  ...
  order_letter = "a",
  guns = {"spidertron-gatling-gun", "spidertron-gatling-gun"},
  legs = 6,
  inventory_size = 80,
  equipment_grid = {
    width = 10,
...
bobmods.warfare.create_spidertron{
  ...
  order_letter = "b",
  guns = {"spidertron-cannon-1", "spidertron-cannon-2"},
  legs = 6,
  inventory_size = 80,
  equipment_grid = {
    width = 8,
...
data:extend({{
  ...
  prerequisites = {"walking-vehicle", "tank"},
  unit = {
    ingredients = {
      {"automation-science-pack", 1},
      {"logistic-science-pack", 1},
  ...
  prerequisites = {"logistics-3", "walking-vehicle", "utility-science-pack"},
  unit = {
    ingredients = {
      {"automation-science-pack", 1},
      {"logistic-science-pack", 1},
