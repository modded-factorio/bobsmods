...
data.raw["character-corpse"]["character-corpse"].armor_picture_mapping["heavy-armor-2"]
= 2
data.raw["character-corpse"]["character-corpse"].armor_picture_mapping["heavy-armor-3"]
= 2
data.raw["character-corpse"]["character-corpse"].armor_picture_mapping["bob-power-armor-mk3"]
= 3
data.raw["character-corpse"]["character-corpse"].armor_picture_mapping["bob-power-armor-mk4"]
= 3
data.raw["character-corpse"]["character-corpse"].armor_picture_mapping["bob-power-armor-mk5"]
= 3