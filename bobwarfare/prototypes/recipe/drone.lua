...
data:extend({{
  ...
  enabled = false,
  ingredients = {{"robot-drone-frame", 1}, {"gun-turret", 1}},
...
data:extend({{
  ...
  enabled = false,
  ingredients = {{"robot-drone-frame", 1}, {"laser-turret", 1}},
...
data:extend({{
  ...
  enabled = false,
  ingredients = {{"robot-drone-frame", 1}, {"flamethrower-turret", 1}},
...
data:extend({{
  ...
  enabled = false,
  ingredients = {{"robot-drone-frame-large", 1}, {"bob-plasma-turret-1", 1}},
