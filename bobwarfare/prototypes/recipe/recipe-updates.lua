...
if data.raw.item["cobalt-steel-bearing"] then
  bobmods.lib.recipe.add_ingredient("bob-sniper-turret-2", {
...
if data.raw.item["titanium-bearing"] then
  ...
  bobmods.lib.recipe.add_ingredient("bob-gun-turret-4", {
    "titanium-bearing",
    10
  })
...
if data.raw.item["nitinol-bearing"] then
  ...
  bobmods.lib.recipe.add_ingredient("bob-sniper-turret-3", {
    "nitinol-bearing",
    20
  })
...
if data.raw.item["sapphire-5"] then
  bobmods.lib.recipe.add_ingredient("laser-rifle-battery-sapphire", {
    "sapphire-5",
    1
  })
  bobmods.lib.recipe.replace_ingredient(
...
if data.raw.item["emerald-5"] then
  bobmods.lib.recipe.add_ingredient("laser-rifle-battery-emerald", {
    "emerald-5",
    1
  })
  bobmods.lib.recipe.replace_ingredient(
...
if data.raw.item["amethyst-5"] then
  bobmods.lib.recipe.add_ingredient("laser-rifle-battery-amethyst", {
    "amethyst-5",
    1
  })
  bobmods.lib.recipe.replace_ingredient(
...
if data.raw.item["diamond-5"] then
  bobmods.lib.recipe.add_ingredient("laser-rifle-battery-diamond", {
    "diamond-5",
    1
  })
  bobmods.lib.recipe.replace_ingredient(
...
if data.raw.item["alien-artifact"] then
  bobmods.lib.recipe.add_new_ingredient("bob-plasma-turret-1", {
    "alien-artifact",
    20
  })
  bobmods.lib.recipe.add_new_ingredient("bob-plasma-turret-2", {
    "alien-artifact",
    30
  })
end
...
if data.raw.item["alien-artifact-orange"] and data.raw.item["alien-artifact-blue"] then
  bobmods.lib.recipe.add_new_ingredient("bob-power-armor-mk3", {
  ...
  bobmods.lib.recipe.add_new_ingredient("bob-plasma-turret-3", {
    "alien-artifact-orange",
    10
  })
  bobmods.lib.recipe.add_new_ingredient("bob-plasma-turret-3", {
...
elseif data.raw.item["alien-artifact"] then
  ...
  bobmods.lib.recipe.add_ingredient("bob-power-armor-mk3", {
    "processing-unit",
    70
  })
end
...
if data.raw.item["alien-artifact-yellow"] and data.raw.item["alien-artifact-purple"] then
  bobmods.lib.recipe.add_new_ingredient("bob-power-armor-mk4", {
  ...
  bobmods.lib.recipe.add_new_ingredient("bob-plasma-turret-4", {
    "alien-artifact-yellow",
    10
  })
  bobmods.lib.recipe.add_new_ingredient("bob-plasma-turret-4", {
...
elseif data.raw.item["alien-artifact"] then
  ...
  bobmods.lib.recipe.add_ingredient("bob-power-armor-mk4", {
    "processing-unit",
    90
  })
end
...
if data.raw.item["alien-artifact-red"] and data.raw.item["alien-artifact-green"] then
  bobmods.lib.recipe.add_new_ingredient("bob-power-armor-mk5", {
    "alien-artifact-red",
    25
  })
  bobmods.lib.recipe.add_new_ingredient("bob-power-armor-mk5", {
  ...
  bobmods.lib.recipe.add_new_ingredient("bob-plasma-turret-5", {
    "alien-artifact-red",
    10
  })
  bobmods.lib.recipe.add_new_ingredient("bob-plasma-turret-5", {
...
elseif data.raw.item["alien-artifact"] then
  ...
  bobmods.lib.recipe.add_ingredient("bob-power-armor-mk5", {
    "processing-unit",
    120
  })
end
...
if data.raw.fluid["alien-explosive"] then
  ...
  bobmods.lib.recipe.add_new_ingredient("explosive-artillery-shell", {
    "explosives",
    3
  })
...
if data.raw.fluid["alien-fire"] then
  ...
  bobmods.lib.recipe.add_new_ingredient("flame-bullet-projectile", {
    "alien-fire",
    10
  })
  ...
  bobmods.lib.recipe.add_new_ingredient("shotgun-flame-shell", {
    "alien-fire",
    10
  })
  ...
  bobmods.lib.recipe.add_new_ingredient("flame-rocket-warhead", {
    "alien-fire",
    20
  })
...
if data.raw.item["distractor-robot"] then
  ...
  bobmods.lib.recipe.add_ingredient("distractor-artillery-shell", {
    "distractor-robot",
    15
  })
end

if data.raw.item["alien-artifact-orange"] and data.raw.item["alien-artifact-blue"] and data.raw.item["alien-artifact-yellow"] and data.raw.item["alien-artifact-purple"] and data.raw.item["alien-artifact-red"] and data.raw.item["alien-artifact-green"] then
  bobmods.lib.recipe.add_new_ingredient("plasma-bullet-projectile", {
    "alien-artifact-orange",
    1
  })
  bobmods.lib.recipe.add_new_ingredient("plasma-bullet-projectile", {
  ...
  bobmods.lib.recipe.add_new_ingredient("shotgun-plasma-shell", {
    "alien-artifact-orange",
    1
  })
  bobmods.lib.recipe.add_new_ingredient("shotgun-plasma-shell", {
  ...
  bobmods.lib.recipe.add_new_ingredient("plasma-rocket-warhead", {
    "alien-artifact-orange",
    1
  })
  bobmods.lib.recipe.add_new_ingredient("plasma-rocket-warhead", {
...
bobmods.lib.recipe.set_ingredient("artillery-shell", {
