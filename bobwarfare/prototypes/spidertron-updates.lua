table.insert(data.raw["spider-vehicle"]["spidertron"].resistances, {
  type = "poison",
  decrease = 15,
  percent = 80
})
...
local function add_tankotron_power_supply()
  ...
  elseif data.raw.item["vehicle-fusion-reactor-1"] then
    bobmods.lib.recipe.add_ingredient("tankotron", {
...
local function remove_spidertron_power_supply()
  ...
  if bobmods.lib.tech.has_recipe_unlock(
    "nuclear-power",
    "uranium-fuel-cell"
  ) then
...
local function add_logistic_spidertron_power_supply()
  ...
  elseif data.raw.item["vehicle-fusion-reactor-1"] then
    bobmods.lib.recipe.add_ingredient("heavy-spidertron", {
      "vehicle-fusion-reactor-1",
      2
    })
  else
...
if settings.startup["bobmods-warfare-spidertron-needsfuel"].value == "all" then
  data.raw["spider-vehicle"]["antron"].energy_source =
    spidertron_burner_energy_source()
  data.raw["spider-vehicle"]["tankotron"].energy_source =
    spidertron_burner_energy_source()
  data.raw["spider-vehicle"]["logistic-spidertron"].energy_source =
    spidertron_burner_energy_source()
  data.raw["spider-vehicle"]["spidertron"].energy_source =
    spidertron_nuclear_energy_source()
  remove_spidertron_power_supply()
  data.raw["spider-vehicle"]["heavy-spidertron"].energy_source =
    spidertron_nuclear_energy_source()
...
if settings.startup["bobmods-warfare-spidertron-overhaul"].value == true then
  ...
  bobmods.lib.recipe.add_ingredient("logistic-spidertron", {
    "mech-armor-plate",
    5
  })
  ...
  if data.raw.item["basic-electronic-components"] and data.raw.item["electronic-components"] and data.raw.item["intergrated-electronics"] and data.raw.item["processing-electronics"] then
    bobmods.lib.tech.add_prerequisite(
      "walking-vehicle",
    ...
    bobmods.lib.recipe.add_difficulty_ingredient("mech-brain", "normal", {
    ...
    bobmods.lib.recipe.add_difficulty_ingredient("mech-brain", "expensive", {
      "basic-electronic-components",
      120
    })
    bobmods.lib.recipe.add_difficulty_ingredient("mech-brain", "expensive", {
    ...
    if data.raw.item["advanced-processing-unit"] then
      bobmods.lib.recipe.add_ingredient("mech-brain", {
  ...
  if data.raw.item["advanced-processing-unit"] then
    bobmods.lib.recipe.remove_ingredient("spidertron", "effectivity-module-3")
    bobmods.lib.tech.remove_prerequisite("spidertron", "effectivity-module-3")
    bobmods.lib.recipe.add_ingredient("spidertron", {
      "advanced-processing-unit",
      10
    })
...
if data.raw["equipment-category"]["spidertron"] and data.raw["equipment-category"]["vehicle"] then
  data.raw["equipment-grid"]["logistic-spidertron-equipment-grid"].equipment_categories
  = {"spidertron", "vehicle"}
