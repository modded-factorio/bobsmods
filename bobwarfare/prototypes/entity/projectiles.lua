...
-- volume_modifier = 1,
-- min_distance = 200,
-- volume_modifier = 1, -- soft decoratives are decoratives with grows_through_rail_path = true -- if true, destroys only decoratives that have trigger_effect set -- large radius for demostrative purposes
