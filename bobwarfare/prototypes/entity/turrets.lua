...
local turret =
  ...
  if inputs.turret_base_8_directions == true then
    ...
    turret.folded_animation = bob_laser_turret_extension_eight{frame_count=1, line_length = 1, tint = inputs.tint, size = size}
  else
    turret.flags = { "placeable-player", "placeable-enemy", "player-creation"}
    turret.folded_animation = bob_laser_turret_extension{frame_count=1, line_length = 1, tint = inputs.tint, size = size}
...
--  bob_gun_turret{name = "gun-turret", health = 400, inventory_size = 1, automated_ammo_count = 10, ammo_category = "bullet", damage_modifier = 1, cooldown = 6, range = 18, tint = white, , base_tint = white},
  ...
  bob_gun_turret{name = "bob-sniper-turret-1", health = 400, inventory_size = 1, automated_ammo_count = 10, ammo_category = "bullet", damage_modifier = 15, cooldown = 150, range = 30, tint = yellow, gun_type = "gun", base = bob_turret_base{type = "laser", tint = red}},
  bob_gun_turret{name = "bob-sniper-turret-2", health = 600, inventory_size = 1, automated_ammo_count = 20, ammo_category = "bullet", damage_modifier = 20, cooldown = 120, range = 35, tint = blue, gun_type = "gun", base = bob_turret_base{type = "laser", tint = red}},
  bob_gun_turret{name = "bob-sniper-turret-3", health = 800, inventory_size = 1, automated_ammo_count = 30, ammo_category = "bullet", damage_modifier = 25, cooldown = 105, range = 40, tint = green, gun_type = "gun", base = bob_turret_base{type = "laser", tint = red}},
...
--  bob_laser_turret{name = "laser-turret", health = 1000, buffer_capacity = "801kJ", input_flow_limit = "4800kW", drain = "24kW", energy_consumption = "800kJ", projectile = "laser", damage_modifier = 2, cooldown = 40, range = 24, tint = white, base_tint = white},
  bob_laser_turret{name = "bob-laser-turret-2", health = 1200, buffer_capacity = "2001kJ", input_flow_limit = "8000kW",  drain = "30kW", energy_consumption = "1000kJ", type = "beam", beam = "bob-laser-beam-sapphire", damage_modifier = 3,   cooldown = 35, range = 26, tint = red,    base = bob_turret_base{type = "laser", tint = yellow}},
  bob_laser_turret{name = "bob-laser-turret-3", health = 1400, buffer_capacity = "3601kJ", input_flow_limit = "12000kW", drain = "36kW", energy_consumption = "1200kJ", type = "beam", beam = "bob-laser-beam-emerald",  damage_modifier = 4.2, cooldown = 30, range = 28, tint = blue,   base = bob_turret_base{type = "laser", tint = yellow}},
  bob_laser_turret{name = "bob-laser-turret-4", health = 1600, buffer_capacity = "5601kJ", input_flow_limit = "16800kW", drain = "42kW", energy_consumption = "1400kJ", type = "beam", beam = "bob-laser-beam-topaz",    damage_modifier = 5.6, cooldown = 25, range = 30, tint = purple, base = bob_turret_base{type = "laser", tint = yellow}},
  bob_laser_turret{name = "bob-laser-turret-5", health = 2000, buffer_capacity = "8001kJ", input_flow_limit = "19200kW", drain = "48kW", energy_consumption = "1600kJ", type = "beam", beam = "bob-laser-beam-diamond",  damage_modifier = 7.2, cooldown = 20, range = 32, tint = green,  base = bob_turret_base{type = "laser", tint = yellow}},
}
)
