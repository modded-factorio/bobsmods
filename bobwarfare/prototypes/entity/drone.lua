...
local tint_drone_gun = {
  r = 1,
  g = 1,
  b = 0.5
}
local tint_drone_laser = {
  r = 0.9,
  g = 0.9,
  b = 0.9
}
local tint_drone_flamethrower = {
  r = 1,
  g = 0.6,
  b = 0.5
}
local tint_drone_plasma = {
  r = 0.5,
  g = 0.8,
  b = 1
}

data:extend({{ -- same as gun_turret_attack shift
  type = "unit",
  ...
  attack_parameters = {
    ...
    animation = bobmods.warfare.tank_drone_animation(
      0.5,
      tint_drone_gun,
      tint_drone_1
    ),
  ...
  run_animation = bobmods.warfare.tank_drone_animation(
    0.5,
    tint_drone_gun,
    tint_drone_1
  )
...
data:extend({{ --slightly more than range, to stop errors.
  type = "unit",
