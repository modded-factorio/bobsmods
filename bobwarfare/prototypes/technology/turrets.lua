data:extend({{
  ...
  icon_mipmaps = 4,
  order = "a-j-a-3",
  prerequisites = {"bob-turrets-2", "military-science-pack"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_mipmaps = 4,
  order = "a-j-a-4",
  prerequisites = {"bob-turrets-3", "military-3"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_mipmaps = 4,
  order = "a-j-a-5",
  prerequisites = {"bob-turrets-4", "production-science-pack"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_mipmaps = 4,
  order = "a-j-b-2",
  prerequisites = {"laser-turret", "advanced-electronics"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_mipmaps = 4,
  order = "a-j-b-3",
  prerequisites = {"bob-laser-turrets-2", "military-3"},
  unit = {
    count = 200,
    time = 30,
    ingredients = {
  ...
  icon_mipmaps = 4,
  order = "a-j-b-5",
  prerequisites = {"bob-laser-turrets-4", "military-4"},
  unit = {
    count = 300,
    time = 30,
    ingredients = {
  ...
  icon_mipmaps = 4,
  order = "a-j-c-2",
  prerequisites = {"bob-sniper-turrets-1", "military-3"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_mipmaps = 4,
  order = "a-j-c-3",
  prerequisites = {"bob-sniper-turrets-2", "military-4"},
  effects = {{
    type = "unlock-recipe",
...
data:extend({{
  ...
  icon_size = 128,
  order = "a-j-c-2",
  prerequisites = {"bob-plasma-turrets-1", "advanced-electronics"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_size = 128,
  order = "a-j-c-3",
  prerequisites = {"bob-plasma-turrets-2", "military-3"},
  unit = {
    count = 300,
    time = 30,
    ingredients = {
  ...
  icon_size = 128,
  order = "a-j-c-5",
  prerequisites = {"bob-plasma-turrets-4", "military-4"},
  unit = {
    count = 500,
    time = 30,
    ingredients = {
...
data:extend({{
  ...
  prerequisites = {"bob-artillery-turret-2"},
  unit = {
    time = 30,
    count = 200,
    ingredients = {
