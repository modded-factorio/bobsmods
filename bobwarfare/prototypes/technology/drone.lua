data:extend({{
  ...
  icon_size = 128,
  prerequisites = {"robotics", "defender", "gun-turret"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_size = 128,
  prerequisites = {"robotics", "defender", "laser-turret"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_size = 128,
  prerequisites = {"robotics", "defender", "flamethrower"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_size = 128,
  prerequisites = {"robotics", "defender", "bob-plasma-turrets-1"},
  effects = {{
    type = "unlock-recipe",
