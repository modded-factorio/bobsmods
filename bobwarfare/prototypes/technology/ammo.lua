data:extend({{
  ...
  icon_size = 32,
  prerequisites = {"cordite-processing"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_size = 32,
  prerequisites = {"bob-bullets", "chemical-science-pack"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_size = 32,
  prerequisites = {"bob-shotgun-shells", "chemical-science-pack"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon = "__bobwarfare__/graphics/icons/technology/laser-rifle.png",
  icon_size = 64,
  prerequisites = {"bob-laser-rifle-ammo-1"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon = "__bobwarfare__/graphics/icons/technology/laser-rifle.png",
  icon_size = 64,
  prerequisites = {"bob-laser-rifle-ammo-2", "chemical-science-pack"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon = "__bobwarfare__/graphics/icons/technology/laser-rifle.png",
  icon_size = 64,
  prerequisites = {"bob-laser-rifle-ammo-3"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon = "__bobwarfare__/graphics/icons/technology/laser-rifle.png",
  icon_size = 64,
  prerequisites = {"bob-laser-rifle-ammo-4", "production-science-pack"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon = "__bobwarfare__/graphics/icons/technology/laser-rifle.png",
  icon_size = 64,
  prerequisites = {"bob-laser-rifle-ammo-5"},
  effects = {{
    type = "unlock-recipe",
...
data:extend({{
  ...
  prerequisites = {"bob-shotgun-shells", "tank"},
  effects = {{
    type = "unlock-recipe",
  ...
  prerequisites = {"distractor", "artillery"},
  effects = {{
    type = "unlock-recipe",
