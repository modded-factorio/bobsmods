if settings.startup["bobmods-warfare-robotupdate"].value == true then
  ...
  if bobmods.warfare.RobotRequirePrevious == true then
    ...
    bobmods.lib.recipe.add_ingredient("destroyer-robot", {
      "distractor-robot",
      1
    })
  ...
  if bobmods.warfare.FlyingRobotFrames == true then
    bobmods.lib.recipe.add_ingredient("defender-robot", {
      "flying-robot-frame",
      1
    })
    ...
    if data.raw.item["flying-robot-frame-2"] then
      bobmods.lib.recipe.add_ingredient("distractor-robot", {
    ...
    if data.raw.item["flying-robot-frame-4"] then
      bobmods.lib.recipe.add_ingredient("bob-laser-robot", {
  ...
  if data.raw.recipe["robot-brain-combat"] then
    ...
    if data.raw.item["basic-circuit-board"] and data.raw.item["basic-electronic-components"] then
      bobmods.lib.recipe.add_ingredient("robot-brain-combat", {
        "basic-circuit-board",
        1
      })
      bobmods.lib.recipe.add_ingredient("robot-brain-combat", {
  ...
  if data.raw.recipe["robot-brain-combat-2"] then
    ...
    if data.raw.item["circuit-board"] and data.raw.item["basic-electronic-components"] and data.raw.item["electronic-components"] then
      bobmods.lib.recipe.add_ingredient("robot-brain-combat-2", {
        "circuit-board",
        1
      })
      bobmods.lib.recipe.add_ingredient("robot-brain-combat-2", {
  ...
  if data.raw.recipe["robot-brain-combat-3"] then
    ...
    if data.raw.item["superior-circuit-board"] and data.raw.item["basic-electronic-components"] and data.raw.item["electronic-components"] and data.raw.item["intergrated-electronics"] then
      bobmods.lib.recipe.add_ingredient("robot-brain-combat-3", {
  ...
  if data.raw.recipe["robot-brain-combat-4"] then
    ...
    if data.raw.item["multi-layer-circuit-board"] and data.raw.item["basic-electronic-components"] and data.raw.item["electronic-components"] and data.raw.item["intergrated-electronics"] and data.raw.item["processing-electronics"] then
      bobmods.lib.recipe.add_ingredient("robot-brain-combat-4", {
  ...
  if data.raw.recipe["robot-tool-combat"] then
    ...
    if data.raw.item["steel-gear-wheel"] then
      bobmods.lib.recipe.add_ingredient("robot-tool-combat", {
        "steel-gear-wheel",
        5
      })
    else
  ...
  if data.raw.recipe["robot-tool-combat-2"] then
    if data.raw.item["brass-alloy"] then
      bobmods.lib.recipe.add_ingredient("robot-tool-combat-2", {
        "brass-alloy",
        1
      })
      bobmods.lib.tech.add_prerequisite("distractor", "zinc-processing")
  ...
  if data.raw.recipe["robot-tool-combat-3"] then
    if data.raw.item["titanium-plate"] then
      bobmods.lib.recipe.add_ingredient("robot-tool-combat-3", {
        "titanium-plate",
        1
      })
    else
  ...
  if data.raw.recipe["robot-tool-combat-4"] then
    if data.raw.item["silicon-nitride"] then
      bobmods.lib.recipe.add_ingredient("robot-tool-combat-4", {
        "silicon-nitride",
        1
      })
    else
