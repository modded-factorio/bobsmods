if settings.startup["bobmods-warfare-robotupdate"].value == true then
  ...
  if bobmods.warfare.RobotRequirePrevious == true then
    bobmods.lib.recipe.add_ingredient("bob-distractor-robot", { type = "item", name = "bob-defender-robot", amount = 1 })
    bobmods.lib.recipe.add_ingredient("bob-destroyer-robot", { type = "item", name = "bob-distractor-robot", amount = 1 })
  ...
  if bobmods.warfare.FlyingRobotFrames == true then
    ...
    if data.raw.item["bob-flying-robot-frame-2"] then
      ...
      bobmods.lib.recipe.add_ingredient("bob-distractor-robot", { type = "item", name = "flying-robot-frame", amount = 1 })
    end

    if data.raw.item["bob-flying-robot-frame-3"] then
      bobmods.lib.recipe.add_ingredient("bob-destroyer-robot", { type = "item", name = "bob-flying-robot-frame-3", amount = 1 })
      bobmods.lib.tech.add_prerequisite("destroyer", "bob-robotics-3")
    else
      bobmods.lib.recipe.add_ingredient("bob-destroyer-robot", { type = "item", name = "flying-robot-frame", amount = 1 })
    end

    if data.raw.item["bob-flying-robot-frame-4"] then
      bobmods.lib.recipe.add_ingredient("bob-laser-robot", { type = "item", name = "bob-flying-robot-frame-4", amount = 1 })
    ...
    if data.raw.item["bob-aluminium-plate"] then
      bobmods.lib.recipe.add_ingredient("bob-distractor-robot", { type = "item", name = "bob-aluminium-plate", amount = 1 })
    else
    ...
    if data.raw.item["bob-titanium-plate"] then
      bobmods.lib.recipe.add_ingredient("bob-destroyer-robot", { type = "item", name = "bob-titanium-plate", amount = 1 })
  ...
  if data.raw.recipe["bob-robot-brain-combat-4"] then
    ...
    if data.raw.item["bob-advanced-processing-unit"] then
      bobmods.lib.recipe.set_ingredient("bob-robot-brain-combat-4", { type = "item", name = "processing-unit", amount = 1 })
      bobmods.lib.recipe.add_ingredient(
  ...
  if data.raw.recipe["bob-robot-brain-combat"] then
    ...
    bobmods.lib.recipe.add_ingredient("bob-defender-robot", { type = "item", name = "bob-robot-brain-combat", amount = 1 })
  else
    bobmods.lib.recipe.add_ingredient("bob-defender-robot", { type = "item", name = "electronic-circuit", amount = 1 })
  end
  if data.raw.recipe["bob-robot-brain-combat-2"] then
    bobmods.lib.tech.add_recipe_unlock("distractor", "bob-robot-brain-combat-2")
    bobmods.lib.recipe.add_ingredient("bob-distractor-robot", { type = "item", name = "bob-robot-brain-combat-2", amount = 1 })
  else
    bobmods.lib.recipe.add_ingredient("bob-distractor-robot", { type = "item", name = "advanced-circuit", amount = 1 })
  end
  if data.raw.recipe["bob-robot-brain-combat-3"] then
    bobmods.lib.tech.add_recipe_unlock("destroyer", "bob-robot-brain-combat-3")
    bobmods.lib.recipe.add_ingredient("bob-destroyer-robot", { type = "item", name = "bob-robot-brain-combat-3", amount = 1 })
  else
    bobmods.lib.recipe.add_ingredient("bob-destroyer-robot", { type = "item", name = "processing-unit", amount = 1 })
  end
  if data.raw.recipe["bob-robot-brain-combat-4"] then
    bobmods.lib.tech.add_recipe_unlock("bob-laser-robot", "bob-robot-brain-combat-4")
    bobmods.lib.recipe.add_ingredient("bob-laser-robot", { type = "item", name = "bob-robot-brain-combat-4", amount = 1 })
  else
    if data.raw.item["bob-advanced-processing-unit"] then
      bobmods.lib.recipe.add_ingredient(
        "bob-laser-robot",
  ...
  if data.raw.recipe["bob-robot-tool-combat"] then
    ...
    if data.raw.item["bob-steel-gear-wheel"] then
      ...
      bobmods.lib.recipe.add_ingredient("bob-robot-tool-combat", { type = "item", name = "iron-gear-wheel", amount = 5 })
    end
  end

  if data.raw.recipe["bob-robot-tool-combat-2"] then
    if data.raw.item["bob-brass-alloy"] then
      bobmods.lib.recipe.add_ingredient("bob-robot-tool-combat-2", { type = "item", name = "bob-brass-alloy", amount = 1 })
      bobmods.lib.tech.add_prerequisite("distractor", "bob-zinc-processing")
    else
    ...
    if data.raw.item["bob-brass-gear-wheel"] then
      ...
      bobmods.lib.recipe.add_ingredient("bob-robot-tool-combat-2", { type = "item", name = "iron-gear-wheel", amount = 2 })
    end
  ...
  if data.raw.recipe["bob-robot-tool-combat-3"] then
    ...
    if data.raw.item["bob-titanium-gear-wheel"] then
      ...
      bobmods.lib.recipe.add_ingredient("bob-robot-tool-combat-3", { type = "item", name = "iron-gear-wheel", amount = 2 })
    end
    ...
    if data.raw.item["bob-emerald-5"] then
      bobmods.lib.recipe.add_ingredient("bob-robot-tool-combat-3", { type = "item", name = "bob-emerald-5", amount = 1 })
  ...
  if data.raw.recipe["bob-robot-tool-combat-4"] then
    ...
    if data.raw.item["bob-nitinol-gear-wheel"] then
      ...
      bobmods.lib.recipe.add_ingredient("bob-robot-tool-combat-4", { type = "item", name = "iron-gear-wheel", amount = 2 })
    end
    ...
    if data.raw.item["bob-diamond-5"] then
      bobmods.lib.recipe.add_ingredient("bob-robot-tool-combat-4", { type = "item", name = "bob-diamond-5", amount = 1 })
    end
  end

  if data.raw.recipe["bob-robot-tool-combat"] then
    bobmods.lib.tech.add_recipe_unlock("defender", "bob-robot-tool-combat")
    bobmods.lib.recipe.add_ingredient("bob-defender-robot", { type = "item", name = "bob-robot-tool-combat", amount = 1 })
  else
    bobmods.lib.recipe.add_ingredient(
      "bob-defender-robot",
  ...
  if data.raw.recipe["bob-robot-tool-combat-2"] then
    ...
    bobmods.lib.recipe.add_ingredient("bob-distractor-robot", { type = "item", name = "bob-robot-tool-combat-2", amount = 1 })
  else
    bobmods.lib.recipe.add_ingredient("bob-distractor-robot", { type = "item", name = "bob-laser-rifle-battery", amount = 1 })
  ...
  if data.raw.recipe["bob-robot-tool-combat-3"] then
    ...
    bobmods.lib.recipe.add_ingredient("bob-destroyer-robot", { type = "item", name = "bob-robot-tool-combat-3", amount = 1 })
  else
    bobmods.lib.recipe.add_ingredient(
      "bob-destroyer-robot",
  ...
  if data.raw.recipe["bob-robot-tool-combat-4"] then
    ...
    bobmods.lib.recipe.add_ingredient("bob-laser-robot", { type = "item", name = "bob-robot-tool-combat-4", amount = 1 })
  else
    bobmods.lib.recipe.add_ingredient(
      "bob-laser-robot",
