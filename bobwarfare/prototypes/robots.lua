...
if settings.startup["bobmods-warfare-robotupdate"].value == true then
  ...
  --    time_to_live = 60 * 60 * 60 * 24, -- 1 day -- 10 mins
    type = "item",
    ...
    idle = bobmods.warfare.robot_picture(
      "__bobwarfare__/graphics/entities/robots/laser-robot.png"
    ),
    shadow_idle = bobmods.warfare.robot_shadow(),
    in_motion = bobmods.warfare.robot_picture(
      "__bobwarfare__/graphics/entities/robots/laser-robot.png"
    ),
    ...
    prerequisites = {"destroyer", "production-science-pack"},
    unit = {
      count = 500,
      ingredients = {
